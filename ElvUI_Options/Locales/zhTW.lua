...
L["Add an item by dragging it onto this field, shift-clicking it into the field, or by entering the numerical Item ID"] = "增加一個物品或是搜尋語法到忽略清單. 符合搜尋語法的物品將會被忽略"
L["Add Currency by ID"] = "添加貨幣 ID"
L["Add Currency"] = "添加貨幣"
L["Add Current"] = "添加貨幣"
L["Add Instance ID"] = "添加副本 ID"
L["Add Item Name or ID"] = "添加物品名稱或 ID"
L["Add Item"] = "增加物品或是搜尋語法"
L["Add Map ID"] = "添加地圖ID"
...
L["Help"] = "幫助"
L["Herbalism"] = "草藥學"
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "在此你可以新增物品或是搜尋語法來排除排序某些物品. 要移除物品請點選列表中的物品名稱"
...
L["Ignored Items (Global)"] = "忽略的物品與搜尋語法 (全局)"
L["Ignored Items (Profile)"] = "忽略的物品與搜尋語法 (個人)"
L["Import Now"] = "現在導入"
L["Import"] = true
