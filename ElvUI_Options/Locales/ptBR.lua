...
L["Add an item by dragging it onto this field, shift-clicking it into the field, or by entering the numerical Item ID"] = "Adicionar um item ou sintaxe de busca para a lista dos ignorados. Items que coincidem com a sintaxe de busca serão ignorados."
...
L["Add Item"] = "Adicionar Item ou Sintaxe de Busca"
...
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "Aqui você pode adicionar itens ou termos de busca que você quer que sejam excluídos por sorteamento. Para remover um item apenas clique num nome na lista."
...
L["Ignored Items (Global)"] = "Itens Ignorados e Sintaxe de Busca (Global)"
L["Ignored Items (Profile)"] = "Itens Ignorados e Sintaxe de Busca (Perfil)"
