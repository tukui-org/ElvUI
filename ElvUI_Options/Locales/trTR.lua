...
L["|cffFF3333Send ADDON_ACTION_BLOCKED errors to the Lua Error frame.|r"] = "|cffFF3333ADDON_ACTION_BLOCKED hatalarini Lua Error cercevesine gonder.|r"
L["These errors are less important in most cases and will not effect your game performance. Also a lot of these errors cannot be fixed. Please only report these errors if you notice a defect in gameplay."] = "Bu hatalar cogu durumda daha az onemlidir ve oyun performansinizi etkilemez. Ayrica bu hatalarin cogu duzeltilemez. Lutfen bu hatalari yalnizca oyunda bir Kusur fark ederseniz bildirin."
