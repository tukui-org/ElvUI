...
L["Add an item by dragging it onto this field, shift-clicking it into the field, or by entering the numerical Item ID"] = "Yok sayilan listeye bir oge veya arama sozdizimi ekleyin. Arama sozdizimiyle eslesen ogeler yoksayilacak."
...
L["Add Item"] = "Oge Ekle veya Sozdizimi Ara"
...
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "Buradan siralamadan cikarilmasini istediginiz ogeleri veya arama terimlerini ekleyebilirsiniz. Bir ogeyi kaldirmak icin listedeki adini tiklamaniz yeterlidir."
...
L["Ignored Items (Global)"] = "Yok Sayilan Ogeler ve Arama Sozdizimi (Global)"
L["Ignored Items (Profile)"] = "Yok Sayilan Ogeler ve Arama Sozdizimi (Profil)"
