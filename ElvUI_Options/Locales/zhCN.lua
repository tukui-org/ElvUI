...
L["Add an item by dragging it onto this field, shift-clicking it into the field, or by entering the numerical Item ID"] = "添加一个物品或者匹配语法到屏蔽列表.符合匹配语法的物品将被忽略"
L["Add Currency by ID"] = "添加货币ID"
L["Add Currency"] = "添加货币"
L["Add Current"] = "添加当前"
L["Add Instance ID"] = "添加副本ID"
L["Add Item Name or ID"] = "添加物品名称或者ID"
L["Add Item"] = "添加物品或者匹配语法"
L["Add Map ID"] = "添加地图ID"
...
L["Help"] = "帮助"
L["Herbalism"] = "草药"
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "你可以在这里添加你想在排序中排除的物品或者匹配语法.在列表中点击他们的名字来移除一个物品"
...
L["Ignored Items (Global)"] = "被忽略的物品和搜索语法(全局)"
L["Ignored Items (Profile)"] = "被忽略的物品和搜索语法(配置文件)"
L["Import Now"] = "现在导入"
L["Import"] = true
