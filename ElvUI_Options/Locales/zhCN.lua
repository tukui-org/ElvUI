...
L["Color by Happiness"] = "根据快乐值染色"
L["Color By Spec"] = "根据规格染色"
L["Color by Unit Class"] = "根据单位职业染色"
...
L["Expansion Landing Page"] = "资料片登陆页面"
L["Expiring"] = "即将冷却完毕"
L["Export Now"] = "现在导出"
...
L["Replaces the StatusBar texture setting on Unitframes and Nameplates with the primary texture."] = "替换单位框架和姓名版上的状态栏文本设定主要材质"
