...
L["Lock Friendly NPC Plates"] = "Sperre freundliche NPC-Plaketten"
...
L["Prevent Friendly NPC nameplates from being reset to enabled on login."] = "Verhindern, dass die Namensschilder freundlicher NPCs beim Einloggen wieder aktiviert werden."
