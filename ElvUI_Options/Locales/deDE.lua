...
L["Middle clicking the unit frame will cause your focus to match the unit.\n\n|cffff3333Note:|r If Clique is enabled, this option only affects ElvUI frames if they are not blacklisted in Clique."] = true
...
L["Multiply the backdrops height or width by this value. This is useful if you wish to have more than one bar behind a backdrop."] = true
...
L["The Thin Border Theme option will change the overall appearance of your UI. Using the Thin Border Theme is a slight performance increase over the traditional layout."] = true
...
L["|cffFF9933You are using Overflow with Max Overflow at zero.|r "] = true
L["2D"] = "2D"
L["3D"] = "3D"
