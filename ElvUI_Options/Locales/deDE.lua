...
L["Add an item by dragging it onto this field, shift-clicking it into the field, or by entering the numerical Item ID"] = "Füge ein Gegenstand oder ein Suchoperator zu der Ignorierliste hinzu. Gegenstände die auf den Suchoperator zutreffen werden ignoriert."
...
L["Add Item"] = "Füge Gegenstand oder Suchoperator hinzu"
...
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "Hier kannst du Gegenstände oder Suchbedingungen vom Suchen ausschließen. Um ein Gegenstand zu entfernen, klicke einfach auf den Namen in der Liste."
...
L["Ignored Items (Global)"] = "Ignorierte Gegenstände oder Suchoperatoren (Global)"
L["Ignored Items (Profile)"] = "Ignorierte Gegenstände oder Suchoperatoren (Profil)"
...
-- L["On screen positions for different elements."] = "Bildschirmpositionen für verschiedene Elemente." --from core
...
-- L["Unlock various elements of the UI to be repositioned."] = "Schalte verschiedene Elemente der Benutzeroberfläche frei, die neu positioniert werden sollen." --from core
L["Up"] = "Hinauf"
...
-- L["You are going to copy settings for |cffD3CF00\"%s\"|r from your current |cff4beb2c\"%s\"|r profile to |cff4beb2c\"%s\"|r profile. Are you sure?"] = "Du wirst die Einstellungen für |cffD3CF00\"%s\"|r von deinem aktuellen |cff4beb2c\"%s\"|r-Profil in das |cff4beb2c\"%s\"|r-Profil kopieren. Bist du sicher?" --from core
...
-- L["You are going to copy settings for |cffD3CF00\"%s\"|r from |cff4beb2c\"%s\"|r profile to your current |cff4beb2c\"%s\"|r profile. Are you sure?"] = "Du wirst die Einstellungen für |cffD3CF00\"%s\"|r aus dem |cff4beb2c\"%s\"|r-Profil in dein aktuelles |cff4beb2c\"%s\"|r-Profil kopieren. Bist du sicher?" --From core
