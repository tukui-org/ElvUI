...
L["Add an item by dragging it onto this field, shift-clicking it into the field, or by entering the numerical Item ID"] = "Добавить предмет или синтаксис поиска в список игнорируемых. Предметы, соответствующие синтаксису, будут игнорироваться."
...
L["Add Item"] = "Добавить предмет или синтаксис поиска"
...
L["Help"] = "Помощь"
L["Herbalism"] = "Травы"
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "Здесь Вы можете добавить предметы или запросы поиска, которые хотите исключить из сортировки. Для удаления предмета просто кликните на его имени в списке."
...
L["Ignored Items (Global)"] = "Игнорируемые предметы и синтаксис (Глобальный)"
L["Ignored Items (Profile)"] = "Игнорируемые предметы и синтаксис (Профиль)"
