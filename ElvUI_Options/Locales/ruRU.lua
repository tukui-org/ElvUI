...
L["Horizontal offset applied to buttons in the each line that was wrapped."] = "Горизонтальный отступ для каждого ряда после переноса строки."
...
L["Vertical offset applied to buttons in the each line that was wrapped."] = "Вертикальный отступ для каждого ряда после переноса строки."
...
L["Wrapped"] = true
L["Wrapped X-Offset"] = "Отступ переноса по X"
L["Wrapped Y-Offset"] = "Отступ переноса по Y"
