...
L["Change the width and controls how big of an area on the screen will accept clicks to target unit."] = "Изменяет ширину и контролирует размер области, которая будет регистрировать клики для выыделения юнита."
...
L["This works like a macro, you can run different situations to get the actionbar to show/hide differently.\n Example: '[combat] show;hide'"] = "Рабюотает как в макросах. Вы можете задать различные ситуации, при которых нужно показать/скрыть панель.\n Пример: '[combat] show;hide'"
...
L["Ticket Tracker"] = "Треккер багов"
L["Ticks"] = "Тики"
