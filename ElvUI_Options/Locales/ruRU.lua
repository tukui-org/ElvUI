...
L["|cffFF3333This is for information. This will not change the tags in the UI.|r"] = "|cffFF3333Все тэги ниже представлены для информации. Изменения не отразятся на интерфейсе (если вы ообще сможете применить эти изменения).|r"
...
L["Assist Target"] = "Цель помощника"
L["Assist"] = "Помощник"
...
L["Backdrop Faded"] = "Прозрацный фон"
...
L["Button Options"] = "Параметры кнопок"
...
L["Hide Zone Text"] = "Скрыть текст зоны"Ы
L["Hide"] = "Скрыть"
