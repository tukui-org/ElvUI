...
L["Help"] = "Помощь"
L["Herbalism"] = "Травы"
L["Here you can add items or search terms that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "Здесь Вы можете добавить предметы или запросы поиска, которые хотите исключить из сортировки. Для удаления предмета просто кликните на его имени в списке."
...
L["Latency"] = "Задержка"
L["Leatherworking"] = "Кожевничество"--Вроде профессия же ?
...
L["Lines"] = "Линии"
L["Link to the latest development version."] = "Ссылка на последнюю версию для разработчиков."
...
L["Replaces the default Blizzard fonts on various panels and frames with the fonts chosen in the Media section of the ElvUI Options. NOTE: Any font that inherits from the fonts ElvUI usually replaces will be affected as well if you disable this. Enabled by default."] = "Заменяет шрифты, используемые Blizzard по умолчанию на различных панелях и фреймах, шрифтами, установленными в секции \"Медиа\" (этой секции). Примечание: любые дочерние шрифты к заменяемым, также будут изменены. Включено по умолчанию."--По-моему, здесь есть вопросики по переводу второго предложения.
...
L["Reset filter priority to the default state."] = "Сбросить приоритеты фильтров на значения по умолчанию."
...
L["Set Settings to Default"] = "Сбросить настройки по умолчанию"
...
L["This section will help reset specfic settings back to default."] = "Эта секция поможет вернуть настройки конкретного модуля по умолчанию."
...
L["This will reset the contents of this filter back to default. Any spell you have added to this filter will be removed."] = "Это сбросит фильтр по умолчанию. Любые заклинания, добавленные в этот фильтр, будут удалены."
...
L["Triggers"] = "Триггеры"
L["Trivial"] = "Обычный"
L["Turtle Color"] = "Цвет Turtle Buffs"--Черепашьих баффов ?!
