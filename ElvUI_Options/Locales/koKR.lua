...
L["Add an item by dragging it onto this field, shift-clicking it into the field, or by entering the numerical Item ID"] = "검색을 제외할 물품 또는 단어를 추가합니다. 검색 단어와 일치하는 항목은 제외하게 됩니다."
...
L["Herbalism"] = "약초 채집"
L["Here you can add items that you want to be excluded from sorting. To remove an item just click on its name in the list."] = "여기에 가방 정리에서 제외할 아이템 또는 검색어를 추가할 수 있습니다. 제거할 때는 목록에서 아이템 이름을 클릭만 하시면 됩니다."
...
L["Ignored Items (Global)"] = "제외된 아이템 또는 검색구문 (전역)"
L["Ignored Items (Profile)"] = "제외된 아이템 또는 검색구문 (프로필)"
