...
General.anchorToElvUIBags = ACH:Select(L["Anchor to ElvUI Bags"], L["Tooltip gets anchored to ElvUI bags when they are shown."], 13, { TOPLEFT = L["TOPLEFT"], TOPRIGHT = L["TOPRIGHT"], DISABLED = L["Disabled"] }, nil, nil, nil, nil, function() return not E.private.bags.enable or E.db.tooltip.cursorAnchor end)
