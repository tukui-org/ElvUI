...
GenGen.totems.args.keepSizeRatio = ACH:Toggle(L["Keep Size Ratio"], nil, 2)
GenGen.totems.args.size = ACH:Range(L["Button Size"], nil, 3, { min = 24, max = 60, step = 1 })
GenGen.totems.args.height = ACH:Range(L["Button Height"], nil, 4, { min = 24, max = 60, step = 1 })
