...
Cosmetic.afkGroup.args.afkAnimation = ACH:Select(L["Idle Animation"], L["Select the idle animation on the AFK screen."], 1, function() return { dance = L["Dance"], lean = L["Lean"], salute = L["Salute"], talk = L["Talk"], shy = L["Shy"], roar = L["Roar"] } end)
