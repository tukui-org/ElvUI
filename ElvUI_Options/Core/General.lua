...
GenGen.taintLog = ACH:Toggle(L["Log Taints"], L["|cffFF3333Send ADDON_ACTION_BLOCKED errors to the Lua Error frame.|r"]..'\n'..L["These errors are less important in most cases and will not effect your game performance. Also a lot of these errors cannot be fixed. Please only report these errors if you notice a defect in gameplay."], 5)
