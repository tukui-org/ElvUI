...
local function GetOptionsTable_Fader(updateFunc, groupName, numUnits)
	...
	config.args.delay = ACH:Range(L["Fade Out Delay"], nil, 14, { min = 0, max = 3, step = 0.01 }, nil, nil, nil, disabledOrRanged)
	config.args.smooth = ACH:Range(L["Smooth"], nil, 15, { min = 0, max = 1, step = 0.01 }, nil, nil, nil, disabled)
	config.args.minAlpha = ACH:Range(L["Min Alpha"], nil, 16, { min = 0, max = 1, step = 0.01 }, nil, nil, nil, disabled)
	config.args.maxAlpha = ACH:Range(L["Max Alpha"], nil, 17, { min = 0, max = 1, step = 0.01 }, nil, nil, nil, disabled)
