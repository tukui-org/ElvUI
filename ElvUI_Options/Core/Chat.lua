...
General.args.recentAllyIcon = ACH:Toggle(L["Recent Ally Icon"], L["Display Recent Ally icon after names in chat (excludes whispers and emotes)."], 14.5, nil, nil, nil, nil, nil, nil, not E.Retail)
General.args.timerunningIcon = ACH:Toggle(L["Timerunning Icon"], L["Display Timerunning seasonal icon before names."], 15, nil, nil, nil, nil, nil, nil, not E.Retail)
