...
Filters.mainOptions.args.filterGroup.args.addSpell = ACH:Input(L["Description"], nil, 6, nil, 350, function() return E.global.unitframe.aurafilters[selectedFilter].desc end, function(_, value) E.global.unitframe.aurafilters[selectedFilter].desc = value UF:Update_AllFrames() end, nil, function() return defaultFilterList[selectedFilter] or G.unitframe.aurafilters[selectedFilter] end)
