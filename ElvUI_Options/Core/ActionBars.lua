...
ActionBar.args.ActionPaging = ACH:Execute(L["Paging Guide"], nil, 4, function() E:StaticPopup_Show('ELVUI_EDITBOX', nil, nil, 'https://github.com/tukui-org/ElvUI/wiki/paging') end, nil, nil, 160)
