...
local function GetUnitAuras(unit, auraType)
	...
	group.args.sourceGroup.args.length = ACH:Range(L["Length"], nil, 5, { min = 2, max = 12, step = 1 })
...
NamePlates.colorsGroup.args.threat.args.soloColorEnable = ACH:Toggle(L["Use Solo Color"], L["Use solo threat color when not in a group."], 8, nil, nil, nil, function(info) return E.db.nameplates.threat.useSoloColor end, function(info, value) E.db.nameplates.threat.useSoloColor = value NP:ConfigureAll() end, nil, function() return (not E.db.nameplates.threat.beingTankedByTank or not E.db.nameplates.threat.useThreatColor) end)
NamePlates.colorsGroup.args.threat.args.soloColor = ACH:Color(L["Solo Color"], nil, 9, nil, nil, nil, nil, nil, function() return (not E.db.nameplates.threat.useSoloColor or not E.db.nameplates.threat.useThreatColor or not E.db.nameplates.threat.beingTankedByTank) end)
