...
Bags.args.general.args.bankGroup.args.split.args.alwaysProfessionBank = ACH:Toggle(L["Always Split Professions"], nil, 5, nil, nil, nil, nil, nil, nil, function() return not E.db.bags.split.bank end)
