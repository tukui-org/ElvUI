...
General.args.socialQueueMessages = ACH:Toggle(L["Quick Join Messages"], L["Show clickable Quick Join messages inside of the chat."], 11, nil, nil, nil, nil, nil, nil, not E.Modern)
...
General.args.mentorshipIcon = ACH:Toggle(L["Mentorship Icon"], L["Display Mentorship status icon before names."], 14, nil, nil, nil, nil, nil, nil, not E.Modern)
General.args.recentAllyIcon = ACH:Toggle(L["Recent Ally Icon"], L["Display Recent Ally icon after names in chat (excludes whispers and emotes)."], 15, nil, nil, nil, nil, nil, nil, not E.Modern)
General.args.timerunningIcon = ACH:Toggle(L["Timerunning Icon"], L["Display Timerunning seasonal icon before names."], 16, nil, nil, nil, nil, nil, nil, not E.Modern)
