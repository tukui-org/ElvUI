...
General.healthBar.args.short = ACH:Toggle(L["Short Values"], nil, 2, nil, nil, nil, nil, function(_, value) E.db.tooltip.healthBar.short = value end, BarDisabled, not E.Modern)
