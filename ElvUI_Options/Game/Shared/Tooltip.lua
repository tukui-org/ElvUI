...
General.moneyLines = ACH:Toggle(L["Money Lines"], L["Replaces Blizzards price lines with custom ones.\n\n|cffff3333Note:|r Required to prevent issues with MoneyFrame."], 11, nil, nil, nil, nil, nil, nil, not E.Retail)
General.moneyHide = ACH:Toggle(L["Money Hide"], L["Hides Blizzards price lines."], 12, nil, nil, nil, nil, nil, function() return not E.db.tooltip.moneyLines end, not E.Retail)
General.fadeOut = ACH:Toggle(L["Fade Out"], L["Fade out the tooltip when it disappears, instant otherwise. Cursor anchored tooltips are unaffected."], 13, nil, nil, nil, nil, nil, nil, not E.Retail)
