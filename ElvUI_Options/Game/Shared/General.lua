...
Fonts.general.args.fontSlug = ACH:Toggle(L["Font Slug"], L["Appends the SLUG rendering flag to the font outline for sharper edges. Retail only."], 4, nil, nil, nil, nil, nil, function() return not E.Retail end)
