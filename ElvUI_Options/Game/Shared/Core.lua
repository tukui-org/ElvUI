...
do -- Module Copy
	...
	local function CreateCooldownConfig()
		...
		config.args.cdmanager_essential.name = L["Essential Cooldowns"]
		config.args.cdmanager_utility.name = L["Utility Cooldowns"]
		config.args.cdmanager_buff.name = L["Buff Cooldowns"]
