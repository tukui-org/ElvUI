...
Maps.args.minimap.args.cluster.args.locationTextGroup.args.locationText = ACH:Select(L["Location Text"], L["Change settings for the display of the location text that is on the minimap."], 1, { MOUSEOVER = L["Minimap Mouseover"], SHOW = L["Always Display"], HIDE = L["Hide"] }, nil, nil, nil, nil, nil, function() return E.Modern and not E.db.general.minimap.clusterDisable end)
...
Maps.args.minimap.args.icons.args.classHall = ACH:Group(L["Expansion"], nil, 1, nil, nil, nil, nil, not E.Modern)
...
Maps.args.minimap.args.icons.args.tracking.args.showAllTracking = ACH:Toggle(L["Show All Tracking Options"], nil, 7, nil, nil, nil, function() return GetCVarBool('minimapTrackingShowAll') end, function(_, value) E:SetCVar('minimapTrackingShowAll', value and 1 or 0) end, nil, not E.Modern)

Maps.args.minimap.args.icons.args.calendar = ACH:Group(L["Calendar"], nil, 5, nil, nil, nil, function() return E.Modern and not E.db.general.minimap.clusterDisable end)
...
Maps.args.minimap.args.icons.args.mail = ACH:Group(L["MAIL_LABEL"], nil, 6, nil, nil, nil, function() return E.Modern and not E.db.general.minimap.clusterDisable end)
...
Maps.args.minimap.args.icons.args.battlefield = ACH:Group(L["Battlefield"], nil, 7, nil, nil, nil, nil, E.Modern)
