...
local function GetUnitAuras(unit, auraType)
	...
	group.args.midnightGroup.args.isAuraImportant = ACH:Toggle(L["Important"], nil, 10, nil, nil, nil, nil, nil, nil, not E.Retail)
	group.args.midnightGroup.args.isAuraCrowdControl = ACH:Toggle(L["Crowd Control"], nil, 11, nil, nil, nil, nil, nil, nil, not E.Retail)
	group.args.midnightGroup.args.isAuraBigDefensive = ACH:Toggle(L["Big Defensive"], nil, 13, nil, nil, nil, nil, nil, nil, not E.Retail)
	group.args.midnightGroup.args.isAuraRaidInCombat = ACH:Toggle(L["Raid Frames"], nil, 14, nil, nil, nil, nil, nil, nil, not E.Retail)
	group.args.midnightGroup.args.isAuraRaidPlayerDispellable = ACH:Toggle(L["Player Dispelable"], nil, 12, nil, nil, nil, nil, nil, nil, not E.Retail)
