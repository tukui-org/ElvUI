...
local function GetOptionsTable_AuraBars(updateFunc, groupName)
	...
	if E.Retail then
		...
		config.args.filtersGroup.args.isAuraRaidInCombat = ACH:Toggle(L["Raid Frames"], nil, 14, nil, nil, nil, nil, nil, nil, not patchReady)
...
local function GetOptionsTable_Auras(auraType, updateFunc, groupName, numUnits)
	...
	config.args.midnightGroup.args.isAuraRaidInCombat = ACH:Toggle(L["Raid Frames"], nil, 14, nil, nil, nil, nil, nil, nil, not patchReady)
