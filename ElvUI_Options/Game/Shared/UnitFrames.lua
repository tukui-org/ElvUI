...
local function GetOptionsTable_AuraBars(updateFunc, groupName)
	...
	if E.Retail then
		...
		config.args.filtersGroup.args.isAuraPlayer = ACH:Toggle(L["Player"], nil, 1)
		config.args.filtersGroup.args.isAuraRaid = ACH:Toggle(L["Raid"], nil, 2)
		config.args.filtersGroup.args.isAuraCancelable = ACH:Toggle(L["Is Cancelable"], nil, 3)
		config.args.filtersGroup.args.notAuraCancelable = ACH:Toggle(L["Not Cancelable"], nil, 4)
		config.args.filtersGroup.args.isAuraImportant = ACH:Toggle(L["Important"], nil, 10, nil, nil, nil, nil, nil, nil, not patchReady)
		config.args.filtersGroup.args.isAuraCrowdControl = ACH:Toggle(L["Crowd Control"], nil, 11, nil, nil, nil, nil, nil, nil, not patchReady)
		config.args.filtersGroup.args.isAuraBigDefensive = ACH:Toggle(L["Big Defensive"], nil, 13, nil, nil, nil, nil, nil, nil, not patchReady)
		config.args.filtersGroup.args.isAuraRaidInCombat = ACH:Toggle(L["Raid Frames (Others)"], nil, 14, nil, nil, nil, nil, nil, nil, not patchReady)
		config.args.filtersGroup.args.isAuraRaidInCombatPlayer = ACH:Toggle(L["Raid Frames (Player)"], nil, 14, nil, nil, nil, nil, nil, nil, not patchReady)
		config.args.filtersGroup.args.isAuraRaidPlayerDispellable = ACH:Toggle(L["Player Dispelable"], nil, 12, nil, nil, nil, nil, nil, nil, not patchReady)
		config.args.filtersGroup.args.isAuraDefensive = ACH:Toggle(L["Defensive"], nil, 15, nil, nil, nil, nil, nil, nil, not E.Retail)
	else
...
local function GetOptionsTable_Auras(auraType, updateFunc, groupName, numUnits)
	...
	config.args.midnightGroup.args.isAuraPlayer = ACH:Toggle(L["Player"], nil, 1)
	config.args.midnightGroup.args.isAuraRaid = ACH:Toggle(L["Raid"], nil, 2)
	config.args.midnightGroup.args.isAuraCancelable = ACH:Toggle(L["Is Cancelable"], nil, 3)
	config.args.midnightGroup.args.notAuraCancelable = ACH:Toggle(L["Not Cancelable"], nil, 3)
	config.args.midnightGroup.args.isAuraImportant = ACH:Toggle(L["Important"], nil, 10, nil, nil, nil, nil, nil, nil, not patchReady)
	config.args.midnightGroup.args.isAuraCrowdControl = ACH:Toggle(L["Crowd Control"], nil, 11, nil, nil, nil, nil, nil, nil, not patchReady)
	config.args.midnightGroup.args.isAuraBigDefensive = ACH:Toggle(L["Big Defensive"], nil, 13, nil, nil, nil, nil, nil, nil, not patchReady)
	config.args.midnightGroup.args.isAuraRaidInCombat = ACH:Toggle(L["Raid Frames (Others)"], nil, 14, nil, nil, nil, nil, nil, nil, not patchReady)
	config.args.midnightGroup.args.isAuraRaidInCombatPlayer = ACH:Toggle(L["Raid Frames (Player)"], nil, 14, nil, nil, nil, nil, nil, nil, not patchReady)
	config.args.midnightGroup.args.isAuraRaidPlayerDispellable = ACH:Toggle(L["Player Dispelable"], nil, 12, nil, nil, nil, nil, nil, nil, not patchReady)
	config.args.midnightGroup.args.isAuraDefensive = ACH:Toggle(L["Defensive"], nil, 15, nil, nil, nil, nil, nil, nil, not E.Retail)
