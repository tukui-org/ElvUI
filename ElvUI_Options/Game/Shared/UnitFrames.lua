...
local function GetOptionsTable_AuraBars(updateFunc, groupName)
	...
	if E.Retail then
		...
		config.args.filtersGroup.args.isAuraImportant = ACH:Toggle(L["Important"], nil, 10, nil, nil, nil, nil, nil, nil, not E.Retail)
		config.args.filtersGroup.args.isAuraCrowdControl = ACH:Toggle(L["Crowd Control"], nil, 11, nil, nil, nil, nil, nil, nil, not E.Retail)
		config.args.filtersGroup.args.isAuraBigDefensive = ACH:Toggle(L["Big Defensive"], nil, 13, nil, nil, nil, nil, nil, nil, not E.Retail)
		config.args.filtersGroup.args.isAuraRaidInCombat = ACH:Toggle(L["Raid Frames"], nil, 14, nil, nil, nil, nil, nil, nil, not E.Retail)
		config.args.filtersGroup.args.isAuraRaidPlayerDispellable = ACH:Toggle(L["Player Dispelable"], nil, 12, nil, nil, nil, nil, nil, nil, not E.Retail)
...
local function GetOptionsTable_Auras(auraType, updateFunc, groupName, numUnits)
	...
	config.args.midnightGroup.args.isAuraImportant = ACH:Toggle(L["Important"], nil, 10, nil, nil, nil, nil, nil, nil, not E.Retail)
	config.args.midnightGroup.args.isAuraCrowdControl = ACH:Toggle(L["Crowd Control"], nil, 11, nil, nil, nil, nil, nil, nil, not E.Retail)
	config.args.midnightGroup.args.isAuraBigDefensive = ACH:Toggle(L["Big Defensive"], nil, 13, nil, nil, nil, nil, nil, nil, not E.Retail)
	config.args.midnightGroup.args.isAuraRaidInCombat = ACH:Toggle(L["Raid Frames"], nil, 14, nil, nil, nil, nil, nil, nil, not E.Retail)
	config.args.midnightGroup.args.isAuraRaidPlayerDispellable = ACH:Toggle(L["Player Dispelable"], nil, 12, nil, nil, nil, nil, nil, nil, not E.Retail)
