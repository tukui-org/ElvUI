...
local SharedOptions = {
	...
	fadeThreshold = ACH:Range(L["Fade Threshold"], L["Threshold before the icon will fade out and back in. Set to -1 to disable."], 26, { min = -1, max = 30, step = 1 }, nil, nil, nil, nil, E.Modern),

	tooltip = ACH:Group(L["Tooltip"], nil, -3, nil, nil, nil, nil, E.Modern),
