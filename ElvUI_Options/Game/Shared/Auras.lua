...
local SharedOptions = {
	...
	horizontalSpacing = ACH:Range(E.PTR and L["Spacing"] or L["Horizontal Spacing"], nil, 24, { min = -5, max = 50, step = 1 }),
	verticalSpacing = ACH:Range(L["Vertical Spacing"], nil, 25, { min = -5, max = 50, step = 1 }, nil, nil, nil, nil, E.PTR),
