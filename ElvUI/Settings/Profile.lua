		...
		['ENEMY_NPC'] = {
			...
			['buffs'] = {
				...
				['filters'] = {
					['minDuration'] = 0,
					['maxDuration'] = 0,
					['priority'] = 'Blacklist,RaidBuffsElvUI,blockNoDuration,PlayerBuffs,TurtleBuffs' --NamePlate EnemyNPC Buffs
				},
			},
			['debuffs'] = {
				['enable'] = true,
	...
	['units'] = {
		...
		['target'] = {
			...
			['aurabar'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 120,
				['priority'] = 'Blacklist,blockNoDuration,Personal,PlayerBuffs,Boss,RaidDebuffs', --Target AuraBars
				['friendlyAuraType'] = 'HELPFUL',
				['enemyAuraType'] = 'HARMFUL',
				['height'] = 20,
				['sort'] = 'TIME_REMAINING',
