...
P.unitframe.units.player.fader.unittarget = nil
...
P.unitframe.units.targettargettarget.name.text_format = '[namecolor][name:medium]'
...
P.unitframe.units.focustarget.name.text_format = '[namecolor][name:medium]'
...
P.unitframe.units.pettarget.name.text_format = '[namecolor][name:medium]'
...
P.unitframe.units.raidpet.priority = 'Blacklist,Personal,Boss,PlayerBuffs,blockNoDuration,nonPersonal'
P.unitframe.units.raidpet.priority = 'Blacklist,Personal,Boss,Whitelist,RaidDebuffs,blockNoDuration,nonPersonal'
