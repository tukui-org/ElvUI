		...
		['ENEMY_NPC'] = {
			...
			['buffs'] = {
				...
				['filters'] = {
					['minDuration'] = 0,
					['maxDuration'] = 0,
					['priority'] = 'Blacklist,blockNoDuration,PlayerBuffs,TurtleBuffs,CastByUnit' --NamePlate EnemyNPC Buffs
				},
			},
			['debuffs'] = {
				['enable'] = true,
	...
	['units'] = {
		['player'] = {
			...
			['aurabar'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 120,
				['priority'] = 'Blacklist,blockNoDuration,Personal,Boss,RaidDebuffs,PlayerBuffs,Whitelist', --Player AuraBars
		...
		['target'] = {
			...
			['debuffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,Personal,nonPersonal', --Target Deuffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['castbar'] = {
			...
			['aurabar'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 120,
				['priority'] = 'Blacklist,blockNoDuration,Personal,PlayerBuffs,Boss,RaidDebuffs,Whitelist', --Target AuraBars
				['friendlyAuraType'] = 'HELPFUL',
				['enemyAuraType'] = 'HARMFUL',
				['height'] = 20,
				['sort'] = 'TIME_REMAINING',
		...
		['targettarget'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,Personal,PlayerBuffs,Dispellable,Whitelist', --TargetTarget Buffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['debuffs'] = {
		...
		['focus'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,Personal,PlayerBuffs,CastByUnit,Dispellable,Whitelist', --Focus Buffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['debuffs'] = {
			...
			['aurabar'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 120,
				['priority'] = 'Blacklist,blockNoDuration,Personal,PlayerBuffs,Boss,RaidDebuffs,Whitelist', --Focus AuraBars
				['friendlyAuraType'] = 'HELPFUL',
				['enemyAuraType'] = 'HARMFUL',
				['height'] = 20,
				['sort'] = 'TIME_REMAINING',
		...
		['focustarget'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,Personal,PlayerBuffs,Dispellable,CastByUnit,Whitelist', --FocusTarget Buffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['debuffs'] = {
		...
		['pet'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,Personal,PlayerBuffs,Whitelist', --Pet Buffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['debuffs'] = {
		...
		['pettarget'] = {
			...
			['debuffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,Personal,Boss,RaidDebuffs,Whitelist', --PetTarget Debuffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
		},
		...
		['arena'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,TurtleBuffs,PlayerBuffs,Dispellable,Whitelist', --Arena Buffs
				['sizeOverride'] = 27,
				['xOffset'] = 0,
				['yOffset'] = 16,
			},
		...
		['party'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,TurtleBuffs,Whitelist', --Party Buffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['debuffs'] = {
		...
		['raid'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,TurtleBuffs,Whitelist', --Raid Buffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['debuffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,Boss,RaidDebuffs,CCDebuffs,Dispellable,Whitelist', --Raid Debuffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['buffIndicator'] = {
		...
		['raid40'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 300,
				['priority'] = 'Blacklist,TurtleBuffs,Whitelist', --Raid40 Buffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['debuffs'] = {
		...
		['raidpet'] = {
			...
			['buffs'] = {
				...
				['minDuration'] = 0,
				['maxDuration'] = 0,
				['priority'] = 'Blacklist,Personal,Boss,Whitelist,PlayerBuffs,blockNoDuration,nonPersonal', --RaidPet Buffs
				['xOffset'] = 0,
				['yOffset'] = 0,
			},
			['debuffs'] = {
