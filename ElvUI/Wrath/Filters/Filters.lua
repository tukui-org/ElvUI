...
G.unitframe.aurawatch = {
	...
	DRUID = {
		[1126]	= UF:AuraWatch_AddSpell(1126, {5232,6756,5234,8907,9884,9885,26990,48469,21849,21850,26991,48470}, 'TOPLEFT', {0.2, 0.8, 0.8}, true), -- Mark of the Wild
		[467]	= UF:AuraWatch_AddSpell(467, {782,1075,8914,9756,9910,26992,53307}, 'TOPRIGHT', {0.4, 0.2, 0.8}, true), -- Thorns
		[774]	= UF:AuraWatch_AddSpell(774, {1058,1430,2090,2091,3627,8910,9839,9840,9841,25299,26981,26982,48440,48441}, 'BOTTOMLEFT', {0.83, 1.00, 0.25}), -- Rejuvenation
		[8936]	= UF:AuraWatch_AddSpell(8936, {8938,8939,8940,8941,9750,9856,9857,9858,26980,48442,48443}, 'BOTTOMRIGHT', {0.33, 0.73, 0.75}), -- Regrowth
		[29166]	= UF:AuraWatch_AddSpell(29166, nil, 'CENTER', {0.49, 0.60, 0.55}, true), -- Innervate
		[33763]	= UF:AuraWatch_AddSpell(33763, {48450,48451}, 'BOTTOM', {0.33, 0.37, 0.47}), -- Lifebloom
		[48438]	= UF:AuraWatch_AddSpell(48438, {53248,53249,53251}, 'BOTTOMRIGHT', {0.8, 0.4, 0}), -- Wild Growth

		-- TODO: Abolish Poison
	},
	HUNTER = {
		[19506]	= UF:AuraWatch_AddSpell(19506, nil, 'TOPLEFT', {0.89, 0.09, 0.05}),		-- Trueshot Aura
		[13159]	= UF:AuraWatch_AddSpell(13159, nil, 'TOP', {0.00, 0.00, 0.85}, true),	-- Aspect of the Pack
		[20043]	= UF:AuraWatch_AddSpell(20043, {20190,27045,49071}, 'TOP', {0.33, 0.93, 0.79}),	-- Aspect of the Wild

		-- TODO: Misdirection
	},
	MAGE = {
		[1459]	= UF:AuraWatch_AddSpell(1459, {1460,1461,10156,10157,27126,42995}, 'TOPLEFT', {0.89, 0.09, 0.05}, true),		-- Arcane Intellect
		[23028]	= UF:AuraWatch_AddSpell(23028, {27127,43002}, 'TOPLEFT', {0.89, 0.09, 0.05}, true),	-- Arcane Brilliance
		[61024]	= UF:AuraWatch_AddSpell(61024, nil, 'TOPLEFT', {0.89, 0.09, 0.05}, true),	-- Dalaran Intellect
	...
	PRIEST = {
		...
		[21562]	= UF:AuraWatch_AddSpell(21562, {21564,25392,48162}, 'TOPLEFT', {1, 1, 0.66}, true),			-- Prayer of Fortitude
		[14752]	= UF:AuraWatch_AddSpell(14752, {14818,14819,27841,25312,48073}, 'TOPRIGHT', {0.2, 0.7, 0.2}, true),		-- Divine Spirit
		[27681]	= UF:AuraWatch_AddSpell(27681, {32999,48074}, 'TOPRIGHT', {0.2, 0.7, 0.2}, true),		-- Prayer of Spirit
		[976]	= UF:AuraWatch_AddSpell(976, {10957,10958,25433,48169}, 'BOTTOMLEFT', {0.7, 0.7, 0.7}, true),		-- Shadow Protection
	...
	WARRIOR = {
		[6673]	= UF:AuraWatch_AddSpell(6673, {5242,6192,11549,11550,11551,25289,2048,47436}, 'TOPLEFT', {0.2, 0.2, 1}, true),		-- Battle Shout
		[469]	= UF:AuraWatch_AddSpell(469, {47439,47440}, 'TOPRIGHT', {0.4, 0.2, 0.8}, true),	-- Commanding Shout
	},
	PET = {
	-- Warlock Imp
		[6307]	= UF:AuraWatch_AddSpell(6307, {7804,7805,11766,11767,27268,47982}, 'BOTTOMLEFT', {0.89, 0.09, 0.05}),	-- Blood Pact

	-- Warlock Felhunter
		[54424]	= UF:AuraWatch_AddSpell(54424, {57564,57565,57566,57567}, 'BOTTOMLEFT', {0.2, 0.8, 0.2}),	-- Fel Intelligence

	-- Hunter Pets
		[24604]	= UF:AuraWatch_AddSpell(24604, {64491,64492,64493,64494,64495}, 'TOPRIGHT', {0.08, 0.59, 0.41}),	-- Furious Howl
	},
}
