...
L["Important Group Members:"] = "小隊重要成員"
...
L["Enabling/Disabling Bar #6 will toggle a paging option from your main actionbar to prevent duplicating bars, are you sure you want to do this?"] = "啟用/停用 快捷列6 會在你的主快捷列開啟一個分頁選項來防止重複的快捷列, 你確定你真的想要如此做嗎?"
