...
if DB.client == "ruRU" then
	...
	L.popup_rightchatwarn = 'Вы самостоятельно убрали правое окно чата, от которого зависит корректная работа Elvui. Запретите правое окно чата в конфигурации или нажмите "Принять" для сброса настроек чата сейчас.'
	...
	L.core_welcome1 = "Добро пожаловать в |cffFF6347Elvui редакции Elv|r, версии "
	...
	L.core_uihelp2 = "|cffFF0000/tracker|r - Elvui Arena Enemy Cooldown Tracker - PVP-таймер вражеских перезарядок . (только иконка)"
	L.core_uihelp3 = "|cffFF0000/rl|r - Перезагрузить интерфейс."
	L.core_uihelp4 = "|cffFF0000/gm|r - Связь с ГМ-ом и игровая помощь."
	L.core_uihelp5 = "|cffFF0000/frame|r - Показать имя рамки под курсором мыши. (очень удобно для редактирования LUA)"
	L.core_uihelp6 = "|cffFF0000/heal|r - Включить healing раскладку рейдовых фремов."
	L.core_uihelp7 = "|cffFF0000/dps|r - Включить Dps/Tank раскладку рейдовых фреймов."
	L.core_uihelp8 = "|cffFF0000/uf|r - ВКЛ/ВЫКЛ перемещение рамок юнитов."
	L.core_uihelp9 = "|cffFF0000/bags|r - сортировка, покупка банковских ячеек и складывание предметов в ваших сумках."
	L.core_uihelp10 = "|cffFF0000/installui|r - сбросить переменные и настройки чата в значения Elvui по умолчанию"
	L.core_uihelp11 = "|cffFF0000/rd|r - распустить рейд."
	L.core_uihelp12 = "|cffFF0000/wf|r - разблокировать окно отслеживания заданий для перемещения."
	L.core_uihelp13 = "|cffFF0000/mss|r - передвинуть панель стоек/тотемов."
	L.core_uihelp15 = "|cffFF0000/ainv|r - Включить автоприглашение по слову. Вы можете установить нужное слово, напечатав '/ainv слово'"
	L.core_uihelp16 = "|cffFF0000/resetgold|r - сбросить статистику золота"
	...
	L.core_uihelp19 = "|cffFF0000/farmmode|r - Переключает увеличение/уменьшение миникарты, удобно для фарма."
	L.core_uihelp20 = "|cffFF0000/micro|r - Переключает фиксацию позиции микроменю"
