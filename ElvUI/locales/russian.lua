...
L["P"] = "Гр"
L["Panel Backdrop"] = "Фон панелей чата"
L["PANEL_DESC"] = "Регулирование размеров левой и правой панелей. Это окажет эффект на чат и сумки."
L["Panel Height"] = "Высота панели чата"
L["Panels"] = "Панели"
L["Panel Texture (Left)"] = "Текстура левой панели чата"
L["Panel Texture (Right)"] = "Текстура правой панели чата"
L["Panel Width"] = "Ширина панели чата"
...
L['If not set to 0 then override the size of the aura icon to this.'] = "Если установленно не на 0, то устанавливать размер иконок аур на заданное число."
...
L["MT, MA First"] = "Танк, помошник и т.д."
L['On Cooldown'] = "Не прозрачная иконка на восстановлении"
L['Show Auras'] = "Показать ауры"
L['Raid-25 Frames'] = "Рейд 25";
L['Raid-10 Frames'] = "Рейд 10";
L['Raid-40 Frames'] = "Рейд 40";
L['Max Paging'] = "Макс-ное пролистывание";
L['When enabled the main actionbar will use the maximum amount of pages available. This means if you have another actionbar disabled, the actionbar page will become available on the main actionbar. Having this disabled will limit the main actionbar to two pages.'] = "Когда включено, основная панель будет использовать максимальное кол-во страниц для пролистывания. Это означает, что если какая-то из панелей отключена, то она будет доступна для пролистывания. Отключение опции ограничит пролистывание двумя панелями.";
L['List of words to color in chat if found in a message. If you wish to add multiple words you must seperate the word with a comma. To search for your current name you can use %MYNAME%.\n\nExample:\n%MYNAME%, ElvUI, RBGs, Tank'] = "Список слов для окрашивания, если они обнаружены в чате. Если вы хотите добавить несколько слов, то разделяйте их запятыми. Для поиска имени вашего нынешнего персонажа используйте %MYNAME%.\n\nПример:\n%MYNAME%, ElvUI, РБГ, Танк";
...
L['RL / ML Icons'] = "Иконки лидера/МЛ'а";
L['Location Text'] = "Локация";
...
L['Always Display'] = "Всегда";
L['Theme Set'] = "Тема установлена";
L['Theme Setup'] = "Тема";
L['Choose a theme layout you wish to use for your initial setup.'] = "Выберите тему, которую хотите использовать.";
L['You can always change fonts and colors of any element of elvui from the in-game configuration.'] = "Вы всегда можете изменить шрифты и цвета любого элемента ElvUI из меню конфигурации.";
