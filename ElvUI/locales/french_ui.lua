...
L["Hold Control + Right Click:"] = "Contrôle enfoncée + Clique droit"
...
L["Profile download complete from %s, but the profile %s already exists. Change the name or else it will overwrite the existing profile."] = "Téléchargement du profil de %s complet, mais le profil de % existe déjà. Changez le nom ou bien il écrasera le profil existant."
...
L["Farm Mode"] = "Mode Ferme"; -- Minimap middle click menu
...
L["TargetTargetTarget Frame"] = "Cadre TargetTargetTarget";
L["Tooltip"] = "Infobulle"
...
L["Are you sure you want to reset all the settings on this profile?"] = "Êtes-vous sur de vouloir réinitialiser tous les réglages sur ce profile?"
...
L["Do you swear not to post in technical support about something not working without first disabling the addon/module combination first?"] = "Jurez-vous de ne pas posté sur le support technique du forum sur quelque chose qui ne fonctionne pas sans avoir désactivé en premier la combinaison Addon/Module?"
...
L["It appears one of your AddOns have disabled the AddOn Blizzard_CompactRaidFrames. This can cause errors and other issues. The AddOn will now be re-enabled."] = "Il semble que l`un de vos Addon ait désactiver L`addon Blizzard_CompactRaidFrames. Ceci peut causer des erreur et d`autre problèmes. L`Addon vas être réactiver."
