...
L["UF Hide"] = "单位框架提示隐藏"
L["When in a raid group display if anyone in your raid is targetting the current tooltip unit."] = "显示团队中目标与你目前鼠标提示目标相同的队友"
...
L['The focus unit can be set by typing /focus when you are targetting the unit you want to focus. It is recommended you make a macro to do this.'] = "你可以通过 /focus 命令设置焦点目标."
