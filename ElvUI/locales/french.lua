...
if DB.client == "frFR" then
	...
	L.core_welcome1 = "Bienvenue sur |cffFF6347Elv's Edit de Elvui|r, version "
	...
	L.core_uihelp2 = "|cffFF0000/tracker|r - Elvui Arena Enemy Cooldown Tracker - Tracker PVP (Icone seulement)"
	L.core_uihelp3 = "|cffFF0000/rl|r - Recharger votre UI."
	L.core_uihelp4 = "|cffFF0000/gm|r - Envoyer une requete MJ ou voir l'aide dans le jeu."
	L.core_uihelp5 = "|cffFF0000/frame|r - Détecte le nom du cadre sur lequel votre souris est actuellement positionnée."
	L.core_uihelp6 = "|cffFF0000/heal|r - Activer l'interface heal."
	L.core_uihelp7 = "|cffFF0000/dps|r - Activer l'interface Tank/DPS."
	L.core_uihelp8 = "|cffFF0000/uf|r - Activer ou désactivez le déplacement des cadres d'unités."
	L.core_uihelp9 = "|cffFF0000/bags|r - pour trier, acheter des places en banque ou empiler des objets dans vos sacs."
	L.core_uihelp10 = "|cffFF0000/installui|r - Réinitialiser les variables et le Chat."
	L.core_uihelp11 = "|cffFF0000/rd|r - Disooudre le raid."
	L.core_uihelp12 = "|cffFF0000/hb|r - assigner des raccourcis à vos boutons d'actions."
	L.core_uihelp13 = "|cffFF0000/mss|r - Déplacer la barre de changeforme / totem."
	L.core_uihelp15 = "|cffFF0000/ainv|r - Activer l'invitation automatique par mot clé en chuchoter. Vous pouvez choisir votre mot clé en tapant <code>/ainv monmotclé</code>"
	L.core_uihelp16 = "|cffFF0000/resetgold|r - Réinitialiser les informations relatives à l'or"
	L.core_uihelp17 = "|cffFF0000/moveele|r - Affiche les portraits d'unités pour pouvoir les déplacer."
	L.core_uihelp18 = "|cffFF0000/resetele|r - Réinitialiser les éléments à leurs places par défaut. Vous pouvez réinitialiser seulement un élément avec /resetele <nom de l'élément>."
