...
L["Average Group iLvl:"] = "Nivel de Objeto Medio del Grupo";
L["Bars"] = "Barras"
...
L["iLvl"] = "Nivel de Objeto"; --Column header in raidbrowser
L["Important Group Members:"] = "Miembros del Grupo Importantes";
L["Left Click:"] = "Click Izquierdo"
L["Raid Browser"] = "Navegador de Banda"; -- Minimap middle click menu
L["Raid Menu"] = "Menú de Banda"
L["Remaining:"] = "Restante"
L["Rested:"] = "Descansado:"
L["Right Click:"] = "Click Derecho"
L["Show BG Texts"] = "Mostrar Textos de CB"
L["Talent Spec"] = "Especialización de Talentos"; --Column header in raidbrowser
...
L["Enabling/Disabling Bar #6 will toggle a paging option from your main actionbar to prevent duplicating bars, are you sure you want to do this?"] = "Activar/Desactivar la barra #6 alternará la opción de paginación de tu barra de acción principal para prevenir barras duplicadas, ¿estás seguro que quieres hacer esto?";
