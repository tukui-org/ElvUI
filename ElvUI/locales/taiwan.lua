...
if E.client == "zhTW" then
	...
	L.core_welcome1 = "歡迎使用 |cffFF6347Elv's Edit of Elvui|r, 版本號 "
	...
	L.core_uihelp2 = "|cffFF0000/tracker|r - Elvui 競技場敵方冷卻監視器 - 一個精簡的PvP冷卻監視器 (Icon only)"
	L.core_uihelp3 = "|cffFF0000/rl|r - 重新載入使用者介面"
	L.core_uihelp4 = "|cffFF0000/gm|r - 聯繫GM或開啟魔獸世界幫助訊息"
	L.core_uihelp5 = "|cffFF0000/frame|r - 偵測滑鼠位置上的框架名稱 (對於lua編輯非常有幫助)"
	L.core_uihelp6 = "|cffFF0000/heal|r - 啟用治療的版面設定"
	L.core_uihelp7 = "|cffFF0000/dps|r - 啟用Dps/Tank的版面設定"
	L.core_uihelp8 = "|cffFF0000/uf|r - 移動及鎖定單位框架"
	L.core_uihelp9 = "|cffFF0000/bags|r - 排序背包, 購買銀行欄位或重新堆疊背包/銀行內的物品"
	L.core_uihelp10 = "|cffFF0000/installui|r - 重置設定為預設值"
	L.core_uihelp11 = "|cffFF0000/rd|r - 解散團隊"
	L.core_uihelp12 = "|cffFF0000/hb|r - 設置動作列快捷鍵"
	L.core_uihelp13 = "|cffFF0000/mss|r - 移動姿態/變形列和圖騰列"
	L.core_uihelp15 = "|cffFF0000/ainv|r - 輸入關鍵字以啟用密語自動邀請, 可以自行設定關鍵字, 指令為`/ainv 關鍵字`"
	L.core_uihelp16 = "|cffFF0000/resetgold|r - 重置金錢記錄"
	L.core_uihelp17 = "|cffFF0000/moveele|r - 移動或鎖定單位視窗可移動部位"
	L.core_uihelp18 = "|cffFF0000/resetele|r - 將所有可移動部位重置回預設位置，重置單一部位請用/resetele <部位名稱>."
	L.core_uihelp19 = "|cffFF0000/farmmode|r - 增加或減少小地圖的大小, farming很有用."
	L.core_uihelp20 = "|cffFF0000/micro|r - 移動或鎖定微型工作列"
