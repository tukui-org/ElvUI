...
if E.client == "deDE" then
	...
	L.ElvUIInstall_page1_desc1 = "Dieser Installationsprozess wird Ihnen helfen, die Funktionen von ElvUI für Ihre Benutzeroberfläche\nbesser kennenzulernen"
	L.ElvUIInstall_page1_desc2 = "Sie können den Befehl /uihelp benutzen, um eine kleine Liste aller Befehle zu erhalten.\nDie Ingame-Konfiguration können Sie entweder mit /ec oder /elvui aufrufen.\nDrücken Sie 'Schritt überspringen', um zum nachsten Schritt zu gelangen."
	L.ElvUIInstall_page1_button1 = "Schritt überspringen"

	L.ElvUIInstall_page2_subtitle = "CVars"
	L.ElvUIInstall_page2_desc1 = "Dieser Installationsprozess richtet alle wichtigen Cvars Ihres World of Warcrafts ein,\num eine problemlose Nutzung zu ermöglichen.."
	...
	L.ElvUIInstall_page3_desc1 = "Dieser Installationsprozess richtet Ihre Chatfenster, Positionen der Fenster, sowie\ndie Namen der Chatfenster ein."
	L.ElvUIInstall_page3_desc2 = "Klicke 'Installiere Chateinstellungen' um die Installation der Chatfenster zu beginnen.\nSie müssen diesen Schritt ausführen, um eine korrekte Installation der Chatfenster zu erhalten."
	L.ElvUIInstall_page3_button1 = "Installiere Chateinstellungen"

	L.ElvUIInstall_page4_subtitle = "Auflösung"
	L.ElvUIInstall_page4_desc1 = "Ihre derzeitige Auflösung ist: %s\nElvUI hat automatisch für sie %s gewählt\n(Basierend auf Ihrer Bildschirmauflösung)."
	L.ElvUIInstall_page4_desc2 = "Dieser Installationsprozess steuert die Einstellung Ihrer Aktionsleisten und Ihrer Einheitenfenster.\nSie können diese in der In-Game Konfiguration auch selbst ändern."
	L.ElvUIInstall_Low = "Low"
	L.ElvUIInstall_High = "High"

	L.ElvUIInstall_page5_subtitle = "Aktionsleisten"
	L.ElvUIInstall_page5_desc1 = "Nach der Einrichtung und Installation der Aktionsleisten können Sie diese\n durch den 'L' Knopf am unteren linken Chatfenster verschieben."
	L.ElvUIInstall_page5_desc2 = "Um schnelle Tastenkürzel setzen zu können, benutzen Sie den Befehl /hb.\nUm einzelne Aktionsknöpfe verschieben zu können\nhalten Sie die Taste 'SHIFT' gedrückt."

	L.ElvUIInstall_page6_subtitle = "Einheitenfenster"
	L.ElvUIInstall_page6_desc1 = "Nach der Einrichtung und Installation der Einheitenfenster, können Sie diese\ndurch den 'L' Knopf am unteren linken Chatfenster verschieben."
	L.ElvUIInstall_page6_desc2 = "Sie können mittels der Befehle /dps oder /heal zwischen zwei verschiedenen Layouts wechseln."
	L.ElvUIInstall_page6_desc3 = "Wenn Sie die Einheitenfenster mit den Standard-Einstellungen einrichten wollen, klicken Sie\n'Positioniere Einheitenfenster'"
	L.ElvUIInstall_page6_button1 = "Positioniere Einheitenfenster"

	L.ElvUIInstall_page7_subtitle = "Installation komplett"
	L.ElvUIInstall_page7_desc1 = "Sie haben die Installation erfolgreich abgeschlossen.\nSollten Sie technischen Support benötigen,besuchen Sie uns unter\nwww.tukui.org."
