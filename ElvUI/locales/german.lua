...
if E.client == "deDE" then
	...
	L.core_uihelp2 = "|cffFF0000/tracker|r - Elvui Arena Gegner Abklingzeiten Anzeige - Low-memory Gegner PVP Abkling Anzeige. (Nur Icons)"
	L.core_uihelp3 = "|cffFF0000/rl|r - Benutzer Interface neu laden."
	L.core_uihelp4 = "|cffFF0000/gm|r - Schicke GM Tickets oder öffnet die WoW Ingame Hilfe."
	L.core_uihelp5 = "|cffFF0000/frame|r - Zeigt im Chat den Namen des Fensters über dem sich die Maus befindet. (Hilfreich für Lua Editoren)"
	L.core_uihelp6 = "|cffFF0000/heal|r - Aktiviert Heiler Raid Layout."
	L.core_uihelp7 = "|cffFF0000/dps|r - Aktiviert DPS/Tank Raid Layout."
	L.core_uihelp8 = "|cffFF0000/uf|r - Aktiviert oder deaktiviert das Bewegen der Einheitenfenster."
	L.core_uihelp9 = "|cffFF0000/bags|r - Zum Sortieren, Kaufen von Bankplätzen oder neu Stapeln von Gegenständen in deiner Tasche."
	L.core_uihelp10 = "|cffFF0000/installui|r - Wiederherstellung der ursprünglichen Elvui Einstellungen."
	L.core_uihelp11 = "|cffFF0000/rd|r - Raid auflösen."
	L.core_uihelp12 = "|cffFF0000/hb|r - Setzte Tastaturbelegung auf die Aktionsleisten"
	L.core_uihelp13 = "|cffFF0000/mss|r - Befehl, um die Haltungs-(Krieger), Präsenz-(Todesritter), Auren-(Paladin), Formen-(Druide), Schattengestalt-(Priester) und Totem-(Schamane) Leisten zu bewegen."
	L.core_uihelp15 = "|cffFF0000/ainv|r - Aktiviere autoinvite per Flüsterschlüsselwort. Du kannst durch Tippen von <code>/ainv meinwort</code> dein eigenes Schlüsselwort setzen."
	L.core_uihelp16 = "|cffFF0000/resetgold|r - Gold im Infotext zurücksetzen"
	L.core_uihelp17 = "|cffFF0000/moveele|r - Entsperrt diverse Einheitenfeatures(Castbars/Buffs/Debuffs/ComboBar)."
	L.core_uihelp18 = "|cffFF0000/resetele|r -  Resettet alle geänderten Einheitenfeatures(Castbars/Buffs/Debuffs/ComboBar). Ein bestimmtes Element kann man mit dem Befehl /resetele <elementname> resetten."
