...
L['If set, only auras belonging to yourself in addition to any aura that passes the set filter(s) may be shown. Note: You can change between only doing this on friendly or enemy units.'] = "Wenn dies aktiv ist, werden nur deine eigenen Auren und jene, die dem eingestellten Filter entsprechen, angezeigt."
...
L["Neutral"] = "Neutral"
L['Filter Raid Buffs'] = 'Nicht zusammengefasst'
L['Filter Auras with No Duration'] = 'Keine Dauer'
...
L["Up"] = "Hinauf"
L['Use Blacklist Filter'] = 'Benutze Blacklist';
L["Additional Filter"] = "Filter benutzen"
...
L['Use Whitelist Filter'] = 'Benutze Whitelist'
