...
if DB.client == "esES" then
	...
	L.core_welcome1 = "Bienvenido a la edición de |cffFF6347Elv of Elvui|r, versión "
	L.core_welcome2 = "Escribe |cff00FFFF/uihelp|r para más ayuda, escribe |cff00FFFF/Elvui|r para configurar, o visit http://www.tukui.org/v2/forums/forum.php?id=31"
 
	L.core_uihelp1 = "|cff00ff00Comandos Generales|r"
	L.core_uihelp2 = "|cffFF0000/tracker|r - Elvui Arena Enemy Cooldown Tracker - Low-memory enemy PVP cooldown tracker. (Solo Iconos)"
	L.core_uihelp3 = "|cffFF0000/rl|r - Recarga tu Interfaz de Usuario."
	L.core_uihelp4 = "|cffFF0000/gm|r - Envía peticiones MJ o muestra ayuda de WoW dentro del juego."
	L.core_uihelp5 = "|cffFF0000/frame|r - Detecta el nombre del cuadro donde tu ratón está actualmente posicionado. (muy útil para el editor lua)"
	L.core_uihelp6 = "|cffFF0000/heal|r - Activar distribución de banda para sanación."
	L.core_uihelp7 = "|cffFF0000/dps|r - Activar distribución de banda para DPS/Tanque."
	L.core_uihelp8 = "|cffFF0000/uf|r - Activa o desactiva el mover los cuadros de unidad."
	L.core_uihelp9 = "|cffFF0000/bags|r - para ordenar comprar espacios de banco o amontonar objetos en tus bolsas."
	L.core_uihelp10 = "|cffFF0000/installui|r - reinicia cVar y Chat Frames a los valores por defecto."
	L.core_uihelp11 = "|cffFF0000/rd|r - disolver banda."
	L.core_uihelp12 = "|cffFF0000/hb|r - asigna vinculaciones de teclas a tus botones de acción."
	L.core_uihelp13 = "|cffFF0000/mss|r - Mover la barra de cambio de forma o totem."
	L.core_uihelp15 = "|cffFF0000/ainv|r - Activar autoinvitar via palabra clave en susurros. Puedes asignar tu propia palabra clave escrubiendo <code>/ainv mipalabra</code>"
	L.core_uihelp16 = "|cffFF0000/resetgold|r - reinicia el texto de datos de oro"
	L.core_uihelp17 = "|cffFF0000/moveele|r - Desbloquea ciertos marcos de unidades para poder moverlos."
	L.core_uihelp18 = "|cffFF0000/resetele|r - Reinicia todos los elementos a su posición inicial. También puedes reiniciar un elemento concreto poniendo /resetele <nombrelemento>."
	L.core_uihelp19 = "|cffFF0000/farmmode|r - Activa aumentar/disminuir el tamaño del minimapa, útil para farmear."
	L.core_uihelp20 = "|cffFF0000/micro|r - Activa el desbloqueo de la Microbarra"	
