...
L["Bandwidth"] = "대역폭"
L["Bases Assaulted"] = "기지 공격"
L["Bases Defended"] = "기지 방어"
L["Carts Controlled"] = "수레 탈취"
L["Character: "] = "캐릭터:"
L["Chest"] = "가슴"
L["Combat"] = "전투"
...
L["Defeated"] = "패배"
L["Deficit:"] = "손해:"
L["Demolishers Destroyed"] = "파괴전차 파괴"
L["Download"] = "다운로드"
L["DPS"] = "DPS"
L["Earned:"] = "수입:"
L["Feet"] = "발"
L["Flags Captured"] = "깃발 탈취"
L["Flags Returned"] = "깃발 회수"
L["Friends List"] = "친구 목록"
L["Friends"] = "친구"
L["Gates Destroyed"] = "관문 파괴"
...
L["Total: "] = "합계:"
L["Towers Assaulted"] = "탑 공격"
L["Towers Defended"] = "탑 방어"
...
L["Pixel Perfect Set"] = "Pixel Perfect 사용"
...
L["Trade"] = "거래"
L["Using this option will cause your borders around frames to be 1 pixel wide instead of 3 pixel. You may have to finish the installation to notice a differance. By default this is enabled."] = "이 테마를 사용하면 3Pixel을 차지하던 기존의 테두리를 1Pixel로 줄입니다.|n설치가 끝나야 차이를 완전히 확인하실 수 있을 겁니다. 사용하는 걸 권장합니다."
...
L["Deleted %d gray items. Total Worth: %s"] = "총 %d개의 잡동사니를 버렸습니다:%s"
L["No gray items to delete."] = "잡동사니가 없습니다."
L["No gray items to sell."] = "잡동사니가 없습니다."
L['The spell "%s" has been added to the Blacklist unitframe aura filter.'] = "%s 주문이 차단 목록에 등록되었습니다."
L["Vendored gray items for:"] = "모든 잡동사니를 팔았습니다:%s"
...
L["ElvUI is out of date. You can download the newest version from http://www.tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "ElvUI가 오래된 버전입니다. http://www.tukui.org 에서 새 버전을 다운로드 받으세요. 프리미엄유저가 되어 Tukui Client 프로그램을 쓰면 자동으로 업데이트 해드립니다."
