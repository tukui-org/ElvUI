...
L["One or more of the default Blizzard AddOns are disabled. This can cause errors and other issues. We recommend you re-enable the AddOns. Re-enable Blizzard AddOns now?"] = "Eines oder mehrere Blizzard Standard Addons sind deaktiviert. Dieses kann zu Fehlern oder anderen Problemen führen. Wir empfehlen dir sie wieder zu aktivieren. Möchtest du sie jetzt aktivieren?"
L["Save"] = "Speichern"
