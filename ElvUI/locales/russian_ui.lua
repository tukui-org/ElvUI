...
L["I Swear"] = "Я клянусь!"
L["No, Revert Changes!"] = "Нет, обртить изменения!"
...
L["One or more of the default Blizzard AddOns are disabled. This can cause errors and other issues. We recommend you re-enable the AddOns. Re-enable Blizzard AddOns now?"] = "Один или более стандартных аддонов Blizzard были отключены. Это может вызвать ошибки и другие проблемы, мы рекомендуем включить. Включить аддоны Blizzard сейчас?"
L["Save"] = "Сохранить"
