...
L.core_welcome2 = "Type |cff1784d1/uihelp|r for more info, type |cff1784d1/ec|r or |cff1784d1/elvui|r to config, or visit http://www.tukui.org/v2/forums/forum.php?id=31"
...
L.core_uihelp22 = "|cffFF0000/resetui <arg>|r - Resets all moved UI objects to their default position (including unitframes), if argument is provided it will reset only the name of frame (this doesn't include unitframes). To only reset unitframes type '/resetui uf'"
