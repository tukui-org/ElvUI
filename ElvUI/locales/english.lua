...
ElvL.core_uihelp17 = "|cffFF0000/moveele <arg>|r - Toggles the unlocking of various unitframe elements, if argument is provided it will reset only the name of frame."
...
ElvL.core_uihelp22 = "|cffFF0000/resetui <arg>|r - Resets all moved UI objects to their default position, if argument is provided it will reset only the name of frame."
