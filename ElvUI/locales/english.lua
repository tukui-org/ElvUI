...
L['ElvUI has a dual spec feature which allows you to load differant profiles based on your current spec on the fly. You can enable this from the profiles tab.'] = true;
