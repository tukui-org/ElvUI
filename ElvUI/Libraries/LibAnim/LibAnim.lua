-- LibAnim by Hydra
-- GLOBALS: ElvUI, CreateAnimationGroup

local Version = 2.02
if _LibAnim and _LibAnim >= Version then return end

local tonumber, tinsert, tremove, strlower = tonumber, tinsert, tremove, strlower
local cos, sin, type, math, ipairs, pairs, floor = cos, sin, type, math, ipairs, pairs, floor
local AnimTypes, UpdateFuncs, Callbacks = {}, {}, {onplay={}, onpause={}, onresume={}, onstop={}, onreset={}, onfinished={}}
...
local Smoothing = {
	none = function(t, b, c, d) return c * t / d + b end,
	['in'] = function(t, b, c, d)
		t = t / d
		return c * t * t + b
	end,
...
local AnimMethods = {
	All = {
		...
		SetScript = function(self, handler, func)
			...
			if not Callbacks[handler] then return end
...
local GroupMethods = {
	...
	CreateAnimation = function(self, TYPE)
		...
		if not AnimTypes[TYPE] then return end
		local Animation = {}
