...
L["ElvUI is five or more revisions out of date. You can download the newest version from tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "ElvUI已过期5个或者更多的版本。你可以在tukui.org下载到最新的版本。购买会员可以使用Tukui客户端自动更新ElvUI"
L["ElvUI is out of date. You can download the newest version from tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "ElvUI已过期。你可以在tukui.org下载到最新的版本。购买会员可以使用Tukui客户端自动更新ElvUI"
...
L["Location"] = true
L["Lock"] = "锁定"
L["LOGIN_MSG"] = ("欢迎使用*ElvUI|r 版本*%.2f|r，输入*/ec|r 访问游戏内配置菜单。如果您需要技术支持，您可以访问我们的 https://tukui.org 或加入我们的 Discord：https://discord.gg/xFWcfgE"):gsub('*', E.InfoColor)
