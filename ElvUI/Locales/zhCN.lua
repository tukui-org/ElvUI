...
L["Plugins:"] = "插件:"
L["Version:"] = "版本:"
L["Equipment Sets"] = "装备设定"
L["No Set Equipped"] = "无装备设定"
L["Set:"] = "套装:"
L["New Mail"] = "新邮件"
L["No Mail"] = "没有邮件"
L["Completed XP:"] = "完成经验:"
...
L["%s is attempting to share the Global Profile with you. Would you like to accept the request?"] = "%s 试图与你分享全局配置文件. 你是否接受?"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from tukui.org."] = "ElvUI 已过期 5 个或者更多的版本. 你可以在 tukui.org 下载到最新的版本."
...
L["Please click the button below to setup your CVars."] = "请按下方按钮设置 CVars."
...
L["System"] = "系统信息"
L["Talent/Loot Specialization"] = "天赋/专精拾取"
...
L["You can see someones average item level inside the tooltip by holding shift and mousing over them."] = "按住 shift键并将鼠标悬停在鼠标提示中, 您可以查看他的平均物品等级."
