...
L["Countdown"] = "倒计时"
L["Reset"] = "重置"
L["ELVUI_DESC"] = ("*ElvUI|r|cFFffffff 是一套功能完整, 可用来替换WoW原始界面的套件|r"):gsub('*', E.InfoColor)
 ...
 */edebug|r ^on|r or ^off|r  -  禁用除 ElvUI 之外的所有插件。
  注意：*/edebug|r ^off|r 将重新启用从使用
  */edebug|r ^on|r 之前的会话中禁用的插件。
