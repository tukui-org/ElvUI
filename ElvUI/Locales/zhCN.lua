...
L["%s frame has a conflicting anchor point. Forcing the Buffs to be attached to the main unitframe."] = "%s 框架有一个冲突的锚点. 强制将增益附加到主单位框架上。"
...
L["Accepting this will reset the UnitFrame settings for %s. Are you sure?"] = "接受这个将重置 %s 的单位框架，你确定吗？"
...
L["Are you sure you want to reset every mover back to it's default position?"] = "确定要重置所有框架至默认位置吗？"
...
L["If you have an icon or aurabar that you don't want to display simply hold down shift and right click the icon for it to disapear."] = "如果你不希望显示某个光环图标或者光环条，只需要按住 shift并右键点击它。"
L["IL"] = "副本领袖"
...
L["The chat windows function the same as Blizzard standard chat windows, you can right click the tabs and drag them around, rename, etc. Please click the button below to setup your chat windows."] = "对话窗口与 WOW 原始对话窗口的操作方式相同，你可以右击标签以拖拽、重命名、等等。请点击下方按钮以设置对话窗口。"
...
L["This will change the layout of your unitframes and actionbars."] = "这将改变你的单位框架和动作条的布局"
L["Threat Bar"] = "仇恨条"
...
----------------------------------
L["DESC_MOVERCONFIG"] = [=[解除框架移动锁定。现在可以移动它们，完成后请点击 锁定。
