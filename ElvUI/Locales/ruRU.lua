...
L["ElvUI is five or more revisions out of date. You can download the newest version from tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "Ваш ElvUI устарел более чем на 5 версий. Обновите его на tukui.org. Или Вы можете автоматически обновлять его через Tukui Client с премиум-статусом."
L["ElvUI is out of date. You can download the newest version from tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "ElvUI устарел. Вы можете скачать последнюю версию на tukui.org. С премиум-аккаунтом ElvUI будет автоматически обновляться через Tukui клиент."
...
L["Location"] = "Локация"
L["Lock"] = "Закрепить"
L["LOGIN_MSG"] = ("Добро пожаловать в *ElvUI|r версии *%.2f|r, наберите */ec|r для доступа в меню настроек. Если Вам нужна техническая поддержка, посетите наш форум на https://tukui.org или присоединяйтесь к серверу Discord: https://discord.gg/xFWcfgE"):gsub('*', E.InfoColor)
...
L["Need help? Join our Discord: https://discord.gg/xFWcfgE"] = "Нужна помощь? Заходи в Discord: https://discord.gg/xFWcfgE"
