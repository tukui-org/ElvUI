...
L["Earned:"] = "Заработано:"
L["Elite"] = "Элита"
L["ElvUI Config"] = "Настройки ElvUI"
...
L["ElvUI is five or more revisions out of date. You can download the newest version from www.tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "Ваш ElvUI устарел более чем на 5 версий. Обновите его на www.tukui.org. Или Вы можете автоматически обновлять его через Tukui Client с премиум-статусом."
L["ElvUI is out of date. You can download the newest version from www.tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "ElvUI устарел. Вы можете скачать последнюю версию на www.tukui.org. С премиум-аккаунтом ElvUI будет автоматически обновляться через Tukui клиент."
