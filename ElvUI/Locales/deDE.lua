...
L["Armor Penetration"] = "Rüstungsdurchdringung"
...
L["Classic"] = "Klassisch"
L["Clear All Markers"] = "Lösche alle Markierungen"
L["Combat"] = "Kampf"
...
L["Include Warband"] = "Inklusive Kriegsmeute"
...
L["Private Raid Warning"] = "Private Schlachtzugswarnung"
...
L["Totem Tracker"] = "Totemverfolgung"
L["Trigger"] = "Auslöser"
...
L["AFK"] = "AFK"
L["AVD: "] = "AVD: "
L["BINDINGS_HELP"] = ("Bewege den Mauszeiger über eine beliebige *Aktion|r, *micro|r, *macro|r, or *spellbook|r button to bind it. Dies funktioniert auch für Gegenstände in Deiner *bag|r. Drücke die Taste ^ESC|r, um die aktuellen Bindungen zu löschen|r."):gsub('*', E.InfoColor):gsub('%^', E.InfoColor2)
L["DND"] = "DND"
L["DPS"] = "DPS"
...
L["LOGIN_MSG_HELP"] = ("Bitte verwende */ehelp|r für eine Liste der verfügbaren *ElvUI|r-Befehle."):gsub('*', E.InfoColor)
L["UPDATE_REQUEST"] = "Es scheint ein Problem mit Deiner Installation zu geben. Bitte installiere ElvUI neu."
