...
L["ElvUI is five or more revisions out of date. You can download the newest version from tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "현재 사용하는 ElvUI가 5버전 이상 뒤처진 버전입니다. http://tukui.org 에서 새 버전을 다운로드 받으세요. 프리미엄유저가 되어 Tukui Client 프로그램을 쓰면 자동으로 업데이트 해드립니다."
L["ElvUI is out of date. You can download the newest version from tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "ElvUI가 오래된 버전입니다. http://tukui.org 에서 새 버전을 다운로드 받으세요. 프리미엄유저가 되어 Tukui Client 프로그램을 쓰면 자동으로 업데이트 해드립니다."
...
L["Experience"] = "경험치"
L["Filter download complete from %s, would you like to apply changes now?"] = "%s 유저에게서 필터 설정 다운로드가 완료되었습니다. 변경 사항을 적용할까요?"
L["Finished"] = "마침"
L["Fishy Loot"] = "낚시 전리품"
...
L["From time to time you should compare your ElvUI version against the most recent version on our website or the Tukui client."] = "정기적으로 ElvUI 버전을 저희 웹 사이트 나 Tukui 클라이언트의 최신 버전과 비교해야 합니다."
L["G"] = "길드"
L["Ghost"] = "유령"
...
L["Need help? Join our Discord: https://discord.gg/xFWcfgE"] = "도움이 필요할 땐 우리 디스코드의 서버에 참가해 보세요: https://discord.gg/xFWcfgE"
...
L["Vendor / Delete Grays"] = "잡템 자동 판매/삭제"
