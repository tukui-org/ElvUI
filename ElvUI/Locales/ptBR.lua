...
L["%s frame has a conflicting anchor point. Forcing the Buffs to be attached to the main unitframe."] = "O quadro %s está conflitando com outro ponto de fixação. Forçando os Buffs serem anexados ao unitframe principal."
...
L["Accepting this will reset the UnitFrame settings for %s. Are you sure?"] = "Aceitar isso irá resetar suas configurações de UnitFrame para %s. Você tem certeza?"
...
L["Player NamePlate"] = "NamePlate do Jogador"
...
L["Reset Counters: Hold Ctrl + Right Click"] = "Resetar contadores: Segurar CTRL + Clique Direito"
...
L["System"] = "Sistema"
L["Talent/Loot Specialization"] = "Especialização em Talentos/Loot"
...
L["This will change the layout of your unitframes and actionbars."] = "Isso irá mudar o leiaute da sua UnitFrame e barra de ações"
...
L["Hunter Akana"] = "Caçador Akana"
L["Bladesman Inowari"] = "Espadachim Inowari"
L["Neri Sharpfin"] = "Neri Pinafiada"
L["Poen Gillbrack"] = "Xablau Guelbraque"
L["Vim Brineheart"] = "Vim Salcárdio"
