...
L["ElvUI is five or more revisions out of date. You can download the newest version from tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "O ElvUI está rodando com cinco ou mais revisões desatualizadas. Você pode baixar a mais nova versão em tukui.org. Compre a assinatura premium e tenha o ElvUI automaticamente atualizado com o Cliente Tukui!"
L["ElvUI is out of date. You can download the newest version from tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"] = "O ElvUI está desatualizado. Você pode baixar a mais nova versão em tukui.org. Compre a assinatura premium e tenha o ElvUI automaticamente atualizado com o Cliente Tukui!"
...
L["Location"] = true
L["Lock"] = "Travar"
L["LOGIN_MSG"] = ("Bem-vindo ao *ElvUI|r versão *%.2f|r, digite */ec|r para acessar as configurações dentro do jogo. Se você precisa de suporte técnico nos contate em https://tukui.org ou se entre no Discord: https://discord.gg/xFWcfgE"):gsub('*', E.InfoColor)
