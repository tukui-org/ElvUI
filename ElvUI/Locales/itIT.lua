...
L["A raid marker feature is available by pressing Escape -> Keybinds scroll to the bottom under ElvUI and setting a keybind for the raid marker."] = "Una funzione marker di raid è disponibile premendo Esc -> Assegnazione Tasti scorrere fino in fondo sotto ElvUI e impostando un tasto di scelta rapida per il marker raid."
...
L["DPS"] = true
L["Earned:"] = true
L["ElvUI has a dual spec feature which allows you to load different profiles based on your current spec on the fly. You can enable this from the profiles tab."] = "ElvUI ha una funzionalità che ti consente di caricare diversi profili in base alle tue specializzazioni correnti al volo. Puoi abilitarlo dalla scheda profili."
...
L["Focus"] = true
L["FocusTarget"] = true
L["For technical support visit us at http://www.tukui.org."] = "Per supporto tecnico, visitare il nostro sito Web http://www.tukui.org."
L["Friends List"] = true
L["G"] = true
L["Garrison"] = true
L["Ghost"] = true
...
L["The focus unit can be set by typing /focus when you are targeting the unit you want to focus. It is recommended you make a macro to do this."] = "Il focus unità può essere impostato digitando /focus quando si sta mirando all'unità che si desidera targhettare. Si consiglia di creare una macro per farlo."
...
L["To move abilities on the actionbars by default hold shift + drag. You can change the modifier key from the actionbar options menu."] = "Per spostare le abilità sulle barre delle azioni di default tieni premuto MAIUSC + trascina. È possibile modificare il tasto modificatore dal menu delle opzioni della barra delle azioni."
L["To setup which channels appear in which chat frame, right click the chat tab and go to settings."] = "Per impostare quali canali da visualizzare nei frame della chat, fai clic con il pulsante destro del mouse sulla scheda della chat e vai alle impostazioni."
L["Toggle Bags"] = true
...
L["You can access copy chat and chat menu functions by mouse over the top right corner of chat panel and left/right click on the button that will appear."] = "Puoi accedere alle funzioni di copia chat e menu chat passando il mouse sull'angolo in alto a destra del pannello e facendo click sinistro/destro sul bottone che apparirà."
...
L["You can see someones average item level of their gear by holding shift and mousing over them. It should appear inside the tooltip."] = "Puoi vedere il livello medio degli oggetti di alcuni dei loro equipaggiamenti tenendo premuto il tasto MAIUSC e muovendoti sopra di essi. Dovrebbe apparire all'interno della descrizione comandi."
L["You can set your keybinds quickly by typing /kb."] = "Puoi impostare rapidamente i tuoi tasti di scelta rapida digitando /kb."
L["You can toggle the microbar by using your middle mouse button on the minimap you can also accomplish this by enabling the actual microbar located in the actionbar settings."] = "È possibile attivare o disattivare la microbar utilizzando il pulsante centrale del mouse sulla minimappa, inoltre puoi farlo semplicemente abilitando la microbar dalle impostazioni della barra delle azioni."
L["You can use the /resetui command to reset all of your movers. You can also use the command to reset a specific mover, /resetui <mover name>.\nExample: /resetui Player Frame"] = "È possibile utilizzare il comando /resetui per ripristinare tutti i motori. Puoi anche usare il comando per resettare uno motore specifico, /resetui <nome motore>.\nEsempio: /resetui Frame Personaggio"
