...
L["UPDATE_REQUEST"] = "Parece que hay un problema con tu instalación de ElvUI. Esto puede ser el resultado de que tu cliente Tukui no esté actualizado. Por favor visita nuestra página de descargas y actualiza tu Cliente Tukui, luego reinstala ElvUI."
...
L["Location"] = true
L["Lock"] = "Bloquear"
L["LOGIN_MSG"] = ("Bienvenido a *ElvUI|r versión *%.2f|r, escribe */ec|r para acceder al menú de configuración del juego. Si necesita ayuda, puede visítenos en https://tukui.org o unirse a nuestro Discord: https://discord.gg/xFWcfgE"):gsub('*', E.InfoColor)
