...
function AFK:SetAFK(status)
	if(status) then
		...
		--self.AFKMode.bottom.model.delay = 2.3
...
function AFK:LoopAnimations()
	if(ElvUIAFKPlayerModel.curAnimation == "wave") then
		...
		ElvUIAFKPlayerModel.delay = 25
		ElvUIAFKPlayerModel.isIdle = false
	elseif(ElvUIAFKPlayerModel.curAnimation == "dance") then
		ElvUIAFKPlayerModel:SetAnimation(74)
		ElvUIAFKPlayerModel.curAnimation = "roar"
		ElvUIAFKPlayerModel.startTime = GetTime()
		ElvUIAFKPlayerModel.delay = 3
		ElvUIAFKPlayerModel.isIdle = false		
	elseif(ElvUIAFKPlayerModel.curAnimation == "roar") then
		ElvUIAFKPlayerModel:SetAnimation(70)
		ElvUIAFKPlayerModel.curAnimation = "laugh"
		ElvUIAFKPlayerModel.startTime = GetTime()
		ElvUIAFKPlayerModel.delay = 0 --3.2
		ElvUIAFKPlayerModel.isIdle = true
	--[[elseif(ElvUIAFKPlayerModel.curAnimation == "laugh") then
		ElvUIAFKPlayerModel:SetAnimation(100)
		ElvUIAFKPlayerModel.curAnimation = "sleep"
		ElvUIAFKPlayerModel.startTime = GetTime()
		ElvUIAFKPlayerModel.delay = 0
		ElvUIAFKPlayerModel.isIdle = true]]			
	end
end
...
function AFK:Initialize()
	...
	self.AFKMode.bottom.name:SetFont(E.LSM:Fetch("font", "ElvUI Alt-Combat"), 24, "OUTLINE")
	...
	self.AFKMode.bottom.guild:SetFont(E.LSM:Fetch("font", "ElvUI Alt-Combat"), 24, "OUTLINE")
	self.AFKMode.bottom.guild:SetText(L["No Guild"])
	...
	self.AFKMode.bottom.time:SetFont(E.LSM:Fetch("font", "ElvUI Alt-Combat"), 24, "OUTLINE")
	self.AFKMode.bottom.time:SetText("00:00")
	...
	--[[self.AFKMode.bottom.model:SetScript("OnUpdateModel", function(self) 
		...
		if(timePassed > self.delay) and self.isIdle ~= true then
			self:SetAnimation(0)
			self.isIdle = true
			AFK.animTimer = AFK:ScheduleTimer("LoopAnimations", 5)
		end
	end)]]
