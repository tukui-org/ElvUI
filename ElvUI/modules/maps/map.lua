...
coords.PlayerText = E.FontString(CoordsFrame, C["media"].font, fontheight, "THINOUTLINE")
coords.MouseText = E.FontString(CoordsFrame, C["media"].font, fontheight, "THINOUTLINE")
