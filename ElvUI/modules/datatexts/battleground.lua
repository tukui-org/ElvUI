...
if not DB["datatext"].battleground or DB["datatext"].battleground ~= true then return end
...
Text1:SetFont(DB["media"].font_, DB["datatext"].fontsize, "THINOUTLINE")
...
Text2:SetFont(DB["media"].font_, DB["datatext"].fontsize, "THINOUTLINE")
...
Text3:SetFont(DB["media"].font_, DB["datatext"].fontsize, "THINOUTLINE")
...
Text4:SetFont(DB["media"].font_, DB["datatext"].fontsize, "THINOUTLINE")
...
Text5:SetFont(DB["media"].font_, DB["datatext"].fontsize, "THINOUTLINE")
...
Text6:SetFont(DB["media"].font_, DB["datatext"].fontsize, "THINOUTLINE")
