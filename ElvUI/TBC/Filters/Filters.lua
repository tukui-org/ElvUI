...
G.unitframe.aurawatch = {
	GLOBAL = {},
	DRUID = {
		[1126]	= UF:AuraWatch_AddSpell(1126, {5232,6756,5234,8907,9884,9885,26990}, 'TOPLEFT', {0.2, 0.8, 0.8}, true),	-- Mark of the Wild
		[21849]	= UF:AuraWatch_AddSpell(21849, {21850,26991}, 'TOPLEFT', {0.2, 0.8, 0.8}, true),	-- Gift of the Wild
	...
	MAGE = {
		[1459]	= UF:AuraWatch_AddSpell(1459, {1460,1461,10156,10157,27126}, 'TOPLEFT', {0.89, 0.09, 0.05}, true),		-- Arcane Intellect
	...
	PALADIN = {
		...
		[25782]	= UF:AuraWatch_AddSpell(25782, {25916,27141}, 'TOPLEFT', {0.2, 0.8, 0.2}, true),			-- Greater Blessing of Might
		[25894]	= UF:AuraWatch_AddSpell(25894, {25918,27143}, 'TOPLEFT', {0.2, 0.8, 0.2}, true),			-- Greater Blessing of Wisdom
	...
	PRIEST = {
		...
		[21562]	= UF:AuraWatch_AddSpell(21562, {21564,25392}, 'TOPLEFT', {1, 1, 0.66}, true),			-- Prayer of Fortitude
		[14752]	= UF:AuraWatch_AddSpell(14752, {14818,14819,27841,25312}, 'TOPRIGHT', {0.2, 0.7, 0.2}, true),		-- Divine Spirit
		[27681]	= UF:AuraWatch_AddSpell(27681, {32999}, 'TOPRIGHT', {0.2, 0.7, 0.2}, true),		-- Prayer of Spirit
		[976]	= UF:AuraWatch_AddSpell(976, {10957,10958,25433}, 'BOTTOMLEFT', {0.7, 0.7, 0.7}, true),		-- Shadow Protection
		[27683]	= UF:AuraWatch_AddSpell(27683, {39374}, 'BOTTOMLEFT', {0.7, 0.7, 0.7}, true),	-- Prayer of Shadow Protection
		[17]	= UF:AuraWatch_AddSpell(17, {592,600,3747,6065,6066,10898,10899,10900,10901,25217,25218}, 'BOTTOM', {0.00, 0.00, 1.00}),				-- Power Word: Shield
		[139]	= UF:AuraWatch_AddSpell(139, {6074,6075,6076,6077,6078,10927,10928,10929,25315,25221,25222}, 'BOTTOMRIGHT', {0.33, 0.73, 0.75}),		-- Renew
	},
	ROGUE = {}, -- No buffs
	SHAMAN = {
