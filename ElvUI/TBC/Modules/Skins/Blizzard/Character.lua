...
function S:CharacterFrame()
	...
	_G.PlayerStatFrameRightDropDownButton:GetNormalTexture():SetRotation(3.14)
	_G.PlayerStatFrameRightDropDownButton:GetPushedTexture():SetRotation(3.14)
	S:HandleDropDownBox(_G.PlayerStatFrameLeftDropDown, 147)
	_G.PlayerStatFrameLeftDropDownButton:GetNormalTexture():SetRotation(3.14)
	_G.PlayerStatFrameLeftDropDownButton:GetPushedTexture():SetRotation(3.14)
