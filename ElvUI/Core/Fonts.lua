...
function E:UpdateBlizzardFonts()
	...
	if E.private.general.replaceBlizzFonts then
		...
		SetFont(_G.AchievementFont_Small,				NORMAL, stock and 10 or small)				-- Achiev dates
		SetFont(_G.BossEmoteNormalHuge,					NORMAL, 25)									-- Talent Title
		SetFont(_G.CoreAbilityFont,						NORMAL, stock and 32 or 28)					-- Core abilities(title)
		...
		SetFont(_G.FriendsFont_Large,					NORMAL, stock and 14 or large)
		SetFont(_G.FriendsFont_Normal,					NORMAL, stock and 12 or size)
		SetFont(_G.FriendsFont_Small,					NORMAL, stock and 10 or small)
		SetFont(_G.FriendsFont_UserText,				NORMAL, stock and 11 or size)
		...
		SetFont(_G.GameFontHighlightMedium,				NORMAL, stock and 14 or medium)				-- Fix QuestLog Title mouseover
		SetFont(_G.GameFontHighlightSmall2,				NORMAL, stock and 11 or small)				-- Skill or Recipe description on TradeSkill frame
		SetFont(_G.GameFontNormalHuge2,					NORMAL, stock and 24 or huge)				-- Mythic weekly best dungeon name
		SetFont(_G.GameFontNormalLarge,					NORMAL, stock and 16 or large)
		SetFont(_G.GameFontNormalLarge2,				NORMAL, stock and 18 or large)				-- Garrison Follower Names
		SetFont(_G.GameFontNormalMed1,					NORMAL, stock and 13 or size)				-- WoW Token Info
		SetFont(_G.GameFontNormalMed2,					NORMAL, stock and 14 or size)				-- Quest tracker
		SetFont(_G.GameFontNormalMed3,					NORMAL, stock and 14 or size)
		SetFont(_G.GameFontNormalSmall2,				NORMAL, stock and 11 or small)				-- MissionUI Followers names
		SetFont(_G.GameTooltipHeader,					NORMAL, stock and 14 or size)
		SetFont(_G.InvoiceFont_Med,						NORMAL, stock and 12 or size)				-- Mail
		SetFont(_G.InvoiceFont_Small,					NORMAL, stock and 10 or small)				-- Mail
		...
		SetFont(_G.NumberFont_Outline_Huge,				NUMBER, stock and 30 or huge, thick)
		SetFont(_G.NumberFont_Outline_Large,			NUMBER, stock and 16 or large, outline)
		SetFont(_G.NumberFont_Outline_Med,				NUMBER, stock and 14 or medium, 'OUTLINE')
		SetFont(_G.NumberFont_OutlineThick_Mono_Small,	NUMBER, stock and 12 or size, 'OUTLINE')
		SetFont(_G.NumberFont_Shadow_Med,				NORMAL, stock and 14 or medium)				-- Chat EditBox
		SetFont(_G.NumberFont_Shadow_Small,				NORMAL, stock and 12 or small)
		SetFont(_G.NumberFontNormalSmall,				NORMAL, stock and 12 or small, 'OUTLINE')	-- Calendar, EncounterJournal
		...
		SetFont(_G.QuestFont,							NORMAL, stock and 13 or size)
		SetFont(_G.QuestFont_Enormous, 					NORMAL, stock and 30 or enormous)			-- Garrison Titles
		SetFont(_G.QuestFont_Huge,						NORMAL, stock and 18 or huge)				-- Quest rewards title(Rewards)
		SetFont(_G.QuestFont_Large,						NORMAL, stock and 14 or large)
		SetFont(_G.QuestFont_Shadow_Huge,				NORMAL, stock and 18 or huge)				-- Quest Title
		SetFont(_G.QuestFont_Shadow_Small,				NORMAL, stock and 14 or small)
		SetFont(_G.QuestFont_Super_Huge,				NORMAL, stock and 24 or mega)
		SetFont(_G.ReputationDetailFont,				NORMAL, stock and 10 or size)				-- Rep Desc when clicking a rep
		SetFont(_G.SpellFont_Small,						NORMAL, 10)
		SetFont(_G.SubSpellFont,						NORMAL, 10)									-- Spellbook Sub Names
		SetFont(_G.SubZoneTextFont,						NORMAL, stock and 26 or 24, outline)		-- World Map(SubZone)
		SetFont(_G.SubZoneTextString,					NORMAL, stock and 26 or 25, outline)
		SetFont(_G.SystemFont_Huge1, 					NORMAL, 20)									-- Garrison Mission XP
		SetFont(_G.SystemFont_Huge1_Outline,			NORMAL, stock and 20 or 18, outline)		-- Garrison Mission Chance
		SetFont(_G.SystemFont_Large,					NORMAL, 16)
		SetFont(_G.SystemFont_Med1,						NORMAL, stock and 12 or size)
		SetFont(_G.SystemFont_Med3,						NORMAL, stock and 14 or medium)
		SetFont(_G.SystemFont_Outline,					NORMAL, stock and 13 or size, outline)		-- Pet level on World map
		SetFont(_G.SystemFont_Outline_Small,			NUMBER, stock and 10 or small, 'OUTLINE')
		SetFont(_G.SystemFont_OutlineThick_Huge2,		NORMAL, stock and 22 or huge, thick)
		SetFont(_G.SystemFont_OutlineThick_WTF,			NORMAL, stock and 32 or enormous, outline)	-- World Map
		...
		SetFont(_G.SystemFont_Shadow_Med1,				NORMAL, stock and 12 or size)
		SetFont(_G.SystemFont_Shadow_Med2,				NORMAL, stock and 14 or medium)		-- Shows Order resourses on OrderHallTalentFrame
		SetFont(_G.SystemFont_Shadow_Med3,				NORMAL, stock and 14 or medium)
		SetFont(_G.SystemFont_Shadow_Small,				NORMAL, stock and 10 or small)
		SetFont(_G.SystemFont_Small,					NORMAL, stock and 10 or small)
		SetFont(_G.SystemFont_Tiny,						NORMAL, stock and 09 or tiny)
		SetFont(_G.Tooltip_Med,							NORMAL, stock and 12 or size)
		SetFont(_G.Tooltip_Small,						NORMAL, stock and 10 or small)
		SetFont(_G.ZoneTextString,						NORMAL, stock and 32 or enormous, outline)
	end
end
