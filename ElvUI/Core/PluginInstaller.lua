...
function PI:CreateStepComplete()
	local imsg = E:CreateFrame('Frame', 'PluginInstallStepComplete', E.UIParent)
	imsg:Size(418, 72)
...
function PI:CreateFrame()
	f = E:CreateFrame('Button', 'PluginInstallFrame', E.UIParent)
	f.SetPage = SetPage
	f:Size(550, 400)
	...
	f.MoveFrame = E:CreateFrame('Frame', nil, f, 'TitleDragAreaTemplate')
	...
	f.Next = E:CreateFrame('Button', 'PluginInstallNextButton', f, 'UIPanelButtonTemplate')
	f.Next:Size(110, 25)
	...
	f.Prev = E:CreateFrame('Button', 'PluginInstallPrevButton', f, 'UIPanelButtonTemplate')
	f.Prev:Size(110, 25)
	...
	f.Status = E:CreateFrame('StatusBar', 'PluginInstallStatus', f)
	...
	f.Option1 = E:CreateFrame('Button', 'PluginInstallOption1Button', f, 'UIPanelButtonTemplate')
	...
	f.Option2 = E:CreateFrame('Button', 'PluginInstallOption2Button', f, 'UIPanelButtonTemplate')
	...
	f.Option3 = E:CreateFrame('Button', 'PluginInstallOption3Button', f, 'UIPanelButtonTemplate')
	...
	f.Option4 = E:CreateFrame('Button', 'PluginInstallOption4Button', f, 'UIPanelButtonTemplate')
	...
	local close = E:CreateFrame('Button', 'PluginInstallCloseButton', f, 'UIPanelCloseButton')
	close:Point('TOPRIGHT', f, 'TOPRIGHT')
	close:SetScript('OnClick', function() f:Hide() end)
	S:HandleCloseButton(close)

	f.pending = E:CreateFrame('Frame', 'PluginInstallPendingButton', f)
	...
	f.side = E:CreateFrame('Frame', 'PluginInstallTitleFrame', f)
	...
	f.side:Hide()
	for i = 1, 18 do
		local button = E:CreateFrame('Button', nil, f)
		if i == 1 then
