...
do
	...
	local frame = CreateFrame("Frame", "ElvBarSmoother")
	frame:SetScript("OnUpdate", function(_, elapsed)
		for object, target in next, objects do
			local new = Lerp(object._value, target, clamp(0.33 * elapsed * TARGET_FPS, 0, 1))
