...
E.TagInfo = {
	...
	--Health
	['absorbs'] = { category = 'Health', description = 'Display the amount of absorbs' },
	...
	--Power
	['arcanecharges'] = { category = 'Power', description = "Displays the Arcane Charges (Mage)" },
	['chi'] = { category = 'Power', description = "Displays the Chi Points (Monk)" },
	...
	['afk'] = { category = 'Status', description = "Shows <AFK> if the Unit is afk" },
	['dead'] = { category = 'Status', description = "Shows <DEAD> if the unit is dead" },
	['resting'] = { category = 'Status', description = "Shows zzz if the unit is dead" },
	['pvp'] = { category = 'Status', description = "Shows PvP if the unit is pvp flagged" },
