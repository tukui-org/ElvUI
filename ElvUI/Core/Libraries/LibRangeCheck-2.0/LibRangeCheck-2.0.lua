...
if isRetail then
	tinsert(FriendSpells.ROGUE, 921) -- Pick Pocket (10 yards, level 24) -- this works for range, keep it in friendly aswell for retail on classic this is melee range and will return min 0 range 0
end
