...
function E.Filters_List(priority)
	return {
		enable = true,
...
function E.Filters_Aura(auraID, includeIDs, point, color, anyUnit, onlyShowMissing, displayText, textThreshold, xOffset, yOffset)
	local r, g, b = 1, 1, 1
...
function E.Filters_Expand(output, source)
	output = output or {}
