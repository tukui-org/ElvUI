...
P.general = {
	...
	totems = { -- totem tracker
		...
		sortDirection = ((E.Mists or E.Wrath) and 'DESCENDING') or 'ASCENDING',
		size = 40,
		height = 40,
		spacing = 4,
		keepSizeRatio = true,
...
P.actionbar.bar1.paging.ROGUE = '[bonusbar:1] 7;'..((E.Mists or E.Wrath) and ' [bonusbar:2] 8;' or '')
P.actionbar.bar1.paging.WARLOCK = (E.Mists or E.Wrath) and '[form:1] 7;' or nil
