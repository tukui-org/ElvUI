...
local function OnEvent(self)
	...
	self.text:SetFormattedText(displayString, L["Armor Penetration"] or 'Armor Penetration', APRating + APBonusRating)
end
...
DT:RegisterDatatext('Armor Penetration', STAT_CATEGORY_ENHANCEMENTS, { 'COMBAT_RATING_UPDATE' }, OnEvent, nil, nil, OnEnter, nil, L["Armor Penetration"] or 'Armor Penetration', nil, ApplySettings)
