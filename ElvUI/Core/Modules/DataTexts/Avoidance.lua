...
DT:RegisterDatatext('Avoidance', STAT_CATEGORY_ENHANCEMENTS, { 'UNIT_TARGET', 'UNIT_STATS' }, OnEvent, nil, nil, OnEnter, nil, L["Avoidance Breakdown"], nil, ValueColorUpdate)
