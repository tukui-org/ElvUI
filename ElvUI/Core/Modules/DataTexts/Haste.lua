...
DT:RegisterDatatext('Haste', STAT_CATEGORY_ENHANCEMENTS, (E.Wrath or E.Mists) and { 'UNIT_STATS', 'UNIT_ATTACK_SPEED' } or { 'UNIT_STATS', 'UNIT_SPELL_HASTE', 'UNIT_AURA' }, OnEvent, nil, nil, not E.Classic and OnEnter, nil, STAT_HASTE, nil, ApplySettings)
