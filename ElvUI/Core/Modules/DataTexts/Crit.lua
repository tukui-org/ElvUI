...
local function OnEvent(self)
	...
	if db.NoLabel then
		...
		self.text:SetFormattedText(displayString, db.Label ~= '' and db.Label or (L["Crit"] or CRIT_ABBR)..': ', critChance)
	end
end
...
DT:RegisterDatatext('Crit', STAT_CATEGORY_ENHANCEMENTS, { 'UNIT_STATS', 'UNIT_AURA', 'PLAYER_DAMAGE_DONE_MODS'}, OnEvent, nil, nil, OnEnter, nil, L["Crit"] or MELEE_CRIT_CHANCE, nil, ApplySettings)
