...
function UF:Configure_ClassBar(frame)
	...
	elseif frame.ClassBar == 'EclipseBar' then
		...
		bars.LunarBar:Size(CLASSBAR_WIDTH - ((UF.BORDER) * 2), frame.CLASSBAR_HEIGHT - ((UF.BORDER) * 2))
		...
		bars.SolarBar:Size(CLASSBAR_WIDTH - ((UF.BORDER) * 2), frame.CLASSBAR_HEIGHT - ((UF.BORDER) * 2))
