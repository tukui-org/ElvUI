			...
			if prefix == 'ELVUI_VERSIONCHK' then
				...
				if msg and (msg > ver) and not E.recievedOutOfDateMessage then -- you're outdated D:
					...
					if msg and ((msg - ver) >= 0.05) and not inCombat then
						E.PopupDialogs.ELVUI_UPDATE_AVAILABLE.text = format(L["ElvUI is five or more revisions out of date. You can download the newest version from www.tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"]..'|n|n'..'Sender %s : Version %s', sender, msg)
