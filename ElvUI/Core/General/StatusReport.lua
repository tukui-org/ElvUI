...
function E:CreateStatusFrame()
	...
	StatusFrame.Section3 = E:CreateStatusSection(300, E.Cata and 165 or 185, nil, 30, StatusFrame, 'TOP', StatusFrame.Section2, 'BOTTOM', 0)
...
function E:UpdateStatusFrame()
	...
	elseif E.Classic then
		Section3.Content.Line6.Text:SetFormattedText('Game Mode: |cff4beb2c%s|r', (E.TimerunningID == 1 and 'Remix') or (E.ClassicHC and 'Hardcore') or (E.ClassicSOD and 'Seasonal') or 'Normal')
	end
