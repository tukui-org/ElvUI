...
function E:CreateStatusFrame()
	...
	StatusFrame.Section2 = E:CreateStatusSection(300, E.Retail and 150 or 130, nil, 30, StatusFrame, 'TOP', StatusFrame.Section1, 'BOTTOM', 0)
...
function E:UpdateStatusFrame()
	...
	if E.Retail then
		Section3.Content.Line4.Text:SetFormattedText('Specialization: |cff4beb2c%s|r', GetSpecName() or UNKNOWN)
