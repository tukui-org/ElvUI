...
L["Lock"] = true
L["LOGIN_PTR"] = "|cffff3333You are currently not running the PTR version of ElvUI which may cause issues.|r Please download the PTR version from the following link. %s"
