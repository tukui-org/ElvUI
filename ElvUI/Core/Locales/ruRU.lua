...
L["Spent:"] = "Потрачено:"
L["Stack Items In Bags"] = "Собрать предметы в сумках" 
L["Stack Items In Bank"] = "Собрать предметы в банке"
L["Stack Items To Bags"] = "Собрать предметы в сумках" -- its twice?
L["Stack Items To Bank"] = "Собрать предметы в банке"
...
L["You can access the microbar by using middle mouse button on the minimap. You can also enable the MicroBar in the actionbar settings."] = "Вы можете получить доступ к микроменю Ком средней кнопкой мыши на миникарте. Также Вы можете активировать панель в разделе \"Панели команд\"."
