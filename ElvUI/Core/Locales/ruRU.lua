...
L["(Ctrl & Shift Click) Toggle CPU Profiling"] = "(Ctrl & Shift) Переключить профилирование процессора"
L["(Hold Shift) Memory Usage"] = "(Удерживайте Shift) Использование памяти"
L["(Shift Click) Collect Garbage"] = "(Шифт клик) Собрать мусор"
...
L["AddOn Memory:"] = "Объём памяти аддонов:"
...
L["Ammo/Shard Counter"] = "Количество снаряжений/осколков"
L["AP:"] = "СА:"
...
L["Download"] = "Загрузка"
L["DPS"] = "УВС"
L["Durability Frame"] = "Рамка прочности"
L["Earned:"] = "Заработано"
L["ElvUI Config"] = "Конфигурация ElvUI"
...
L["Heal Power"] = true
L["Healer"] = "Лекарь"
L["Hold Control + Right Click:"] = "Удерживайте Control + ПКМ:"
L["Hold Shift + Drag:"] = "Удерживайте shift и перетаскивать:"
L["Hold Shift + Right Click:"] = "Удерживайте Shift + ПКМ:"
...
L["Mobile"] = "Мобильный"
L["Mov. Speed"] = "Скорость передвижения"
L["MT Frames"] = "Танки"
...
L["New Profile will create a fresh profile for this character."] = "Новый профиль создаст свежий профиль для этого персонажа."
...
L["Output Audio Device"] = "Выходное аудиоустройство"
L["P"] = "Гр"
L["Paragon"] = "Парагон"
...
L["Player Choice Toggle"] = "Переключатель выбора игрока"
...
L["Please click the button below to setup your Profile Settings."] = "Пожалуйста, нажмите кнопку ниже, чтобы настроить параметры своего профиля."
...
L["Profile Settings Setup"] = "Настройка параметров профиля"
L["Profit:"] = "Прибыль:"
L["Purchase Bags"] = "Приобрести слот"
L["Purchase"] = "Приобрести слот"
L["Quest Log XP:"] = "Журнал заданий XP:"
L["Quest Objective Frame"] = "Цель квеста"
L["Quest Timer Frame"] = "Таймер квеста"
L["R"] = "Р"
L["Raid Frames"] = "Рейдовые фреймы"
L["Raid Menu"] = "Рейдовое меню"
L["Raid Pet Frames"] = "Рамки Питомцы рейда"
L["Raid-40 Frames"] = "Рамки Рейд 40"
...
L["Reset Session Data: Hold Ctrl + Right Click"] = "Сбросить сессию: Удерживайте Ctrl + ПКМ"
L["Rested:"] = "Бодрость:"
...
L["SP"] = "+ Закл."
L["Spec"] = "Спек"
L["Spell Hit"] = "Попадание заклинания"
L["Spell Power"] = "Сила заклинания"
L["Spent:"] = "Потрачено:"
L["Stack Items In Bags"] = "Складывать предметы в сумки"
L["Stack Items In Bank"] = "Складывать предметы в банк"
L["Stack Items To Bags"] = "Складывать предметы в сумки"
L["Stack Items To Bank"] = "Складывать предметы в банк"
...
L["Toggle Volume Stream"] = "Переключить звуковой поток"
L["Tooltip"] = "Подсказка"
