...
L["You are running the retail version on the PTR server. Please download our PTR version instead."] = "Du benutzt die retail Version auf dem Öffentlichen Testserver. Bitte downloade unsere PTR version stattdessen."
