...
P.nameplates.units.ENEMY_PLAYER.debuffs.allowOthers = true
...
P.unitframe.units.targettarget.debuffs.allowOthers = true
...
P.unitframe.units.focus.aurabar.allowOthers = true
