...
P.unitframe.units.player.aurabar.useAllowlist = true
...
P.unitframe.units.player.buffs.useAllowlist = true
...
P.unitframe.units.party.buffs.useAllowlist = true
...
P.unitframe.units.raid1.buffs.useAllowlist = true
