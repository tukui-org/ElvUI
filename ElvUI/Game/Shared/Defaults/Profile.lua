...
P.unitframe.units.tank.buffs.filterLists.group4.filter = 'HELPFUL||RAID||!BIG_DEFENSIVE||!EXTERNAL_DEFENSIVE'
...
P.unitframe.units.tank.buffs.filterLists.group6.enable = true
