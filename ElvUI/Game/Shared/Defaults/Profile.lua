...
local NP_Name = {
	enable = true,
	format = E.Retail and '[name]' or '[classcolor][name]',
	position = 'TOPLEFT',
	parent = 'Nameplate',
	xOffset = 0,
	yOffset = -7,
...
P.nameplates.units.ENEMY_PLAYER.name.format = E.Retail and '[name]' or '[classcolor][name:abbrev:long]'
...
P.unitframe.units.target.name.text_format = E.Retail and '[name] [difficultycolor][smartlevel] [shortclassification]' or '[classcolor][name:medium] [difficultycolor][smartlevel] [shortclassification]'
...
P.unitframe.units.targettarget.name.text_format = E.Retail and '[name]' or '[classcolor][name:medium]'
...
P.unitframe.units.focus.name.text_format = E.Retail and '[name]' or '[classcolor][name:medium]'
...
P.unitframe.units.pet.name.text_format = E.Retail and '[name]' or '[classcolor][name:medium]'
...
P.unitframe.units.boss.name.text_format = E.Retail and '[name]' or '[classcolor][name:medium]'
...
P.unitframe.units.arena.name.text_format = E.Retail and '[name]' or '[classcolor][name:medium]'
...
P.unitframe.units.raid1.name.text_format = E.Retail and '[name]' or '[classcolor][name:short]'
...
P.unitframe.units.tank.name.text_format = E.Retail and '[name]' or '[classcolor][name:medium]'
...
P.unitframe.units.tank.targetsGroup.name.text_format = E.Retail and '[name]' or '[classcolor][name:medium]'
