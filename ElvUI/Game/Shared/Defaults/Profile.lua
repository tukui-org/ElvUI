...
P.unitframe.units.player.buffs.notAuraCancelable = true
...
P.unitframe.units.boss.buffs.isAuraRaid = true
...
P.unitframe.units.party.buffs.isAuraRaidInCombat = true
...
P.unitframe.units.raid1.buffs.isAuraRaidInCombat = true
