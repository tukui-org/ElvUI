...
G.datatexts = {
	...
	settings = {
		...
		CombatIndicator = { OutOfCombat = '', InCombat = '', OutOfCombatColor = {r = 0, g = 0.8, b = 0, a = 1}, InCombatColor = {r = 0.8, g = 0, b = 0, a = 1} },
		...
		['Item Level'] = { Label = '', NoLabel = false, onlyEquipped = false, rarityColor = true },
		Leech = { Label = '', NoLabel = false, decimalLength = 1 },
		Location = { showZone = true, showSubZone = true, showContinent = false, color = 'REACTION', customColor = {r = 1, g = 1, b = 1, a = 1} },
