...
function E:UpdateBlizzardFonts()
	...
	if db.replaceBlizzFonts then
		...
		E:SetFont(_G.ObjectiveTrackerHeaderFont,			NORMAL, size, 'OUTLINE')
		E:SetFont(_G.ObjectiveTrackerLineFont,				NORMAL, size, 'SHADOW')
		E:SetFont(_G.ObjectiveTrackerFont12,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont13,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont14,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont15,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont16,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont17,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont18,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont19,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont20,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont21,				NORMAL, size)
		E:SetFont(_G.ObjectiveTrackerFont22,				NORMAL, size)
