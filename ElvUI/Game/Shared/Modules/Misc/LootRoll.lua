...
function M:LootRoll_Create(index)
	...
	bar.disenchant = E.Modern and CreateRollButton(bar, [[Interface\Buttons\UI-GroupLoot-DE-Up]], 3, ROLL_DISENCHANT) or nil
	bar.transmog = E.Modern and CreateRollButton(bar, [[Interface\MINIMAP\TRACKING\Transmogrifier]], 4, TRANSMOGRIFY) or nil
...
function M:UpdateLootRollFrames()
	...
	local maxBars = E.Modern and db.maxBars or _G.NUM_GROUP_LOOT_FRAMES or 4
