...
local C_ChallengeMode_GetActiveChallengeMapID = E.Modern and C_ChallengeMode.GetActiveChallengeMapID
local C_ChallengeMode_GetActiveKeystoneInfo = E.Modern and C_ChallengeMode.GetActiveKeystoneInfo
local C_ChallengeMode_IsChallengeModeActive = E.Modern and C_ChallengeMode.IsChallengeModeActive
local C_MythicPlus_IsMythicPlusActive = E.Modern and C_MythicPlus.IsMythicPlusActive
...
local DungeonDifficultyID, RaidDifficultyID, LegacyRaidDifficultyID = GetDungeonDifficultyID(), GetRaidDifficultyID(), E.Modern and GetLegacyRaidDifficultyID()
...
local function OnEvent(panel)
	...
	elseif instanceType ~= 'none' and difficultyID and not Garrison[instanceID] then
		...
		DungeonDifficultyID, RaidDifficultyID, LegacyRaidDifficultyID = GetDungeonDifficultyID(), GetRaidDifficultyID(), E.Modern and GetLegacyRaidDifficultyID()
		local displayString = E.Modern and '%s %s %s %s %s %s' or '%s %s %s %s'
		panel.text:SetFormattedText(displayString, DungeonTexture, GetDiffIDLabel(DungeonDifficultyID), RaidTexture, GetDiffIDLabel(RaidDifficultyID), E.Modern and LegacyTexture, E.Modern and GetDiffIDLabel(LegacyRaidDifficultyID))
	end
end
