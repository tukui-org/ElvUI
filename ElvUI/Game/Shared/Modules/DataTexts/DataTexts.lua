...
local ChatFrame_SendBNetTell = (_G.ChatFrameUtil and _G.ChatFrameUtil.SendBNetTell) or ChatFrame_SendBNetTell
...
function DT:BuildPanel_OnEvent(name, obj, UpdateColor, UpdateText)
