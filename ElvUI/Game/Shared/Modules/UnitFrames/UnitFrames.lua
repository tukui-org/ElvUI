...
function UF:SetStatusBarColor(bar, r, g, b, custom, overrideAlpha, overrideBackdrop)
	local mainR, mainG, mainB, mainA = r, g, b, E:Clamp((bar.isTransparent and (UF.multiplier * 2)) or 1, 0, 1)
	local bgR, bgG, bgB, bgA = r, g, b, E:Clamp(overrideBackdrop or (bar.isTransparent and (UF.multiplier * 0.5)) or UF.multiplier, 0, 1)
