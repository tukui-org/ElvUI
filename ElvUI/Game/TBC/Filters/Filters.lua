...
G.unitframe.aurawatch = {
	...
	DRUID = {
		[1126]	= Aura(1126, {5232, 6756, 5234, 8907, 9884, 9885, 26990, 21849, 21850, 26991}, 'TOPLEFT', {0.2, 0.8, 0.8}, true), -- Mark of the Wild
	...
	PALADIN = {
		...
		[25895] = Aura(25895, nil, 'TOPLEFT', {0.11, 1.00, 0.45}, true), -- Greater Blessing of Salvation
		[6940]	= Aura(6940, {20729, 27147, 27148}, 'CENTER', {0.89, 0.1, 0.1}), -- Blessing Sacrifice
		[20217] = Aura(20217, nil, 'TOPLEFT', {0.89, 0.45, 0}, true), -- Blessing of Kings
		[25898] = Aura(25898, nil, 'TOPLEFT', {0.89, 0.45, 0}, true), -- Greater Blessing of Kings
	...
	SHAMAN = {
		...
		[5677]	= Aura(5677, {10491, 10493, 10494, 25570}, 'LEFT', {0.67, 1.00, 0.80}), -- Mana Spring Totem
		[8072]	= Aura(8072, {8156, 8157, 10403, 10404, 10405, 25508, 25509}, 'BOTTOMRIGHT', {0.00, 0.00, 0.26}), -- Stoneskin Totem
