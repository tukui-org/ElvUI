...
function S:ContainerFrame()
	...
	hooksecurefunc("BankFrameItemButton_Update", function(button)
		if not BankFrame.backdrop then
			...
			BankFrame.backdrop2 = E:CreateFrame("Frame", nil, _G.BankSlotsFrame)
			...
			BankFrame.backdrop3 = E:CreateFrame("Frame", nil, _G.BankSlotsFrame)
	...
	local Bags = E:CreateFrame("Frame")
