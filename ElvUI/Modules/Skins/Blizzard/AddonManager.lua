...
function S:AddonList()
	...
	S:HandleButton(AddonList.EnableAllButton, true, nil, nil, true)
	S:HandleButton(AddonList.DisableAllButton, true, nil, nil, true)
	S:HandleButton(AddonList.OkayButton, true, nil, nil, true)
	S:HandleButton(AddonList.CancelButton, true, nil, nil, true)
