...
local function SkinTableAttributeDisplay(frame)
	...
	frame.OpenParentButton:SetSize(17)
	...
	frame.VisibilityButton:SetSize(28)
	S:HandleCheckBox(frame.HighlightButton)
	frame.HighlightButton:SetSize(28)
	S:HandleCheckBox(frame.DynamicUpdateButton)
	frame.DynamicUpdateButton:SetSize(28)
	...
	frame.DuplicateButton:SetSize(17)
