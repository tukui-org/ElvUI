...
function S:Blizzard_TradeSkillUI()
	...
	TradeSkillFrame.bg1 = E:CreateFrame("Frame", nil, TradeSkillFrame)
	...
	TradeSkillFrame.bg2 = E:CreateFrame("Frame", nil, TradeSkillFrame)
	...
	hooksecurefunc(TradeSkillFrame.DetailsFrame, "RefreshDisplay", function()
		...
		for i = 1, #TradeSkillFrame.DetailsFrame.Contents.Reagents do
			...
			if not Icon.backdrop then
				Icon.backdrop = E:CreateFrame("Frame", nil, Button)
