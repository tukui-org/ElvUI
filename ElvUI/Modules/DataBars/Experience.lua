...
function mod:LoadExperienceBar()
	self.expBar = self:CreateBar('ElvUI_ExperienceBar', self.ExperienceBar_OnEnter, self.ExperienceBar_OnClick, nil, 'LEFT', LeftChatPanel, 'RIGHT', -E.Border + E.Spacing*3, 0)
