...
function NP:Update_Power(nameplate)
	...
	if db.power.text.enable then
		...
		nameplate.Power.Text:SetPoint(E.InversePoints[db.power.text.position], nameplate.Power, db.power.text.position, db.power.text.xOffset, db.power.text.yOffset)
