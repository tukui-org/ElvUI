...
function NP:Update_Health(nameplate)
	...
	if db.health.text.enable then
		...
		nameplate.Health.Text:SetPoint(E.InversePoints[db.health.text.position], nameplate.Health, db.health.text.position, db.health.text.xOffset, db.health.text.yOffset)
