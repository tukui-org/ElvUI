...
function AB:CreateVehicleLeave()
	...
	vehicle:SetNormalTexture(E.Media.Textures.VehicleExit)
	vehicle:SetPushedTexture(E.Media.Textures.VehicleExit)
	vehicle:SetHighlightTexture(E.Media.Textures.VehicleExit)
	vehicle:SetTemplate()
