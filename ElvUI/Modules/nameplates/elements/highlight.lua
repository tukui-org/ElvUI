...
function mod:UpdateElement_Highlight(frame)
	if frame:IsShown() and frame.unit and UnitIsUnit("mouseover", frame.unit) and not self.db.units[frame.UnitType].healthbar.enable and self.db.units[frame.UnitType].showName and not frame.isTarget then
		frame.Name.NameOnlyGlow:Show()
		frame.Highlight:Show()
	elseif frame:IsShown() and frame.unit and UnitIsUnit("mouseover", frame.unit) and self.db.units[frame.UnitType].healthbar.enable and not frame.isTarget then
