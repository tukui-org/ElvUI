...
local function LoadSkin()
	...
	LFGListFrame.ApplicationViewer.NameColumnHeader.Label:FontTemplate(nil, 10)
	...
	LFGListFrame.ApplicationViewer.RoleColumnHeader.Label:FontTemplate(nil, 10)
	...
	LFGListFrame.ApplicationViewer.ItemLevelColumnHeader.Label:FontTemplate(nil, 10)
	LFGListFrame.ApplicationViewer.PrivateGroup:FontTemplate(nil, 11)
