...
local function LoadSkin()
	...
	HonorFrame.BonusFrame.RandomBGButton:CreateBackdrop("Default")
	...
	HonorFrame.BonusFrame.Arena1Button:CreateBackdrop("Default")
	...
	HonorFrame.BonusFrame.LargeBattlegroundButton:CreateBackdrop("Default")
	...
	HonorFrame.BonusFrame.BrawlButton:CreateBackdrop("Default")
