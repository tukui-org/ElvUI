...
local function LoadSkin()
	...
	LootHistoryFrame.ResizeButton.text:SetFont([[Interface\AddOns\ElvUI\media\fonts\PT_Sans_Narrow.ttf]], 16, 'OUTLINE')
	LootHistoryFrame.ResizeButton.text:SetText(text)
	LootHistoryFrame.ResizeButton.text:SetJustifyH('CENTER')
	LootHistoryFrame.ResizeButton.text:Point('CENTER', f, 'CENTER')
