local E, L, V, P, G = _G.unpack(select(2, ...)); --Import: Engine, Locales, PrivateDB, ProfileDB, GlobalDB, Localize Underscore
...
local CLASS, CONTINUE, PREVIOUS = _G.CLASS, _G.CONTINUE, _G.PREVIOUS
...
function E:SetupLayout(layout, noDataReset)
	...
	if (layout == "tank" or layout == "dpsCaster") and not noDataReset then
