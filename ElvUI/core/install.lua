...
function E:SetupLayout(layout, noDataReset)
	...
	if layout == 'healer' then
		...
		if not noDataReset then
			...
			E.db.unitframe.units.raid.buffs.priority = 'Boss,TurtleBuffs' --Default='Personal,Boss,Blacklist,hasDuration'
			...
			E.db.unitframe.units.party.buffs.priority = 'Boss,TurtleBuffs' --Default='Personal,Boss,Blacklist,hasDuration'
...
local function SetupAuras(style)
	...
	if not style then
		...
		E.db.unitframe.units.player.buffs.priority = "Personal,Whitelist,Blacklist" --Default='Personal,Whitelist,Blacklist,hasDuration'
