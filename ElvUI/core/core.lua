...
local E, _, V, P, G = _G.unpack(ElvUI); --Import: Engine, Locales, PrivateDB, ProfileDB, GlobalDB
...
local GetDodgeChance, GetParryChance = _G.GetDodgeChance, _G.GetParryChance
local GetFunctionCPUUsage = _G.GetFunctionCPUUsage
local GetNumGroupMembers = _G.GetNumGroupMembers
local GetSpecialization, GetActiveSpecGroup = _G.GetSpecialization, _G.GetActiveSpecGroup
local GetSpecializationRole = _G.GetSpecializationRole
local InCombatLockdown = _G.InCombatLockdown
local IsAddOnLoaded = _G.IsAddOnLoaded
local IsInInstance, IsInGuild = _G.IsInInstance, _G.IsInGuild
...
local UnitLevel, UnitStat, UnitAttackPower = _G.UnitLevel, _G.UnitStat, _G.UnitAttackPower
local hooksecurefunc = _G.hooksecurefunc
local COMBAT_RATING_RESILIENCE_PLAYER_DAMAGE_TAKEN = _G.COMBAT_RATING_RESILIENCE_PLAYER_DAMAGE_TAKEN
...
local MAX_WOW_CHAT_CHANNELS = _G.MAX_WOW_CHAT_CHANNELS
local ERR_NOT_IN_COMBAT = _G.ERR_NOT_IN_COMBAT
local C_ChatInfo_GetNumActiveChannels = _G.C_ChatInfo.GetNumActiveChannels
...
E.myLocalizedClass, E.myclass, E.myClassID = _G.UnitClass('player')
E.myLocalizedRace, E.myrace = _G.UnitRace('player')
E.myname = _G.UnitName('player')
E.myrealm = _G.GetRealmName()
E.myspec = _G.GetSpecialization()
E.version = _G.GetAddOnMetadata('ElvUI', 'Version')
E.wowpatch, E.wowbuild = _G.GetBuildInfo()
E.wowbuild = tonumber(E.wowbuild)
E.resolution = ({_G.GetScreenResolutions()})[_G.GetCurrentResolution()] or GetCVar('gxWindowedResolution') --only used for now in our install.lua line 779
E.screenwidth, E.screenheight = _G.GetPhysicalScreenSize()
E.isMacClient = _G.IsMacClient()
