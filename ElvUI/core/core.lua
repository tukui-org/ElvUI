...
function E:StaggeredUpdateAll(event, ignoreInstall)
	...
	if event and (event == "OnProfileChanged" or event == "OnProfileCopied") then
		...
		C_Timer_After(0.1, E.UpdateMediaItems)
		C_Timer_After(0.2, E.UpdateLayout)
		C_Timer_After(0.3, E.UpdateTooltip)
		C_Timer_After(0.4, E.UpdateActionBars)
		C_Timer_After(0.5, E.UpdateBags)
		C_Timer_After(0.6, E.UpdateChat)
		C_Timer_After(0.7, E.UpdateDataBars)
		C_Timer_After(0.8, E.UpdateDataTexts)
		C_Timer_After(0.9, E.UpdateMinimap)
		C_Timer_After(1.0, E.UpdateNamePlates)
		C_Timer_After(1.1, E.UpdateAuras)
		C_Timer_After(1.2, E.UpdateMisc)
		C_Timer_After(1.3, E.UpdateEnd)
	else
		--Fire away
		E:UpdateAll(true)
	end
