...
E.colors = {
	...
	power = {
		["MANA"] = C["unitframes"].POWER_MANA,
		["RAGE"] = C["unitframes"].POWER_RAGE,
		["FOCUS"] = C["unitframes"].POWER_FOCUS,
		["ENERGY"] = C["unitframes"].POWER_ENERGY,
		["RUNES"] = {0.55, 0.57, 0.61},
		["RUNIC_POWER"] = C["unitframes"].POWER_RUNICPOWER,
		["AMMOSLOT"] = {0.8, 0.6, 0},
		["FUEL"] = {0, 0.55, 0.5},
