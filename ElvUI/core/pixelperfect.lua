...
function E.UIScale()
	...
	if E.lowversions[E.getscreenresolution] and C["general"].resolutionoverride ~= "High" then
			E.lowversion = true
	elseif E.getscreenwidth >= 3840 or (UIParent:GetWidth() + 1 > E.getscreenwidth and not E.lowversions[E.getscreenresolution]) then
