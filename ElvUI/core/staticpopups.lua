...
E.PopupDialogs['ELVUI_UPDATE_AVAILABLE'] = {
	text = L["ElvUI is more than five or more revisions out of date. You can download the newest version from www.tukui.org. Get premium membership and have ElvUI automatically updated with the Tukui Client!"],
	hasEditBox = 1,
