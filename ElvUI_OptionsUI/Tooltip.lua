...
General.inspectDataEnable = ACH:Toggle(L["Inspect Data"], L["Display the item level and current specialization of the unit"], 10, nil, nil, nil, nil, nil, nil, not E.Retail)
General.inspectDataEnableIsShift = ACH:Toggle(L["Inspect Data Is Shift"], L["If need shift key press to show"], 11, nil, nil, nil, nil, nil, nil, not E.Retail)
