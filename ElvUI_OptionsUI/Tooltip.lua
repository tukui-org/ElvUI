...
General.inspectDataEnableIsShift = ACH:Toggle(L["Inspect Data Is Shift"], L["Display data only if Shift key down"], 11, nil, nil, nil, nil, nil, function() return not E.db.tooltip.inspectDataEnable end, not E.Retail)
