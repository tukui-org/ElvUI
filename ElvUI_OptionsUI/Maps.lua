...
Maps.args.minimap.args.icons.args.queueStatus = ACH:Group(L["Queue Status"], nil, 5)
...
Maps.args.minimap.args.icons.args.difficulty = ACH:Group(L["Instance Difficulty"], nil, 6)
...
Maps.args.minimap.args.icons.args.challengeMode = ACH:Group(L["CHALLENGE_MODE"], nil, 7, nil, nil, nil, nil, not E.Retail)
