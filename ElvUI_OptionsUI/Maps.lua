...
Maps.args.minimap.args.scale = ACH:Range(L["Scale"], L["Adjust the scale of the minimap. This scales the pins on the minimap. Eg: Quests"], 3, { min = .5, max = 2, step = .01, isPercent = true }, nil, nil, nil, function() return not E.private.general.minimap.enable end)
