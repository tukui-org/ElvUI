...
E.Options.args.info.args.download.args.changelog = ACH:Execute(L["Changelog"], nil, 3, function() E:StaticPopup_Show('ELVUI_EDITBOX', nil, nil, E.Retail and 'https://www.tukui.org/download.php?ui=elvui&changelog' or E.TBC and 'https://www.tukui.org/classic-tbc-addons.php?id=2&changelog' or E.Classic and 'https://www.tukui.org/classic-addons.php?id=2&changelog' or E.Wrath and 'https://github.com/tukui-org/ElvUI/archive/refs/heads/wrath_beta.zip') end, nil, nil, 140)
