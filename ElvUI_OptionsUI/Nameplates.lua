...
E.Options.args.nameplates.args.generalGroup.args.threatGroup.args.beingTankedByTank = ACH:Toggle(L["Off Tank"], L["Use Off Tank Color when another Tank has threat."], 2, nil, nil, nil, nil, nil, function() return not E.db.nameplates.threat.useThreatColor end)
E.Options.args.nameplates.args.generalGroup.args.threatGroup.args.beingTankedByPet = ACH:Toggle(L["Off Tank (Pets)"], nil, 3, nil, nil, nil, nil, nil, function() return not E.db.nameplates.threat.useThreatColor end)
E.Options.args.nameplates.args.generalGroup.args.threatGroup.args.indicator = ACH:Toggle(L["Show Icon"], nil, 4, nil, nil, nil, nil, nil, function() return not E.db.nameplates.threat.enable end)
E.Options.args.nameplates.args.generalGroup.args.threatGroup.args.goodScale = ACH:Range(L["Good Scale"], nil, 5, { min = .5, max = 1.5, step = .01, isPercent = true }, nil, nil, nil, function() return not E.db.nameplates.threat.enable end)
E.Options.args.nameplates.args.generalGroup.args.threatGroup.args.badScale = ACH:Range(L["Bad Scale"], nil, 6, { min = .5, max = 1.5, step = .01, isPercent = true }, nil, nil, nil, function() return not E.db.nameplates.threat.enable end)
