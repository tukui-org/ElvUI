...
local function GetUnitSettings(unit, name)
	...
	group.args.healthGroup.args.textGroup.args.position = ACH:Select(L["Position"], nil, 3, { CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], TOPRIGHT = L["Top Right"], BOTTOMRIGHT = L["Bottom Right"] })
	...
	group.args.powerGroup.args.textGroup.args.position = ACH:Select(L["Position"], nil, 3, { CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], TOPRIGHT = L["Top Right"], BOTTOMRIGHT = L["Bottom Right"] })
	...
	group.args.buffsGroup.args.stacks.args.countPosition = ACH:Select(L["Position"], nil, 3, { TOP = L["Top"], LEFT = L["Left"], BOTTOM = L["Bottom"], CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], BOTTOMRIGHT = L["Bottom Right"], RIGHT = L["Right"], TOPRIGHT = L["Top Right"] })
	...
	group.args.buffsGroup.args.duration.args.durationPosition = ACH:Select(L["Position"], nil, 2, { TOP = L["Top"], LEFT = L["Left"], BOTTOM = L["Bottom"], CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], BOTTOMRIGHT = L["Bottom Right"], RIGHT = L["Right"], TOPRIGHT = L["Top Right"] })
	...
	group.args.debuffsGroup.args.stacks.args.countPosition = ACH:Select(L["Position"], nil, 3, { TOP = L["Top"], LEFT = L["Left"], BOTTOM = L["Bottom"], CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], BOTTOMRIGHT = L["Bottom Right"], RIGHT = L["Right"], TOPRIGHT = L["Top Right"] })
	...
	group.args.debuffsGroup.args.duration.args.durationPosition = ACH:Select(L["Position"], nil, 2, { TOP = L["Top"], LEFT = L["Left"], BOTTOM = L["Bottom"], CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], BOTTOMRIGHT = L["Bottom Right"], RIGHT = L["Right"], TOPRIGHT = L["Top Right"] })
	...
	group.args.portraitGroup.args.position = ACH:Select(L["Position"], nil, 4, { LEFT = L["Left"], RIGHT = L["Right"], TOP = L["Top"], BOTTOM = L["Bottom"], CENTER = L["Center"] })
	...
	group.args.levelGroup.args.position = ACH:Select(L["Position"], nil, 3, { CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], TOPRIGHT = L["Top Right"], BOTTOMRIGHT = L["Bottom Right"] })
	...
	group.args.nameGroup.args.position = ACH:Select(L["Position"], nil, 3, { CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], TOPRIGHT = L["Top Right"], BOTTOMRIGHT = L["Bottom Right"] })
	...
	group.args.titleGroup.args.position = ACH:Select(L["Position"], nil, 3, { CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], TOPRIGHT = L["Top Right"], BOTTOMRIGHT = L["Bottom Right"] })
	...
	group.args.pvpindicator.args.position = ACH:Select(L["Position"], nil, 4, { LEFT = L["Left"], RIGHT = L["Right"], TOP = L["Top"], BOTTOM = L["Bottom"], CENTER = L["Center"] })
	...
	group.args.raidTargetIndicator.args.position = ACH:Select(L["Position"], nil, 4, { LEFT = L["Left"], RIGHT = L["Right"], TOP = L["Top"], BOTTOM = L["Bottom"], CENTER = L["Center"] })
	...
	elseif unit == 'ENEMY_NPC' or unit == 'FRIENDLY_NPC' then
		...
		group.args.eliteIcon.args.position = ACH:Select(L["Position"], nil, 4, { LEFT = L["Left"], RIGHT = L["Right"], TOP = L["Top"], BOTTOM = L["Bottom"], CENTER = L["Center"] })
		...
		group.args.questIcon.args.position = ACH:Select(L["Position"], nil, 4, { LEFT = L["Left"], RIGHT = L["Right"], TOP = L["Top"], BOTTOM = L["Bottom"], CENTER = L["Center"] })
		...
		group.args.questIcon.args.fontGroup.args.textPosition = ACH:Select(L["Text Position"], nil, 4, { TOP = L["Top"], LEFT = L["Left"], BOTTOM = L["Bottom"], CENTER = L["Center"], TOPLEFT = L["Top Left"], BOTTOMLEFT = L["Bottom Left"], BOTTOMRIGHT = L["Bottom Right"], RIGHT = L["Right"], TOPRIGHT = L["Top Right"] })
	end
	...
	if unit == 'PLAYER' or unit == 'FRIENDLY_PLAYER' or unit == 'ENEMY_PLAYER' then
		...
		group.args.pvpclassificationindicator.args.position = ACH:Select(L["Position"], nil, 3, { LEFT = L["Left"], RIGHT = L["Right"], TOP = L["Top"], BOTTOM = L["Bottom"], CENTER = L["Center"] })
