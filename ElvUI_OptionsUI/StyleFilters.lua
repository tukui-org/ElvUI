...
StyleFitlers.triggers.args.combat.args.unitGroup.args.notMyGuild = ACH:Toggle(L["Not Guild"], nil, 20)
StyleFitlers.triggers.args.combat.args.unitGroup.args.isOthersPet = ACH:Toggle(L["Is Other Players Pet"], nil, 21)
StyleFitlers.triggers.args.combat.args.unitGroup.args.notOthersPet = ACH:Toggle(L["Not Other Players Pet"], nil, 22)
