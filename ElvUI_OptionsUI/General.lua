...
Cosmetic.customGlowGroup.args.color = ACH:Color(L["Color"], nil, 12, true, nil, function(info) local c, d = E.db.general.customGlow[info[#info]], P.general.customGlow[info[#info]] return c[1], c[2], c[3], c[4], d[1], d[2], d[3], d[4] end, function(info, r, g, b, a) local c = E.db.general.customGlow[info[#info]] c[1], c[2], c[3], c[4] = r, g, b, a end, function() return not E.db.general.customGlow.useColor end)
