...
GenGen.totems.args.sortDirection = ACH:Select(L["Sort Direction"], nil, 3, { ASCENDING = L["Ascending"], DESCENDING = L["Descending"] })
GenGen.totems.args.growthDirection = ACH:Select(L["Bar Direction"], nil, 4, { VERTICAL = L["Vertical"], HORIZONTAL = L["Horizontal"] })
