...
L["|cffFF3333This does not work in Instances or Garrisons!|r"] = "|cffFF3333這個功能在副本或要塞中不能正常使用!|r"
...
L["If you have an icon or aurabar that you don't want to display simply hold down shift and right click the icon for it to disapear."] = "如果你不想讓某一個光環或是光環條顯示出來, 只需按住Shift的同時滑鼠右鍵點擊圖示就可以讓其消失."
...
L["Show ElvUI users and their version of ElvUI."] = "顯示 ElvUI 的用戶及其 ElvUI 版本."
...
L["Use Modifier for Item Count"] = "使用修飾鍵添加物品計數"
L["Use Portrait"] = "使用頭像"
