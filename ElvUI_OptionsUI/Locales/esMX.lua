...
L["Color health by threat status."] = "Colorea la salud según el estado de la amenaza."
...
L["Color power by threat status."] = "Color de poder según el estado de la amenaza."
