...
L["Change the width and controls how big of an area on the screen will accept clicks to target unit."] = "Изменяет ширину и контролирует, насколько большая область на экране будет принимать клики по целевому юниту."
...
L["This works like a macro, you can run different situations to get the actionbar to show/hide differently.\n Example: '[combat] show;hide'"] = "Это работает как макрос, Вы можете запускать разные ситуации, чтобы панель действий отображалась / скрывалась по-разному.\n Пример: '[combat] show;hide'"
...
L["Use Subzone Names"] = "Использовать имена субзон"
