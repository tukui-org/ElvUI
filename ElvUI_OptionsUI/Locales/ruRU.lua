...
L["Display the item level and current specialization of the unit on modifier press."] = "Отображение уровня предмета и текущей специализации юнита"
...
L["Inset"] = "Внутри"
L["Inspect Data"] = "Отображение специализации и ilvl"
L["Inspect Data Is Shift"] = "Shift key"
L["Display data only if Shift key down"] = "Отображает специализации и ilvl только при зажатой Shift"
L["Inspect"] = "Осмотреть"
L["Install"] = "Установка"
...
L["Target units on mouse down rather than mouse up."] = "Выделять при нажатии кнопки мыши, а не при ее отпускании."
L["Target"] = "Цель"
