...
-- Perhaps this translation needs to be added to the ElvUI\Core\Locales directory. Start ..
L["Active Output Audio Device"] = "Активное аудиоустройство вывода"
L["Volume Streams"] = "Громкость потоков"
L["|cFFffffffLeft Click:|r Select Volume Stream"] = "|cFFffffffЛевый щелчок:|r Выбрать объемный поток"
L["|cFFffffffMiddle Click:|r Toggle Mute Master Stream"] = "|cFFffffffСредний щелчок:|r Отключить главный поток"
L["|cFFffffffRight Click:|r Toggle Volume Stream"] = "|cFFffffffПравый щелчок:|r Переключить объемный поток"
L["|cFFffffffShift + Left Click:|r Open System Audio Panel"] = "|cFFffffffShift + Левый щелчок:|r Открыть системные настройки звука"
L["|cFFffffffShift + Right Click:|r Select Output Audio Device"] = "|cFFffffffShift + правый щелчок:|r Выберите выходное аудиоустройство"
-- Perhaps this translation needs to be added to the ElvUI\Core\Locales directory. End ..
...
L["|cffFF0000Warning:|r Changing options in this section will apply to all Aura Indicator auras. To change only one Aura, please click \"Configure Auras\" and change that specific Auras settings. If \"Profile Specific\" is selected it will apply to that filter set."] = "|cffFF0000Внимание:|r Изменение параметров в этом разделе будет применяться ко всем аурам индикатора аур. Чтобы изменить только одну ауру, нажмите \"Настроить ауры\" и измените настройки конкретных аур. Если выбран параметр \"Специфичный для профиля\", он будет применяться к этому набору фильтров."
...
L["Action Button Glow"] = "Подсветка кнопки действия"
...
L["Allow Sharing"] = "Разрешить совместное использование"
...
L["Apply To All"] = "Применить ко всему"
...
L["Assigned Icon"] = "Назначенный значок"
...
L["Backdrop Faded"] = "Исчезновение фона"
...
L["Bind on Equip/Use Text"] = "Привязать к экипировке / использовать текст"
...
L["Charged Combo Point"] = "Заряженные комбо поинты"
...
L["Color tooltip border based on Item Quality."] = "Цвет границы всплывающей подсказки в зависимости от качества предмета."
...
L["Colorize Selected Text"] = "Раскрасить выделенный текст"
...
L["Condensed (Spaced)"] = "Через запятую (с интервалом)"
...
L["Count Text"] = "Количество текста"
...
L["Desaturate Junk"] = "Обесцветить мусор"
...
L["Display Item Info"] = "Отображать информацию о предмете"
L["Displays item info on center of item."] = "Отображает информацию о предмете в центре элемента."
...
L["Editbox History"] = "История поля ввода"
...
L["Fade Chat Toggles"] = "Затухание переключателей чата"
...
L["Fader"] = "Затухание"
L["Fades the buttons that toggle chat windows when that window has been toggled off."] = "Затухание кнопок, которые переключают окна чата, когда это окно было выключено."
...
L["Filter Modifiers"] = "Модификаторы фильтра"
...
L["Flyout Button Size"] = "Размер всплывающей кнопки"
...
L["Forces Focus Glow to be disabled for these frames"] = "Принудительное отключение свечения фокуса для этих кадров"
...
L["Full Time"] = "На постоянной основе"
L["Gems"] = "Самоцветы"
L["Gender"] = "Пол"
L["General"] = "Общие"
...
L["Hide by Application"] = "Скрыть по приложению"
...
L["Hide In Keystone"] = "Прятать в ключе (mythic+)"
...
L["If enabled, the style filter will only activate when you are in one of the instances specified in Instance ID."] = "Если включено, фильтр будет активирован только когда Вы в одном из подземелий, добавленных в список по ID."
...
L["Keyword Alert"] = "Оповещение ключевых слов"
L["Keyword Alerts"] = "Оповещения по ключевым словам"
L["Keywords"] = "Ключевые слова"
L["LANGUAGE"] = "Язык"
L["Label"] = "Ярлык"
L["Large"] = "Большой"
L["Larger Font"] = "Шрифт большего размера"
L["Larger Outline"] = "Крупный контур"
L["Larger Size"] = "Большой размер"
L["Latency"] = "Задержка"
...
L["Max Overflow is set to zero. Absorb Overflows will be hidden when using Overflow style.\nIf used together Max Overflow at zero and Overflow mode will act like Normal mode without the ending sliver of overflow."] = "Максимальное переполнение установлено на ноль. Поглощение переполнения будет скрыто при использовании стиля «Переполнение».\nПри совместном использовании «Максимальное переполнение при нуле» и «Режим переполнения» будут действовать как нормальный режим без конечной полосы переполнения."
...
L["Modifier Count"] = "Количество модификаторов"
L["Modifier for IDs"] = "Модификатор для IDs"
...
L["Mythic+ Best Run"] = "Эпохальный+ лучший забег"
...
L["Other AddOns"] = "Другие дополнения"
...
L["Panel Snapping"] = "Привязка панелей"
...
L["Quality Name"] = "Название качества"
...
L["Reset Editbox History"] = "Сбросить историю поля ввода"
...
L["Right Position"] = "Правая позиция"
...
L["Scrap Icon"] = "Значок утилизации"
...
L["Selected Text Color"] = "Выбранный цвет текста"
L["Selection Health"] = "Здоровье по выделению"
L["Selection Power"] = "Ресурс по выделению"
L["Selection"] = "Выделение"
L["Selector Color"] = "Цвет переключателя"
L["Selector Style"] = "Стиль переключателя"
...
L["Short (Whole Numbers Spaced)"] = "Короткий (целые числа через интервалы)"
...
L["Show ElvUI users and their version of ElvUI."] = "Показать пользователей ElvUI и их версию ElvUI."
...
L["Show Max Currency"] = "Показать максимальную валюту"
...
L["Swipe: Loss of Control"] = "Swipe: потеря контроля"
L["Swipe: Normal"] = "Swipe: обычный"
...
L["Tab Selector"] = "Переключатель вкладок"
L["Tabard Frame"] = "Создание накидки"
L["Table"] = "Таблица"
L["Tagged NPC"] = "Чужой НИП"
L["Talent to match"] = "Соответствующий талант"
L["TALENT"] = "Талант"
L["TALENTS"] = "Таланты"
...
L["Target Marker Icon"] = "Значок метки цели"
...
L["This setting mimics the older style of Replace Blizzard Fonts, with a more static unified font sizing."] = "Этот параметр имитирует старый стиль замены шрифтов Blizzard с более статичным унифицированным размером шрифта."
...
L["This will join auras together which are normally separated. Example: Bolstering and Force of Nature."] = "Это объединит ауры, которые обычно разделены. Пример: поддержка и сила природы."
...
L["Tooltip Lines"] = "Строки всплывающей подсказки"
...
L["Unified Font Sizes"] = "Единый размер шрифта"
...
L["Use Instance ID or Name"] = "Использовать название или ID подземелья"
...
L["Use thin borders on certain nameplate elements."] = "Используйте тонкие рамки на некоторых элементах индикаторов здоровья."
...
L["When disabled the Chat Background color has to be set via Blizzards Chat Tabs Background setting."] = "Когда отключено, цвет фона чата должен быть установлен через настройку фона вкладок чата Blizzards."
...
L["World Latency"] = "Мировая задержка"
...
L["XP Quest Percent"] = "Процент квеста XP"
