...
L["Color Score"] = "Цвет очков"
L["Color score based on Blizzards API."] = "Цвет очков на основе Blizzards API."
...
L["Display the current Mythic+ Dungeon Score."] = "Отображение текущего счета подземелья в эпохальном+ режиме."
...
L["Equipped Item"] = "Одетые предметы"
...
L["Show QuestXP"] = "Показать опыт квеста"
