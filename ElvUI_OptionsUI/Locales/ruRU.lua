...
L["Adjust the height of your right chat panel."] = "Настроить выоту правой панели чата."
...
L["Block Focus Glow"] = "Блокировать подсветку фокуса"
...
L["Keyword Alert"] = "Предупреждение о ключевом слове"
L["Keyword Alerts"] = "Предупреждение о ключевых словах"
...
L["Target Marker Icon"] = "Значок маркера"
