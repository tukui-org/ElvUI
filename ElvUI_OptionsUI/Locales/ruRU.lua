...
L["Controls the text displayed. Tags are available in the Available Tags section of the config."] = "Задает отображаемый текст. Доступные тэги можно увидеть в разделе \"Инфо/Контроль\"."
