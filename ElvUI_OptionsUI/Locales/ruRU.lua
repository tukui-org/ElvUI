...
L["Display the item level and current specialization of the unit"] = "Отображать ли специализацию и ilvl в подсказке"
...
L["If need shift key press to show"] = "Показывать только при зажатой Shift"
...
L["Inset"] = "Внутри"
L["Inspect Data"] = "Показывать ли специализацию и ilvl"
L["Inspect Data Is Shift"]  = "При зажатой Shift (Показывать ли специализацию и ilvl)"
L["Inspect"] = "Осмотреть"
L["Install"] = "Установка"
