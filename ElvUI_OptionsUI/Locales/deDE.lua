...
L["Automatically hide the objective frame during boss fights while you are running a key."] = "Verberge automatisch die Questverfolgung während Bosskämpfen, während Du einen Schlüsselstein läufst."
