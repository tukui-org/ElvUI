...
local function group(order, db, label)
	...
	tColors.args.modRateColor = ACH:Color(L["Modified Rate"], L["Color when the text is using a modified timer rate."], 1)
	...
	iColors.args.modRateIndicator = ACH:Color(L["Modified Rate"], L["Color when the text is using a modified timer rate."], 1)
