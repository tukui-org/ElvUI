...
UnitFrame.enable = ACH:Toggle(L["Enable"], nil, 1, nil, nil, nil, function() return E.private.unitframe.enable end, function(_, value) E.private.unitframe.enable = value E:StaticPopup_Show('PRIVATE_RL') end)
...
UnitFrame.allColorsGroup.args.healthGroup = ACH:Group(L["Health"], nil, 2, nil, function(info) if info.type == 'color' then local t, d = E.db.unitframe.colors[info[#info]], P.unitframe.colors[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b else return E.db.unitframe.colors[info[#info]] end end, function(info, ...) if info.type == 'color' then local r, g, b, a = ... local t = E.db.unitframe.colors[info[#info]] t.r, t.g, t.b, t.a = r, g, b, a or 1 else local value = ... E.db.unitframe.colors[info[#info]] = value end UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.healthGroup.args.colorhealthbyvalue = ACH:Toggle(L["Health By Value"], L["Color health by amount remaining."], 1)
UnitFrame.allColorsGroup.args.healthGroup.args.healthselection = ACH:Toggle(L["Selection Health"], L["Color health by color selection."], 2)
UnitFrame.allColorsGroup.args.healthGroup.args.healthclass = ACH:Toggle(L["Class Health"], L["Color health by classcolor or reaction."], 3, nil, nil, nil, nil, nil, function() return E.db.unitframe.colors.healthselection end)
UnitFrame.allColorsGroup.args.healthGroup.args.forcehealthreaction = ACH:Toggle(L["Force Reaction Color"], L["Forces reaction color instead of class color on units controlled by players."], 4, nil, nil, nil, nil, nil, function() return E.db.unitframe.colors.healthselection or not E.db.unitframe.colors.healthclass end)
UnitFrame.allColorsGroup.args.healthGroup.args.transparentHealth = ACH:Toggle(L["Transparent"], L["Make textures transparent."], 6)
UnitFrame.allColorsGroup.args.healthGroup.args.useDeadBackdrop = ACH:Toggle(L["Use Dead Backdrop"], nil, 7)
UnitFrame.allColorsGroup.args.healthGroup.args.classbackdrop = ACH:Toggle(L["Class Backdrop"], L["Color the health backdrop by class or reaction."], 8, nil, nil, nil, nil, nil, function() return E.db.unitframe.colors.customhealthbackdrop end)
UnitFrame.allColorsGroup.args.healthGroup.args.customhealthbackdrop = ACH:Toggle(L["Custom Backdrop"], L["Use the custom backdrop color instead of a multiple of the main color."], 9)
UnitFrame.allColorsGroup.args.healthGroup.args.healthMultiplier = ACH:Range(L["Health Backdrop Multiplier"], nil, 10, { min = 0, softMax = 0.75, max = 1, step = .01 }, nil, nil, nil, function() return E.db.unitframe.colors.customhealthbackdrop end)
UnitFrame.allColorsGroup.args.healthGroup.args.health_backdrop = ACH:Color(L["Health Backdrop"], nil, 20, nil, nil, nil, nil, function() return not E.db.unitframe.colors.customhealthbackdrop end)
UnitFrame.allColorsGroup.args.healthGroup.args.tapped = ACH:Color(L["Tapped"], nil, 21)
UnitFrame.allColorsGroup.args.healthGroup.args.health = ACH:Color(L["Health"], nil, 22)
UnitFrame.allColorsGroup.args.healthGroup.args.disconnected = ACH:Color(L["Disconnected"], nil, 23)
UnitFrame.allColorsGroup.args.healthGroup.args.health_backdrop_dead = ACH:Color(L["Custom Dead Backdrop"], L["Use this backdrop color for units that are dead or ghosts."], 24, nil, 250)

UnitFrame.allColorsGroup.args.powerGroup = ACH:Group(L["Power"], nil, 9, nil, function(info) return E.db.unitframe.colors[info[#info]] end, function(info, value) E.db.unitframe.colors[info[#info]] = value UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.powerGroup.args.transparentPower = ACH:Toggle(L["Transparent"], L["Make textures transparent."], 1)
UnitFrame.allColorsGroup.args.powerGroup.args.invertPower = ACH:Toggle(L["Invert Colors"], L["Invert foreground and background colors."], 2, nil, nil, nil, nil, nil, function() return not E.db.unitframe.colors.transparentPower end)
UnitFrame.allColorsGroup.args.powerGroup.args.powerselection = ACH:Toggle(L["Selection Power"], L["Color power by color selection."], 3, nil, nil, nil, nil, nil, not E.Retail)
UnitFrame.allColorsGroup.args.powerGroup.args.powerclass = ACH:Toggle(L["Class Power"], L["Color power by classcolor or reaction."], 4, nil, nil, nil, nil, nil, function() return E.db.unitframe.colors.powerselection end)
UnitFrame.allColorsGroup.args.powerGroup.args.spacer2 = ACH:Spacer(5, 'full')
UnitFrame.allColorsGroup.args.powerGroup.args.custompowerbackdrop = ACH:Toggle(L["Custom Backdrop"], L["Use the custom backdrop color instead of a multiple of the main color."], 6)
UnitFrame.allColorsGroup.args.powerGroup.args.power_backdrop = ACH:Color(L["Custom Backdrop"], L["Use the custom backdrop color instead of a multiple of the main color."], 7, nil, nil, function(info) local t, d = E.db.unitframe.colors[info[#info]], P.unitframe.colors[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.unitframe.colors[info[#info]] t.r, t.g, t.b = r, g, b UF:Update_AllFrames() end, function() return not E.db.unitframe.colors.custompowerbackdrop end)

UnitFrame.allColorsGroup.args.castBars = ACH:Group(L["Castbar"], nil, 4, nil, function(info) if info.type == 'color' then local t, d = E.db.unitframe.colors[info[#info]], P.unitframe.colors[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b else return E.db.unitframe.colors[info[#info]] end end, function(info, ...) if info.type == 'color' then local r, g, b, a = ... local t = E.db.unitframe.colors[info[#info]] t.r, t.g, t.b, t.a = r, g, b, a or 1 else local value = ... E.db.unitframe.colors[info[#info]] = value end UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.castBars.args.transparentCastbar = ACH:Toggle(L["Transparent"], L["Make textures transparent."], 1)
UnitFrame.allColorsGroup.args.castBars.args.invertCastbar = ACH:Toggle(L["Invert Colors"], L["Invert foreground and background colors."], 2, nil, nil, nil, nil, nil, function() return E.db.unitframe.colors.transparentCastbar end)
UnitFrame.allColorsGroup.args.castBars.args.castClassColor = ACH:Toggle(L["Class Castbars"], L["Color castbars by the class of player units."], 3)
UnitFrame.allColorsGroup.args.castBars.args.castReactionColor = ACH:Toggle(L["Reaction Castbars"], L["Color castbars by the reaction type of non-player units."], 4)
UnitFrame.allColorsGroup.args.castBars.args.spacer1 = ACH:Spacer(5, 'full')
UnitFrame.allColorsGroup.args.castBars.args.customcastbarbackdrop = ACH:Toggle(L["Custom Backdrop"], L["Use the custom backdrop color instead of a multiple of the main color."], 6)
UnitFrame.allColorsGroup.args.castBars.args.castbar_backdrop = ACH:Color(L["Custom Backdrop"], L["Use the custom backdrop color instead of a multiple of the main color."], 7, true, nil, nil, nil, function() return not E.db.unitframe.colors.customcastbarbackdrop end)
UnitFrame.allColorsGroup.args.castBars.args.spacer2 = ACH:Spacer(8, 'full')
UnitFrame.allColorsGroup.args.castBars.args.castColor = ACH:Color(function() return E.Retail and L["Interruptible"] or L["COLOR"] end, nil, 9)
UnitFrame.allColorsGroup.args.castBars.args.castNoInterrupt = ACH:Color(L["Non-Interruptible"], nil, 10, nil, nil, nil, nil, nil, not E.Retail)
UnitFrame.allColorsGroup.args.castBars.args.castInterruptedColor = ACH:Color(L["Interrupted"], nil, 11, nil, nil, nil, nil, nil, not E.Retail)

UnitFrame.allColorsGroup.args.auras = ACH:Group(L["Auras"], nil, 5)
UnitFrame.allColorsGroup.args.auras.args.auraByDispels = ACH:Toggle(L["Borders By Dispel"], nil, 1)
UnitFrame.allColorsGroup.args.auras.args.auraByType = ACH:Toggle(L["Borders By Type"], nil, 2)

UnitFrame.allColorsGroup.args.auraBars = ACH:Group(L["Aura Bars"], nil, 5, nil, function(info) if info.type == 'color' then local t, d = E.db.unitframe.colors[info[#info]], P.unitframe.colors[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b, d.a else return E.db.unitframe.colors[info[#info]] end end, function(info, ...) if info.type == 'color' then local r, g, b, a = ... if E:CheckClassColor(r, g, b) then local classColor = E:ClassColor(E.myclass, true) r, g, b = classColor.r, classColor.g, classColor.b end local t = E.db.unitframe.colors[info[#info]] t.r, t.g, t.b, t.a = r, g, b, a else local value = ... E.db.unitframe.colors[info[#info]] = value end UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.auraBars.args.transparentAurabars = ACH:Toggle(L["Transparent"], L["Make textures transparent."], 1)
UnitFrame.allColorsGroup.args.auraBars.args.invertAurabars = ACH:Toggle(L["Invert Colors"], L["Invert foreground and background colors."], 2, nil, nil, nil, nil, nil, function() return not E.db.unitframe.colors.transparentAurabars end)
UnitFrame.allColorsGroup.args.auraBars.args.auraBarByType = ACH:Toggle(L["By Type"], L["Color aurabar debuffs by type."], 3)
UnitFrame.allColorsGroup.args.auraBars.args.auraBarTurtle = ACH:Toggle(L["Color Turtle Buffs"], L["Color all buffs that reduce the unit's incoming damage."], 4)
UnitFrame.allColorsGroup.args.auraBars.args.spacer1 = ACH:Spacer(5, 'full')
UnitFrame.allColorsGroup.args.auraBars.args.customaurabarbackdrop = ACH:Toggle(L["Custom Backdrop"], L["Use the custom backdrop color instead of a multiple of the main color."], 6)
UnitFrame.allColorsGroup.args.auraBars.args.aurabar_backdrop = ACH:Toggle(L["Custom Backdrop"], L["Use the custom backdrop color instead of a multiple of the main color."], 7, nil, nil, nil, nil, nil, function() return not E.db.unitframe.colors.customaurabarbackdrop end)
UnitFrame.allColorsGroup.args.auraBars.args.spacer2 = ACH:Spacer(8, 'full')
UnitFrame.allColorsGroup.args.auraBars.args.auraBarBuff = ACH:Color(L["Buffs"], nil, 10)
UnitFrame.allColorsGroup.args.auraBars.args.auraBarDebuff = ACH:Color(L["Debuffs"], nil, 11)
UnitFrame.allColorsGroup.args.auraBars.args.auraBarTurtleColor = ACH:Color(L["Turtle Color"], nil, 12)

UnitFrame.allColorsGroup.args.reactionGroup = ACH:Group(L["Reactions"], nil, 6, nil, function(info) local t, d = E.db.unitframe.colors.reaction[info[#info]], P.unitframe.colors.reaction[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.unitframe.colors.reaction[info[#info]] t.r, t.g, t.b = r, g, b UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.reactionGroup.args.BAD = ACH:Color(L["Bad"], nil, 1)
UnitFrame.allColorsGroup.args.reactionGroup.args.NEUTRAL = ACH:Color(L["Neutral"], nil, 2)
UnitFrame.allColorsGroup.args.reactionGroup.args.GOOD = ACH:Color(L["Good"], nil, 3)

UnitFrame.allColorsGroup.args.selectionGroup = ACH:Group(L["Selection"], nil, 7, nil, function(info) local n = tonumber(info[#info]) local t, d = E.db.unitframe.colors.selection[n], P.unitframe.colors.selection[n] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local n = tonumber(info[#info]) local t = E.db.unitframe.colors.selection[n] t.r, t.g, t.b = r, g, b UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.selectionGroup.args['0'] = ACH:Color(L["Hostile"], nil, 0)
UnitFrame.allColorsGroup.args.selectionGroup.args['1'] = ACH:Color(L["Unfriendly"], nil, 1)
UnitFrame.allColorsGroup.args.selectionGroup.args['2'] = ACH:Color(L["Neutral"], nil, 2)
UnitFrame.allColorsGroup.args.selectionGroup.args['3'] = ACH:Color(L["Friendly"], nil, 3)
UnitFrame.allColorsGroup.args.selectionGroup.args['5'] = ACH:Color(L["Player"], nil, 5) -- Player Extended
UnitFrame.allColorsGroup.args.selectionGroup.args['6'] = ACH:Color(L["Party"], nil, 6)
UnitFrame.allColorsGroup.args.selectionGroup.args['7'] = ACH:Color(L["Party PVP"], nil, 7)
UnitFrame.allColorsGroup.args.selectionGroup.args['8'] = ACH:Color(L["Friend"], nil, 8)
UnitFrame.allColorsGroup.args.selectionGroup.args['9'] = ACH:Color(L["Dead"], nil, 9)
UnitFrame.allColorsGroup.args.selectionGroup.args['13'] = ACH:Color(L["Battleground Friendly"], nil, 13)

UnitFrame.allColorsGroup.args.healPrediction = ACH:Group(L["Heal Prediction"], nil, 9, nil, function(info) if info.type == 'color' then local t, d = E.db.unitframe.colors.healPrediction[info[#info]], P.unitframe.colors.healPrediction[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b, d.a else return E.db.unitframe.colors.healPrediction[info[#info]] end end, function(info, ...) if info.type == 'color' then local r, g, b, a = ... local t = E.db.unitframe.colors.healPrediction[info[#info]] t.r, t.g, t.b, t.a = r, g, b, a else local value = ... E.db.unitframe.colors.healPrediction[info[#info]] = value end UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.healPrediction.args.maxOverflow = ACH:Range(L["Max Overflow"], L["Max amount of overflow allowed to extend past the end of the health bar."], 1, { min = 0, max = 1, step = 0.01, isPercent = true })
UnitFrame.allColorsGroup.args.healPrediction.args.spacer1 = ACH:Spacer(2, 'full')
UnitFrame.allColorsGroup.args.healPrediction.args.personal = ACH:Color(L["Personal"], nil, 3, true)
UnitFrame.allColorsGroup.args.healPrediction.args.others = ACH:Color(L["Others"], nil, 4, true)
UnitFrame.allColorsGroup.args.healPrediction.args.absorbs = ACH:Color(L["Absorbs"], nil, 5, true, nil, nil, nil, nil, not E.Retail)
UnitFrame.allColorsGroup.args.healPrediction.args.healAbsorbs = ACH:Color(L["Heal Absorbs"], nil, 6, true, nil, nil, nil, nil, not E.Retail)
UnitFrame.allColorsGroup.args.healPrediction.args.overabsorbs = ACH:Color(L["Over Absorbs"], nil, 7, true, nil, nil, nil, nil, not E.Retail)
UnitFrame.allColorsGroup.args.healPrediction.args.overhealabsorbs = ACH:Color(L["Over Heal Absorbs"], nil, 8, true, nil, nil, nil, nil, not E.Retail)

UnitFrame.allColorsGroup.args.powerPrediction = ACH:Group(L["Power Prediction"], nil, 10, nil, function(info) if info.type == 'color' then local t, d = E.db.unitframe.colors.powerPrediction[info[#info]], P.unitframe.colors.powerPrediction[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b, d.a else return E.db.unitframe.colors.powerPrediction[info[#info]] end end, function(info, ...) if info.type == 'color' then local r, g, b, a = ... local t = E.db.unitframe.colors.powerPrediction[info[#info]] t.r, t.g, t.b, t.a = r, g, b, a else local value = ... E.db.unitframe.colors.powerPrediction[info[#info]] = value end UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.powerPrediction.args.enable = ACH:Toggle(L["Custom Power Prediction Color"], nil, 1, nil, nil, 250)
UnitFrame.allColorsGroup.args.powerPrediction.args.spacer2 = ACH:Spacer(2)
UnitFrame.allColorsGroup.args.powerPrediction.args.color = ACH:Color(L["Power Prediction Color"], nil, 3, true)
UnitFrame.allColorsGroup.args.powerPrediction.args.additional = ACH:Color(L["Additional Power Prediction Color"], nil, 4, true)

UnitFrame.allColorsGroup.args.debuffHighlight = ACH:Group(L["Debuff Highlighting"], nil, 11, nil, function(info) if info.type == 'color' then local t, d = E.db.unitframe.colors.debuffHighlight[info[#info]], P.unitframe.colors.debuffHighlight[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b, d.a else return E.db.unitframe.colors.debuffHighlight[info[#info]] end end, function(info, ...) if info.type == 'color' then local r, g, b, a = ... local t = E.db.unitframe.colors.debuffHighlight[info[#info]] t.r, t.g, t.b, t.a = r, g, b, a else local value = ... E.db.unitframe.colors.debuffHighlight[info[#info]] = value end UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.debuffHighlight.args.debuffHighlighting = ACH:Select(L["Highlight Color Style"], L["Color the unit healthbar if there is a debuff that can be dispelled by you."], 1, { NONE = NONE, GLOW = L["Glow"], FILL = L["Fill"] }, nil, nil, function(info) return E.db.unitframe[info[#info]] end, function(info, value) E.db.unitframe[info[#info]] = value end)
UnitFrame.allColorsGroup.args.debuffHighlight.args.blendMode = ACH:Select(L["Blend Mode"], nil, 2, blendModeValues)
UnitFrame.allColorsGroup.args.debuffHighlight.args.spacer1 = ACH:Spacer(3, 'full')
UnitFrame.allColorsGroup.args.debuffHighlight.args.Magic = ACH:Color(L["ENCOUNTER_JOURNAL_SECTION_FLAG7"], nil, 4, true)
UnitFrame.allColorsGroup.args.debuffHighlight.args.Curse = ACH:Color(L["ENCOUNTER_JOURNAL_SECTION_FLAG8"], nil, 5, true)
UnitFrame.allColorsGroup.args.debuffHighlight.args.Disease = ACH:Color(L["ENCOUNTER_JOURNAL_SECTION_FLAG10"], nil, 6, true)
UnitFrame.allColorsGroup.args.debuffHighlight.args.Poison = ACH:Color(L["ENCOUNTER_JOURNAL_SECTION_FLAG9"], nil, 7, true)

UnitFrame.allColorsGroup.args.classResourceGroup = ACH:Group(L["Class Resources"], nil, -10, nil, function(info) local t, d = E.db.unitframe.colors.classResources[info[#info]], P.unitframe.colors.classResources[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.unitframe.colors.classResources[info[#info]] t.r, t.g, t.b = r, g, b UF:Update_AllFrames() end)
-- UnitFrame.allColorsGroup.args.classResourceGroup.args.transparentClasspower = ACH:Toggle(L["Transparent"], L["Make textures transparent."], 1, nil, nil, nil, function(info) return E.db.unitframe.colors[info[#info]] end, function(info, value) E.db.unitframe.colors[info[#info]] = value UF:Update_AllFrames() end)
-- UnitFrame.allColorsGroup.args.classResourceGroup.args.invertClasspower = ACH:Toggle(L["Invert Colors"], L["Invert foreground and background colors."], 2, nil, nil, nil, function(info) return E.db.unitframe.colors[info[#info]] end, function(info, value) E.db.unitframe.colors[info[#info]] = value UF:Update_AllFrames() end, function() return not E.db.unitframe.colors.transparentClasspower end)
UnitFrame.allColorsGroup.args.classResourceGroup.args.customclasspowerbackdrop = ACH:Toggle(L["Use Custom Backdrop"], L["Use the custom backdrop color instead of a multiple of the main color."], 3, nil, nil, nil, function(info) return E.db.unitframe.colors[info[#info]] end, function(info, value) E.db.unitframe.colors[info[#info]] = value UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.classResourceGroup.args.classpower_backdrop = ACH:Color(L["Custom Backdrop"], nil, 4, nil, nil, function(info) local t, d = E.db.unitframe.colors[info[#info]], P.unitframe.colors[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.unitframe.colors[info[#info]] t.r, t.g, t.b = r, g, b UF:Update_AllFrames() end, function() return not E.db.unitframe.colors.customclasspowerbackdrop end)

UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup = ACH:Group(L["Power"], nil, 0, nil, function(info) local t, d = E.db.unitframe.colors.power[info[#info]], P.unitframe.colors.power[info[#info]] return t.r, t.g, t.b, t.a, d.r, d.g, d.b end, function(info, r, g, b) local t = E.db.unitframe.colors.power[info[#info]] t.r, t.g, t.b = r, g, b UF:Update_AllFrames() end)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.inline = true
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.MANA = ACH:Color(L["MANA"], nil, 1)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.RAGE = ACH:Color(L["RAGE"], nil, 2)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.FOCUS = ACH:Color(L["FOCUS"], nil, 3)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.ENERGY = ACH:Color(L["ENERGY"], nil, 4)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.RUNIC_POWER = ACH:Color(L["RUNIC_POWER"], nil, 5)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.PAIN = ACH:Color(L["PAIN"], nil, 6)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.FURY = ACH:Color(L["FURY"], nil, 7)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.LUNAR_POWER = ACH:Color(L["LUNAR_POWER"], nil, 8)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.INSANITY = ACH:Color(L["INSANITY"], nil, 9)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.MAELSTROM = ACH:Color(L["MAELSTROM"], nil, 10)
UnitFrame.allColorsGroup.args.classResourceGroup.args.powerGroup.args.ALT_POWER = ACH:Color(L["Swapped Alt Power"], nil, 11)

UnitFrame.allColorsGroup.args.classResourceGroup.args.class = ACH:Group(L["Class Resources"], nil, 1)
