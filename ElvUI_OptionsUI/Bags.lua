...
Bags.args.general = ACH:Group(L["General"], nil, 4, nil, nil, function(info, value) E.db.bags[info[#info]] = value B:UpdateAll() end, function() return not E.Bags.Initialized end)
...
Bags.args.general.args.playerGroup = ACH:Group(L["Player"], nil, 40, nil, nil, nil, function() return not E.Bags.Initialized end)
...
Bags.args.general.args.playerGroup.args.split = ACH:Group(L["Split"], nil, 2, nil, function(info) return E.db.bags.split[info[#info]] end, function(info, value) E.db.bags.split[info[#info]] = value B:Layout() end)
...
Bags.args.general.args.bankGroup = ACH:Group(L["Bank"], nil, 45, nil, nil, nil, function() return not E.Bags.Initialized end)
...
Bags.args.general.args.bankGroup.args.split = ACH:Group(L["Split"], nil, 2, nil, function(info) return E.db.bags.split[info[#info]] end, function(info, value) E.db.bags.split[info[#info]] = value B:Layout(true) end)
...
Bags.args.general.args.countGroup = ACH:Group(L["Item Count"], nil, 50, nil, nil, function(info, value) E.db.bags[info[#info]] = value B:UpdateCountDisplay() end)
...
Bags.args.general.args.itemLevelGroup = ACH:Group(L["Item Level"], nil, 55, nil, nil, function(info, value) E.db.bags[info[#info]] = value B:UpdateItemLevelDisplay() end)
...
Bags.args.bagBar = ACH:Group(L["Bag Bar"], nil, 6, nil, function(info) return E.db.bags.bagBar[info[#info]] end, function(info, value) E.db.bags.bagBar[info[#info]] = value; B:SizeAndPositionBagBar() end)
...
Bags.args.vendorGrays = ACH:Group(L["Vendor Grays"], nil, 8, nil, function(info) return E.db.bags.vendorGrays[info[#info]] end, function(info, value) E.db.bags.vendorGrays[info[#info]] = value; B:UpdateSellFrameSettings() end)
...
Bags.args.bagSortingGroup = ACH:Group(L["Sorting"], nil, 9, nil, nil, nil, function() return (not E.Bags.Initialized) or E.db.bags.useBlizzardCleanup end)
...
Bags.args.search_syntax = ACH:Group(L["Search Syntax"], nil, 10, nil, nil, nil, function() return not E.Bags.Initialized end)
