...
local function CreateDTOptions(name, data)
	...
	elseif name == 'Time' then
		...
		optionTable.args.flashInvite = ACH:Toggle(L["Flash Invites"], L["This will allow you to enable/disable the flashing of the time datatext when there are calendar invites."])
