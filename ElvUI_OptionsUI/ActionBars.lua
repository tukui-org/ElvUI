...
ActionBar.args.general.args.applyGroup = ACH:Group(L["Apply To All"], nil, 30)
...
ActionBar.args.masqueGroup = ACH:Group(L["Masque"], nil, -1, nil, function(info) return E.private.actionbar.masque[info[#info]] end, function(info, value) E.private.actionbar.masque[info[#info]] = value; E:StaticPopup_Show('PRIVATE_RL') end, function() return not E.Masque end)
ActionBar.args.masqueGroup.args.actionbars = ACH:Toggle(L["ActionBars"], nil, 1)
ActionBar.args.masqueGroup.args.petBar = ACH:Toggle(L["Pet Bar"], nil, 2)
ActionBar.args.masqueGroup.args.stanceBar = ACH:Toggle(L["Stance Bar"], nil, 3)
