...
general.args.generalGroup.args.keyDown = ACH:Toggle(L["Key Down"], L["OPTION_TOOLTIP_ACTION_BUTTON_USE_KEY_DOWN"], 1, nil, nil, nil, nil, function(info, value) E.db.actionbar[info[#info]] = value SetCVar('ActionButtonUseKeyDown', (value == true and 1 or 0)) end)
