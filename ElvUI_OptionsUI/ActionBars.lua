...
general.args.generalGroup.args.rightClickSelfCast = ACH:Toggle(L["Right Click Self Cast"], nil, 5)
general.args.generalGroup.args.checkSelfCast = ACH:Toggle(L["Check Self Cast"], nil, 6)
general.args.generalGroup.args.checkFocusCast = ACH:Toggle(L["Check Focus Cast"], nil, 7)
