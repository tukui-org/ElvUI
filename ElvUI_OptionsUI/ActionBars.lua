...
general.args.castGroup.args.focusCastKey = ACH:Select(L["Focus Cast Key"], nil, 1, castKeyValues, nil, nil, function() return GetModifiedClick('FOCUSCAST') end, function(_, value) SetModifiedClick('FOCUSCAST', value) end, nil, E.Classic)
general.args.castGroup.args.checkFocusCast = ACH:Toggle(L["Check Focus Cast"], nil, 2, nil, nil, nil, nil, nil, nil, E.Classic)
general.args.castGroup.args.spacer1 = ACH:Spacer(3, 'full', E.Classic)
general.args.castGroup.args.mouseoverCastKey = ACH:Select(E.NewSign..L["Mouseover Cast Key"], nil, 10, castKeyValues, nil, nil, function() return GetModifiedClick('MOUSEOVERCAST') end, function(_, value) SetModifiedClick('MOUSEOVERCAST', value) end)
general.args.castGroup.args.checkMouseoverCast = ACH:Toggle(E.NewSign..L["Check Mouseover Cast"], nil, 11, nil, nil, nil, function() return GetCVarBool('enableMouseoverCast') end, function(_, value) SetCVar('enableMouseoverCast', value and 1 or 0); AB:UpdateButtonSettings() end, nil, not E.Retail)
...
general.args.castGroup.args.autoSelfCast = ACH:Toggle(L["Auto Self Cast"], nil, 24, nil, nil, nil, function() return GetCVarBool('autoSelfCast') end, function(_, value) SetCVar('autoSelfCast', value and 1 or 0) end)
