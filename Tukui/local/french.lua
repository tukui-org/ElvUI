if TukuiDB.client == "frFR" then
	...
	tukuilocal.datatext_avoidancebreakdown = "Avoidance détaillée"
	...
	tukuilocal.datatext_mitigation = "Mitigation par Lvl: "
	...
	tukuilocal.datatext_flagsreturned = "Drapeaux Ramenés:"
	...
	tukuilocal.datatext_control = "Contrôlé par:"
	...
	tukuilocal.popup_2raidactive = "2 interfaces de raid sont actives, merci d'en choisir une" --"2 raid layouts are active, please select a layout."
	...
	tukuilocal.unitframes_ouf_ghostheal = "Fantôme"
	...
	tukuilocal.tooltip_count = "Nombre"
 
	tukuilocal.bags_noslots = "Plus de place!"
	tukuilocal.bags_costs = "Coût: %.2f or"
	tukuilocal.bags_buyslots = "Acheter une nouvel emplacement avec /bags purchase yes"
	tukuilocal.bags_openbank = "Vous devez ouvrir votre banque d'abord."
	tukuilocal.bags_sort = "Trier vos sacs ou votre banque, si elle est ouverte."
	tukuilocal.bags_stack = "Empiler les objets dans vos sacs ou banque, si elle est ouverte."
	tukuilocal.bags_buybankslot = "Acheter un emplacement de banque  (Requiert d'avoir la banque ouverte)."
	tukuilocal.bags_search = "Recherche"
	tukuilocal.bags_sortmenu = "Tri"
	tukuilocal.bags_sortspecial = "Tri Personnalisé"
	tukuilocal.bags_stackmenu = "Empilement"
	tukuilocal.bags_stackspecial = "Empilement Personnalisé"
	...
	tukuilocal.core_uihelp3 = "|cffFF0000/rl|r - Recharger votre UI."
	tukuilocal.core_uihelp4 = "|cffFF0000/gm|r - Envoyer une requete MJ ou voir l'aide dans le jeu."
	tukuilocal.core_uihelp5 = "|cffFF0000/frame|r - Détecte le nom du cadre sur lequel votre souris est actuellement positionnée."
	...
	tukuilocal.core_uihelp8 = "|cffFF0000/uf|r - Activer ou désactivez le déplacement des cadres d'unités."
	tukuilocal.core_uihelp9 = "|cffFF0000/bags|r - pour trier, acheter des places en banque ou empiler des objets dans vos sacs."
	tukuilocal.core_uihelp10 = "|cffFF0000/resetui|r - Réinitialiser les variables et le Chat."
	tukuilocal.core_uihelp11 = "|cffFF0000/rd|r - Disooudre le raid."
	tukuilocal.core_uihelp12 = "|cffFF0000/hb|r - assigner des raccourcis à vos boutons d'actions."
	...
	tukuilocal.core_uihelp17 = "|cffFF0000/moveele|r - Affiche les portraits d'unités pour pouvoir les déplacer."
	tukuilocal.core_uihelp18 = "|cffFF0000/resetele|r - Réinitialiser les éléments à leurs places par défaut. Vous pouvez réinitialiser seulement un élément avec /resetele <nom de l'élément>."
	...
	tukuilocal.bind_discard = "Tous les raccourcis récemment ajoutés ont été supprimés."
	tukuilocal.bind_instruct = "Survoler le bouton d'action avec votre souris pour assigner un raccourci. Appuyer sur Echap ou clic droit pour le supprimer."
	tukuilocal.bind_save = "Sauvegarder les raccourcis"
	tukuilocal.bind_discardbind = "Supprimer les raccourcis"
 
	tukuilocal.core_raidutil = "Outils de raids"
	tukuilocal.core_raidutil_disbandgroup = "Dissoudre le raid"
