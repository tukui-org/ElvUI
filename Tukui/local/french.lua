if TukuiDB.client == "frFR" then
	...
	tukuilocal.core_welcome2 = "Tappez |cff00FFFF/uihelp|r pour plus d'info, tappez |cff00FFFF/tukui|r pour configurer, ou visitez http://www.tukui.org/v2/forums/topic.php?id=3557"
