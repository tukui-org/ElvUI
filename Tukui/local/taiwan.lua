if TukuiDB.client == "zhTW" then
	...
	tukuilocal.chat_GUILD_GET = "[公會]"
	tukuilocal.chat_OFFICER_GET = "[幹部]"
	tukuilocal.chat_PARTY_GET = "[隊伍]"
	tukuilocal.chat_PARTY_GUIDE_GET = "[公會隊伍]"
	tukuilocal.chat_PARTY_LEADER_GET = "[隊長]"
	tukuilocal.chat_RAID_GET = "[團隊]"
	tukuilocal.chat_RAID_LEADER_GET = "[團隊隊長]"
	tukuilocal.chat_RAID_WARNING_GET = "[團隊警告]"
	tukuilocal.chat_WHISPER_GET = "來自"
	tukuilocal.chat_FLAG_AFK = "[暫離]"
	tukuilocal.chat_FLAG_DND = "[勿擾]"
	...
	tukuilocal.datatext_wg = "距離下次冬握湖:"
	tukuilocal.datatext_friendlist = "好友名單:"
	tukuilocal.datatext_playersp = "法能: "
	...
	tukuilocal.datatext_graveyardsdefended = "墓地防禦:"
	...
	tukuilocal.datatext_control = "控制方:"
	...
	tukuilocal.core_welcome2 = "輸入 |cff00FFFF/uihelp|r 以獲得更多資訊, 輸入 |cff00FFFF/tukui|r 進行設置, 或訪問 http://www.tukui.org/v2/forums/topic.php?id=1235"
