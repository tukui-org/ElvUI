...
local EXPIRING_FORMAT = "|cff"..TukuiDB.RGBPercToHex(unpack(TukuiCF["cooldown"].expiringcolor))..'%.1f|r' --format for timers that are soon to expire
local SECONDS_FORMAT = "|cff"..TukuiDB.RGBPercToHex(unpack(TukuiCF["cooldown"].secondscolor))..'%d|r' --format for timers that have seconds remaining
local MINUTES_FORMAT = "|cff"..TukuiDB.RGBPercToHex(unpack(TukuiCF["cooldown"].minutescolor))..'%dm|r' --format for timers that have minutes remaining
local HOURS_FORMAT = "|cff"..TukuiDB.RGBPercToHex(unpack(TukuiCF["cooldown"].hourscolor))..'%dh|r' --format for timers that have hours remaining
local DAYS_FORMAT = "|cff"..TukuiDB.RGBPercToHex(unpack(TukuiCF["cooldown"].dayscolor))..'%dh|r' --format for timers that have days remaining
