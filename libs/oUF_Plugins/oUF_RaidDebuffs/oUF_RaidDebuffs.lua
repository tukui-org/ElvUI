...
local function Update(self, event, unit)
	...
	for i = 1, 40 do
		...
		if addon.ShowDispelableDebuff and debuffType then
			if addon.FilterDispellableDebuff and DispellFilter[debuffType] ~= nil and DispellPriority[debuffType] ~= nil and addon.priority ~= nil then -- SUPER CODE PROTECTION OF THE /FLEX
			...
			elseif DispellPriority[debuffType] ~= nil then
