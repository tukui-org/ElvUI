...
L["Shows item level of each item, enchants, and gems when inspecting another player.\nAlso displays Gear Score on the bottom right side of the inspect frame. This is an average of each equipped item."] = "当你观察另一个玩家是显示每个物品的物品等级、附魔和宝石. 在观察框体的右下角还有显示装备分数. 这是当前装备的平均值."
