...
L["Item Level"] = "物品等级"
L["Items in this list or items that match any Search Syntax query in this list will be ignored when sorting. Separate each entry with a comma."] = "在这个列表里的任何物品或任何匹配列表里搜索语法的物品都将在整理时被忽略。每一项用逗号隔开。"
L["Money Format"] = "金币格式"
...
L["Name Font"] = "名称字体"
L["Objective Frame Height"] = "目标框架高度"
L["Party / Raid"] = "小队/团队"
L["Party Only"] = "仅小队"
...
L["Only show a nameplate for the unit you have targetted."] = "仅显示你选定过的姓名板"
...
L["Bank Only"] = "仅银行"
L["Both"] = "两者"
L["Choose when you want the tooltip to show. If a modifer is chosen, then you need to hold that down to show the tooltip."] = "选择合适"
