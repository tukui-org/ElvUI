...
L["Display the upgrade icon on items that WoW considers an upgrade for your character."] = "为WoW认为可以为你角色提升的物品显示升级图标"
...
L["Hide the nameplate unless you are in combat, you are not on full health or have a target you can attack."] = "除非你在战斗中, 未满血或者有一个可以攻击的目标, 否则隐藏姓名板"
L["Hide Time"] = "隐藏时间"
L["Hide"] = "隐藏"
