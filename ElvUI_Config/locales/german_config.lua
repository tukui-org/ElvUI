...
L['Forces reaction color instead of class color on units controlled by players.'] = 'Erzwinge Reaktionsfarbe anstatt von Klassenfarbe auf übernommene Einheiten.'
