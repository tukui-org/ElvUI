...
L["List of items to ignore when sorting. If you wish to add multiple items you must seperate the word with a comma. Eligible Keys are Item-Names or Search-Syntax."] = "Liste von Items die beim sortieren ignoriert werden. Wenn du willst kannst du auch mehrere Items hinzufügen du musst nur nachdem Wort ein Komma setzen. Erlaubte Schlüssel sind Item-Namen und Suchsyntax."
