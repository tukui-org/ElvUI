...
L["Actions"] = "Aktionen"
L["Add a buff/debuff to the list."] = "Füge einen Stärkungs-/Schwächungszauber zur Liste hinzu."
L["Add Buff"] = "Füge Stärkungszauber hinzu"
L["Add Debuff"] = "Füge Schwächungszauber hinzu"
L["Add default filter into Priority"] = "Füge den Standard Filter zur Priorität hinzu"
L["Add global filter into Priority"] = "Füge den Globalen Filter zur Priorität hinzu"
L["Current Level"] = "Aktuelles Level"
L["Filters Page"] = "Filter Seite"
L["Hide Frame"] = "Verstecke Fenster"
L["If in or out of combat state, pass filter."] = "Wenn im oder außerhalb des Kampfes, absolviere den Filter."
...
L["Must have all of the buffs/debuffs listed in order to pass filter."]= "Muss alle Stärkungs-/Schwächungszauber in der gelisteten Reihenfolge haben um den Filter zu bestehen."
L["Must Have All"] = "Muss alle haben"
L["Missing All"] = "Alles fehlend"
L["Must be missing all of the buffs/debuffs listed in order to pass filter."] = "Folgende Buffs/Debuffs müssen fehlen um den Filter zu bestehen."
L["Name must but this in order to trigger, set to blank to turn off."] = "Name muss folgendes enthalten, leer lassen um auszuschalten."
L["Nameplate Type"] = "Namensplaketten Type"
L["NPC ID must but this in order to trigger, set to blank to turn off."] = "NPC ID muss folgendes enthalten, leer lassen um auszuschalten."
L["NPC ID"] = true; -- No need to translate
L["Out Of Combat"] = "Außerhalb des Kampfes"
L["Remove a buff/debuff from the list."] = "Entferne einen Stärkungs-/Schwächungszauber aus der Liste."
L["Remove Buff"] = "Stärkungszauber entfernen"
L["Remove Debuff"] = "Schwächungszauber entfernen"
L["Shortcut to global filters page"] = "Schnellzugriff "
L["Triggers"] = "Auslöser"
