...
L["Disable Debuff Highlight"] = "Deaktiviere Schwächungszauber-Herforhebung"
...
L["Forces Debuff Highlight to be disabled for these frames"] = "Erzwinge die deaktivierung der Schwächungszauber-Herforhebung für diese Fenster"
