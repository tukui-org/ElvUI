...
L["Attach Icon to Bar"] = "Symbol an Leiste anfügen"
...
L["Display the castbar icon on the castbar, if not set it will appear next to the unitframe seperately."] = "Zeige das Zauberleisten Symbol auf der Zauberleiste, wenn nicht ausgewählt wird es separat neben dem Einheitenfenster erscheinen."
