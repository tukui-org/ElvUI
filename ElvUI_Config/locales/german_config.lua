...
L["Use class color for the names of players when they are mentioned."] = "Benutze Klassenfarben von Spielernamen die erwähnt werden."
...
L["By forcing the nameplate to always show it will not move on the screen to stay below your characters feet."] = "Wenn du die Namensplaketten forcierst dass sie immer angezeigt werden, bewegen sie sich nicht unter deinen Charakter Füße."
...
L["Control enemy nameplates toggling on or off when in combat."] = "Legt fest, dass die Namensplaketten im Kampf für Gegner ein- oder ausgeblendet werden."
L["Control friendly nameplates toggling on or off when in combat."] = "Legt fest, dass die Namensplaketten im Kampf für freundliche Einheiten ein- oder ausgeblendet werden."
L["Controls how many auras are displayed, this will also affect the size of the auras."] = "Lege fest, wieviele Auren angezeigt werden. Dieses beeinflusst auch die Größe der Auren."
...
L["Display NPC Titles whenever healthbars arent displayed and names are."] = "Zeige NPC Titel, wenn die Lebensleiste ausgeblendet ist, der Name aber aktiviert ist."
...
L["Non-Target Transparency"] = "Transparents von nicht ausgewählten Zielen"
L["Only show a nameplate for the unit you have targetted."] = "Zeige nur Namensplaketten von ausgewählten Einheiten."
...
L["Scale of the nameplate that is targetted."] = "Skalierung der Namensplaketten von ausgewählten Einheiten."
L["Set Settings to Default"] = "Setzte die Einstellungen auf Standard"
L["Set the transparency level of nameplates that are not the target nameplate."] = "Setze das Transparenzlevel von Namensplaketten, die nicht die ausgewählte Namensplaketten ist."
L["Set to either stack nameplates vertically or allow them to overlap."] = "Setze die Namensplaketten um übereinander gestappelt zu werden oder sich überlappen."
...
L["Statusbar Fill Orientation"] = "Statusleiste Füllung Orientierung"
...
L["Vertical Orientation"] = "Vertikale Orientierung"
