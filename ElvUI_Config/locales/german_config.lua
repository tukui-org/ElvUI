...
L["If enabled then you will no longer see nameplates that use the default Blizzard appearance. This will prevent raid icons from showing on those units."] = "Wenn aktiviert wirst du nicht mehr in der Lage sein Namensplaketten im Blizzard Stil zu sehen. Des weiteren auch nicht die Raid Icons auf den Einheiten."
