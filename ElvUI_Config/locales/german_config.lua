...
L["Shows item level of each item, enchants, and gems when inspecting another player.\nAlso displays Gear Score on the bottom right side of the inspect frame. This is an average of each equipped item."] = "Zeigt das Itemlevel von jedem Gegenstand, Verzauberungen und Edelsteine wenn man einen Spieler betrachtet.\nEs wird auch der Gear Score unten rechts auf dem Betrachten-Fenster angezeigt. Dieses ist der Durschnitt von den ausgerüsteten Gegenständen."
