...
L["Set the orientation of the UnitFrame. If set to automatic it will adjust based on where the frame is located on the screen."] = "Setzt die Orientierung der Einheitenfenster. Wenn automatisch gewählt wird, wird automatisch die Orientierung gewählt wo sich das Fenster befindet."
