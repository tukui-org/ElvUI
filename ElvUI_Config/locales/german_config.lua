...
L["This makes the item level display more reliable but uses more resources. If this is disabled then upgraded items will not show the correct item level."] = "Aktivieren um Itemlevels zuverlässiger anzuzeigen (verwendet mehr Resourcen). Wenn Tooltip-Scanning deaktiviert ist wird das Itemlevel von aufgewerteten Gegenständen nicht korrekt angezeigt."
...
L["Hide blob ring"] = "Verstecke Blob Ring" --bad translation
L["Hides the minimap blob ring for quest and archaeology."] = "Verstecke den Minikarten Ring für Quest und Archäologie."
...
L["Hide the nameplate unless you are in combat, you are not on full health or have a target you can attack."] = "Versteckt die Namensplakette ausser du bist im Kampf, nicht bei voller Gesundheit oder hast ein Ziel im Visier dass du angreifen kannst."
