...
L["This setting will be updated upon changing stances."] = "Diese Einstellungen werden bei Gestaltwandel upgedated"
...
L['Display LFG Icons in group chat.'] = "LFG Icons im Gruppenchat anzeigen"
...
L['Name Alignment'] = "Ausrichtung des Namens"
L["Name X-Offset"] = "x-Versatz des Namens"
L["Name Y-Offset"] = "y-Versatz des Namens"
...
L['Display the players talent spec and item level in the tooltip, this may not immediately update when mousing over a unit.'] = "Zeige die Spezialisierung und das Itemlevel des Spielers im Tooltip an, wird vielleicht nicht direkt upgedated"
...
L['Name (Entire Group)'] = "Name (ganze Gruppe)"
...
L['Override the default class color setting.'] = "Überschreibe die standart Klassenfarben Einstellungen"
...
L['Reverses the grouping order. For example if your group is to grow right than up by default the first group is always at the bottom. With this option set then the first group will start at the bottom but as the number of groups grow it will always be near the top.'] = "Umkehrung der Gruppierungsreihenfolge Wenn z.B. die Gruppe standartmäßig nach Rechts und dann nach Oben wächst ist die erste Gruppe immer Unten. Wenn diese Option ausgewählt ist startet die erste Gruppe unten aber wenn die Gruppenanzahl wächt wird sie immer Oben sein."
...
L["UnitFrames"] = "Einheitenfenster"
L["Up"] = "Hinauf"
L['Use Default'] = "Benutze Standart"
