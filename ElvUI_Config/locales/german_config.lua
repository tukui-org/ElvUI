...
L["Invert Heal Absorbs"] = "Heilung Absorbierungen Umkehren"
...
L["Makes the heal absorb texture cover part of the health instead of extending it."] = "Die Heilung Absorbierungen Textur wird nun die Lebensleiste überdecken anstatt sie zu erweitern."
