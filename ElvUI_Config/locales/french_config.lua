...
L["Clear the Search Box when closing the bag"] = "Nettois la barre de recherche à la fermeture des sacs";
L["Clear Search Box On Close"] = "Nettoyer la barre de recherche à la fermeture";
