...
L["Clear the search bar when closing the bag"] = "Nettois la barre de recherche à la fermeture des sacs";
L["Clear Search Bar On Close"] = "Nettoyer la barre de recherche à la fermeture";
