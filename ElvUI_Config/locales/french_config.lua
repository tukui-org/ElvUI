...
L['The direction the auras will grow and then the direction they will grow after they reach the wrap after limit.'] = "La direction que les auras vont prendre au fur et à mesure et la direction que les auras prendront après avoir atteint la limite."; --need review
...
L['Time xOffset'] = "Temps xOffset";
L['Time yOffset'] = "Temps yOffset";
L['Time'] = "Temps"
...
L["Can Interrupt"] = "Peut interrompre.";
...
L['Color Name By Health Value'] = "Colorer le nom par la valeur de la vie"; --need review
...
L["NamePlates"] = "Noms"
L["No Interrupt"] = "Pas d'interruption";
...
L['Scale if Low Health'] = "A l'échelle si vie faible";
L["Scaling"] = "Échelle";
