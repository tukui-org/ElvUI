...
L["Color castbars by the class or reaction type of the unit."] = "시전바 색상을 직업색으로 변경합니다."
...
L["Disable Blizzard"] = "기본 프레임 미사용"
L["Disabled"] = "미사용"
L["Disables the blizzard party/raid frames."] = "블리자드에서 기본적으로 제공하는 유닛프레임들을 사용하지 않고 숨깁니다."
L["Disconnected"] = "오프라인"
...
L["Latency"] = "지연 시간 표시"
L["Low Mana Threshold"] = "낮은 마나 경고 임계점"
L["Lunar"] = "달 에너지"
