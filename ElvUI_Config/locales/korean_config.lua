...
L["The first button anchors itself to this point on the bar."] = "첫 번째 버튼을 기준으로 나머지 버튼들이 나열됩니다."
...
L["Controls what the transparency of the worldmap will be set to when you are moving."] = "캐릭터가 이동 중이면 세계 지도의 투명도를 이 값으로 변경합니다. 100에 맞추면 이동 중에 투명도가 변하지 않습니다."
...
L["Don't scale the large world map to block out sides of the screen."] = "세계지도의 크기를 줄여서 화면 전체를 가리지 않게 합니다."
...
L["Loot Roll"] = "주사위 굴림창"
L["Loot"] = "전리품 확인창"
L["Map Alpha While Moving"] = "이동 중 세계지도 투명도"
...
L["Create a custom fontstring. Once you enter a name you will be able to select it from the elements dropdown list."] = "유닛프레임에 새로운 문자 영역을 추가합니다. 빈칸에 새 문자영역 이름을 입력하고 Enter 키를 누르면 우측하단의 목록에서 선택할 수 있게 됩니다."
...
L["Friendlies: Show Buffs"] = "아군: 버프 표시"
L["Friendlies: Show Debuffs"] = "아군: 디버프 표시"
...
L["If the unit is an enemy to you."] = "만약 유닛이 아군이라면"
L["If the unit is friendly to you."] = "만약 유닛이 적군이라면"
...
L["Raid Icon"] = "레이드 아이콘"
L["Raid-10 Frames"] = "10인 레이드프레임"
L["Raid-25 Frames"] = "25인 레이드프레임"
L["Raid-40 Frames"] = "40인 레이드프레임"
