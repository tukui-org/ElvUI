...
L["Colors the border according to the type of items assigned to the bag."] = "Окрашивать границу в соответствии с типом предметов, назначеным для сумки."
...
L["Show Assigned Color"] = "Цвет назнасенных"
