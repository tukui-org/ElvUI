...
L["If enabled then you will no longer see nameplates that use the default Blizzard appearance. This will prevent raid icons from showing on those units."] = "Если включено, то фильтр будет активирован только, если вы не в бою."
