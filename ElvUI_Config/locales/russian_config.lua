...
L["Show clickable Quick Join messages inside of the chat."] = "Отображжать интерактивные сообщения для быстрого присоединения в чате."
...
L["Controls how many auras are displayed."] = "Контроллирует кол-во отображаемых эффектов."
...
L["Height for the Aura Icon"] = "Высота иконок аур"
...
L["Icon Height"] = "Высота иконок"
L["Icon Position"] = "Позиция иконки"
L["Icon Width"] = "Ширина иконок"
...
L["When using Static Position, this option also requires the target to be attackable."] = "При использовании фиксированой позиции требуется, чтобы цель была враждебной."
...
L["Width for the Aura Icon"] = "Ширина иконок аур"
...
L["Help Frame"] = "Помощь"
L["Island Party Pose"] = "Завевшение экспедиции"
