...
L["Attach Icon to Bar"] = "Прикрепить иконку к полосе"
...
L["Display the castbar icon on the castbar, if not set it will appear next to the unitframe seperately."] = "Отображать иконку на полосе заклинаний. Если выключено, она появится рядом с соответствующе рамкой."
