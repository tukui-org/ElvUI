...
L["Hide the nameplate unless you are not on full health or have a target you can attack."] = "Скрывать индикатор если у вас не полное здоровье или нет цели, которую можно атаковать."
