		...
		general = {
			...
			args = {
				...
				ignoreItems = {
					order = 100,
					name = L["Ignore Items"],
					desc = L["List of items to ignore when sorting. If you wish to add multiple items you must seperate the word with a comma. Eligible Keys are Item-Names or Search-Syntax."],
					type = 'input',
					width = 'full',
					multiline = true,
					set = function(info, value) E.db.bags[ info[#info] ] = value; end,
