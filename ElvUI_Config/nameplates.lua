...
E.Options.args.nameplate = {
	...
	args = {
		...
		castBar = {
			...
			args = {
				...
				name = {
					...
					guiInline = true,
					order = 100,
					get = function(info) return E.db.nameplate.castBar.name[ info[#info] ] end,
					set = function(info, value) E.db.nameplate.castBar.name[ info[#info] ] = value; NP:UpdateAllPlates() end,	
					args = {
						enable = {
							order = 1,
							type = "toggle",
				...
				time = {
					...
					guiInline = true,
					order = 100,
					get = function(info) return E.db.nameplate.castBar.time[ info[#info] ] end,
					set = function(info, value) E.db.nameplate.castBar.time[ info[#info] ] = value; NP:UpdateAllPlates() end,	
					args = {
						enable = {
							order = 1,
							type = "toggle",
		...
		name = {
			...
			order = 5,
			name = L["Name"],
			get = function(info) return E.db.nameplate.name[ info[#info] ] end,
			set = function(info, value) E.db.nameplate.name[ info[#info] ] = value; NP:UpdateAllPlates() end,	
			args = {
				enable = {
					order = 1,
					type = "toggle",
		...
		level = {
			...
			order = 5,
			name = L["Level"],
			get = function(info) return E.db.nameplate.level[ info[#info] ] end,
			set = function(info, value) E.db.nameplate.level[ info[#info] ] = value; NP:UpdateAllPlates() end,	
			args = {
				enable = {
					order = 1,
					type = "toggle",
