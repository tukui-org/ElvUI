				...
				icons = {
					...
					args = {
						...
						webTicket = {
							...
							type = 'group',
							name = L["WebTicket"],
							get = function(info) return E.db.general.minimap.icons.webTicket[ info[#info] ] end,
							set = function(info, value) E.db.general.minimap.icons.webTicket[ info[#info] ] = value; E:GetModule('Minimap'):UpdateSettings() end,
							args = {
								scale = {
									order = 1,
									type = 'range',
