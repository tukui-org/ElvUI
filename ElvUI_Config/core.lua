						...
						garrison = {
							...
							args = {
								...
								garrisonPos = {
									...
									get = function(info) return E.db.general.minimap.garrisonPos end,
									set = function(info, value) E.db.general.minimap.garrisonPos = value; E:GetModule('Minimap'):UpdateSettings() end,
									values = {
										["TOPLEFT"] = L["Top Left"],
						...
						calendar = {
							...
							args = {
								...
								calendarPos = {
									...
									get = function(info) return E.db.general.minimap.calendarPos end,
									set = function(info, value) E.db.general.minimap.calendarPos = value; E:GetModule('Minimap'):UpdateSettings() end,
									values = {
										["TOPLEFT"] = L["Top Left"],
										["TOPRIGHT"] = L["Top Right"],
										["BOTTOMLEFT"] = L["Bottom Left"],
