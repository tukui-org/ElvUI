...
L["Set the alpha level of nameplates that are not the target nameplate."] = true
...
L["Show the castbar icon desatured if a spell is not interruptible."] = true
