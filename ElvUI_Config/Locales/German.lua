...
L["This controls the speed of status bars which use Smooth Bars option."] = "Dieses kontriliert die Geschwindigkeit von Statusleisten welche die Option Sanfte Leistenübergänge verwenden."
