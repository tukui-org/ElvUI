...
L["Item Level Font"] = "Шрифт ур. предметов"
...
L["Desatured Icon"] = "Бесцветная иконка"
...
L["Set the alpha level of nameplates that are not the target nameplate."] = "Установить прозрачность индикаторов тех юнитов, которые не являются целью."
...
L["Show the castbar icon desatured if a spell is not interruptible."] = "Показывать иконку полосы заклинания обесцвеченой, если заклинание нельзя прервать."
...
L["Use Target Size"] = "Использовать размер цели"
