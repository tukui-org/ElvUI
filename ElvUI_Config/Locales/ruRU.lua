...
L["Fade-in on Shown"] = "Анимация появления"
L["Fader"] = "Затухание"
...
L["Highlight on NamePlate"] = "Подсветка на индикаторе"
...
L["NPC_NAMES_DROPDOWN_HOSTILE"] = "Враждебные и связанные с заданиями NPC";
L["NPC_NAMES_DROPDOWN_INTERACTIVE"] = "Враждебные, ключевые и интерактивные NPC";
