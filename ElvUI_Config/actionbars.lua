...
E.Options.args.actionbar = {
	...
	args = {
		...
		useMasque = {
			...
			desc = L["Allow Masque to handle skinning of the actionbars."],
			get = function(info) return E.private.actionbar.useMasque end,
			set = function(info, value) E.private.actionbar.useMasque = value; E:StaticPopup_Show("PRIVATE_RL") end,
			disabled = function() return not E.private.actionbar.enable end,
		},
		movementModifier = {
			type = 'select',
