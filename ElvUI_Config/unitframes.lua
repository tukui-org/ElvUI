...
E.Options.args.unitframe.args.player = {
	...
	args = {
		...
		healAbsorbsInvertDirection = {
			order = 9,
			type = "toggle",
			name = L["Invert Heal Absorbs"],
			desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
			disabled = function() return not E.db.unitframe.units.player.healPrediction end,
		},
		hideonnpc = {
			type = 'toggle',
			order = 10,
...
E.Options.args.unitframe.args.target = {
	...
	args = {
		...
		healAbsorbsInvertDirection = {
			...
			name = L["Invert Heal Absorbs"],
			desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
			disabled = function() return not E.db.unitframe.units.target.healPrediction end,
		},
		hideonnpc = {
			type = 'toggle',
			order = 10,
...
E.Options.args.unitframe.args.focus = {
	...
	args = {
		...
		healAbsorbsInvertDirection = {
			...
			name = L["Invert Heal Absorbs"],
			desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
			disabled = function() return not E.db.unitframe.units.focus.healPrediction end,
		},
		hideonnpc = {
			type = 'toggle',
			order = 10,
...
E.Options.args.unitframe.args.pet = {
	...
	args = {
		...
		healAbsorbsInvertDirection = {
			...
			name = L["Invert Heal Absorbs"],
			desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
			disabled = function() return not E.db.unitframe.units.pet.healPrediction end,
		},
		hideonnpc = {
			type = 'toggle',
			order = 10,
...
E.Options.args.unitframe.args.arena = {
	...
	args = {
		...
		healAbsorbsInvertDirection = {
			...
			name = L["Invert Heal Absorbs"],
			desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
			disabled = function() return not E.db.unitframe.units.arena.healPrediction end,
		},
		hideonnpc = {
			type = 'toggle',
			order = 10,
		...
		general = {
			...
			args = {
				...
				healAbsorbsInvertDirection = {
					...
					name = L["Invert Heal Absorbs"],
					desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
					disabled = function() return not E.db.unitframe.units.party.healPrediction end,
				},
				threatStyle = {
					type = 'select',
					order = 6,
		...
		general = {
			...
			args = {
				...
				healAbsorbsInvertDirection = {
					...
					name = L["Invert Heal Absorbs"],
					desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
					disabled = function() return not E.db.unitframe.units.raid.healPrediction end,
				},
				threatStyle = {
					type = 'select',
					order = 6,
		...
		general = {
			...
			args = {
				...
				healAbsorbsInvertDirection = {
					...
					name = L["Invert Heal Absorbs"],
					desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
					disabled = function() return not E.db.unitframe.units.raid40.healPrediction end,
				},
				threatStyle = {
					type = 'select',
					order = 6,
		...
		general = {
			...
			args = {
				...
				healAbsorbsInvertDirection = {
					...
					name = L["Invert Heal Absorbs"],
					desc = L["Makes the heal absorb texture cover part of the health instead of extending it."],
					disabled = function() return not E.db.unitframe.units.raidpet.healPrediction end,
				},
				threatStyle = {
					type = 'select',
					order = 6,
