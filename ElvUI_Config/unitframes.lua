	...
	local config = {
		...
		args = {
			enable = {
				...
				order = 1,
				name = L["Enable"],
				desc = L["If you have a lot of 3D Portraits active then it will likely cause a big impact on your FPS. Disable some portraits if you experience FPS issues."],
			},
			width = {
				type = 'range',
				order = 2,
