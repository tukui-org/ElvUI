...
local function PLAYER_ENTERING_WORLD()
	...
	ChatFrameEditBox:SetPoint("TOPLEFT", InfoLeft, TukuiDB:Scale(2), TukuiDB:Scale(-2))
	ChatFrameEditBox:SetPoint("BOTTOMRIGHT", InfoLeft, TukuiDB:Scale(-2), TukuiDB:Scale(2))	
