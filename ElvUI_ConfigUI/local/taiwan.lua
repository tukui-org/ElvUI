if GetLocale() == "zhTW" then
	...
	ElvuiL.option_actionbar_rbn = "底部動作條數量 (1 或 2)"
	ElvuiL.option_actionbar_rbn2 = "底部動作條數量 (1, 2, 或 3)"
	ElvuiL.option_actionbar_rn = "右方動作條數量 (1, 2 或 3)"
	ElvuiL.option_actionbar_splitbar = "啟用分割動作條"
	...
	ElvuiL_option_chat_chatwidth = "對話框寬度"
	ElvuiL_option_chat_backdrop = "顯示對話框背景"
	ElvuiL_option_chat_chatheight = "對話框高度"
	ElvuiL_option_chat_fadeoutofuse = "不使用時使文字淡出"
	ElvuiL_option_chat_sticky = "開啟新對話框時預設某些重要頻道"
	ElvuiL_option_chat_rightchat = "顯示右邊對話框"
	ElvuiL_option_chat_combathide = "戰鬥中隱藏對話框('Left-左', 'Right-右', 'Both-左+右', or 'NONE-無')"
	...
	ElvuiL_option_perchar = "你確定要啟用或者關閉依角色儲存設定的模式嗎?"
	ElvuiL_option_makeselection = "你必需作出選擇才能繼續設定"
end