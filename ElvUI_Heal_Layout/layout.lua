...
local function Shared(self, unit)
	...
	if unit == "player" then
		...
		if E.level ~= MAX_PLAYER_LEVEL then
			...
			E.SetTemplate(self.Experience.F)
		...
		if E.level == MAX_PLAYER_LEVEL then
			...
			E.SetTemplate(self.Reputation.F)
		...
		if C["unitframes"].showthreat == true and not IsAddOnLoaded("Omen") then
			...
			E.SetTemplate(self.ThreatBar.F)
		...
		if C["unitframes"].classbar == true then
			...
			if E.myclass == "DRUID" then
				...
				E.SetTemplate(eclipseBar.FrameBackdrop)
			...
			if (E.myclass == "WARLOCK" or E.myclass == "PALADIN") then
				...
				E.SetTemplate(bars.FrameBackdrop)
			...
			if E.myclass == "DEATHKNIGHT" then
				...
				E.SetTemplate(Runes.FrameBackdrop)
			...
			if E.myclass == "SHAMAN" then
				...
				E.SetTemplate(TotemBar.FrameBackdrop)
